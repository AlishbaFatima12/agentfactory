...
跟踪本书中的重要变化。当文档更改被合并时，这个页面会自动更新。

---

## 最近更新

*更新按日期分组，并根据已合并的 pull requests 自动填充。*
...
本书会持续更新。我们不使用版本号，而是在这里跟踪变更，这样你就能看到自上次访问以来有哪些新内容。

- 每一条记录都会链接到发生变更的具体内容
- 当更改合并到 `main` 时，更新会自动记录
- 这里只显示书籍内容的变更，不显示基础设施变更

**提示**：把这个页面加入书签，方便快速查看更新。
