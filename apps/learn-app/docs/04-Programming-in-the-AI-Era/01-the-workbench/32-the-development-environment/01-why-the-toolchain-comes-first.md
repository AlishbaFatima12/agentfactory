...
skills:
  ...
  - name: "Tool-to-Axiom Mapping"
    ...
    measurable_at_this_level: "Student can match each of the five discipline stack tools (uv, pyright, ruff, pytest, Git) to its corresponding axiom from Chapter 43"
...
learning_objectives:
  ...
  - objective: "Connect each tool to its corresponding axiom from Chapter 43"
    proficiency_level: "A2"
    bloom_level: "Understand"
