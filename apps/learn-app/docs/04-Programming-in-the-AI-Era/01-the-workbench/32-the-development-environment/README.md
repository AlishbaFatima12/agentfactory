...
description: "Install and configure the five-tool Python discipline stack -- uv, pyright, ruff, pytest, and Git -- each connected to an axiom from Chapter 31."
keywords:
  [
    "uv",
    "python",
...
In Chapter 31, you learned that AI generates code fast -- but speed without verification is dangerous. The ten axioms gave you the principles: specify what you want, verify what you get. This chapter gives you the tools that make verification automatic.
