...
- **Leads to**: Chapter 33: Reading Python -- where students begin writing actual Python code with the complete workbench already in place, using all five tools to verify every line they write
