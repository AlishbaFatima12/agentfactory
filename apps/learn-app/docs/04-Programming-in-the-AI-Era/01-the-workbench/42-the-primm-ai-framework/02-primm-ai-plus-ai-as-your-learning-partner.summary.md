...
- **Builds on**: PRIMM five-stage framework from Lesson 1 (Predict, Run, Investigate, Modify, Make), Spec-Driven Development from Chapter 16 (spec before code principle), and recognition that AI assistants change the partner but not the method.
