...
### Connections
- **Builds on**: Axiom II (Knowledge Over Memory) — if code is your universal interface (Principle 2: Code as Universal Interface from Chapter 6), then types, tests, and error handling determine interface reliability.
