---
sidebar_position: 46
title: "Chapter 46: Your First TDG Cycle"
description: "Complete your first Test-Driven Generation cycle -- write a stub and tests, prompt AI to implement, verify the result. Five lines of specification produce twenty lines of working, tested code."
keywords:
  [
    "TDG",
...
|--------|-------|-------------|
| 1 | [From Reading to Specifying -- What Is TDG?](from-reading-to-specifying) | Understand the TDG loop by reading a complete worked example |
| 2 | [Your First Failing Test](your-first-failing-test) | Learn `return`, `-> float`, and `...` -- write your first stub and tests |
| 3 | [AI Generates, You Verify](ai-generates-you-verify) | Prompt AI to implement your stub, verify with pytest and PRIMM |
| 4 | [When AI Gets It Wrong](when-ai-gets-it-wrong) | Handle a failed generation -- read the failure, re-prompt, verify again |
