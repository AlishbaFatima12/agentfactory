...
- **Builds on**: Principle 4 (Small, Reversible Decomposition from Chapter 17) governs process (how you work); Axiom IV governs architecture (what you build). Process = task decomposition into commits/steps; Architecture = system decomposition into functions/modules.
