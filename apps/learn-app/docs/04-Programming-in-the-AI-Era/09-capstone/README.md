---
title: "Phase 9 — Capstone"
sidebar_position: 0
---

# Phase 9 — Capstone

### Chapters 55, 56: Prove
...
| #  | Chapter | Key Focus |
|----|---------|-----------|
| 55 | When Not to Use AI | Judgment and knowing when manual is better |
| 56 | QuizForge Capstone — AI-Powered Quiz Generator | The complete cycle, from scratch |
