...
layer_2_collaboration: "Using Claude as a business strategy advisor to apply MBA frameworks, generate competitive analyses, and build financial models"
...
skills:
  - name: "Competitive Strategy Analysis"
    ...
    measurable_at_this_level: "Student can run a Porter's Five Forces analysis on their own industry using Claude"
  ...
  - name: "Business Model Design"
    ...
    measurable_at_this_level: "Student can generate a Business Model Canvas and TAM/SAM/SOM analysis using Claude and the StratArts plugin"

  - name: "Financial Statement Literacy"
    proficiency_level: "A2"
    category: "Conceptual"
    bloom_level: "Understand"
    digcomp_area: "Information-Data-Literacy"
    measurable_at_this_level: "Student can explain income statement, balance sheet, and cash flow statement as business stories, and identify red flags"
  ...
  - name: "Strategic Framework Selection"
    ...
    bloom_level: "Analyze"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can choose the right MBA framework for a given business scenario"

learning_objectives:
  - objective: "Apply Porter's Five Forces to analyze competitive dynamics in a specific industry"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student produces a Five Forces analysis with rated forces and strategic positioning recommendation"
  - objective: "Generate a Business Model Canvas and market sizing using the StratArts plugin"
    proficiency_level: "A2"
    bloom_level: "Apply"
    assessment_method: "Student installs StratArts, invokes business-model-designer, and produces a complete BMC"
  - objective: "Interpret financial statements as business narratives and identify warning signs"
    proficiency_level: "A2"
    bloom_level: "Understand"
    assessment_method: "Student explains what income statement, balance sheet, and cash flow tell about a company's health"
  - objective: "Select the appropriate MBA framework for different business scenarios"
    proficiency_level: "A2"
    bloom_level: "Analyze"
    assessment_method: "Student correctly matches 4 scenarios to the right framework with reasoning"
...
differentiation:
  ...
  remedial_for_struggling: "Start with Porter's Five Forces on a familiar industry (e.g., coffee shops, ride-sharing) before applying to own business"
...
teaching_guide:
  ...
  assessment_quick_check:
    ...
    - "What does a Jobs-to-be-Done analysis reveal that a feature list does not?"
---
...
| Tier                       | Frameworks                                                                             | Depth                |
| :------------------------- | :------------------------------------------------------------------------------------- | :------------------- |
| **Analytical** (deep dive) | Harvard Case Study, Porter's Five Forces, Christensen Disruption, Financial Statements | Full worked examples |
| **Strategic** (applied)    | Marketing Strategy, Negotiation, Pricing Strategy                                      | Framework + prompt   |
| **Leadership** (applied)   | Leadership & Management, Organizational Design, Operations                             | Framework + prompt   |
...
Michael Porter's framework is the most widely used tool in competitive strategy. It answers one question: _how attractive is this industry to compete in?_

The five forces:

| Force                      | What It Measures                       | High = Bad For You                          |
| :------------------------- | :------------------------------------- | :------------------------------------------ |
| **Threat of new entrants** | How easy is it for newcomers to enter? | Low barriers = more competition             |
| **Supplier power**         | Can suppliers dictate terms?           | Few suppliers = they set prices             |
| **Buyer power**            | Can customers dictate terms?           | Commodity products = buyers choose on price |
| **Threat of substitutes**  | Can customers switch to alternatives?  | Many alternatives = price pressure          |
| **Competitive rivalry**    | How intense is existing competition?   | Many equal competitors = margin pressure    |
...
Clayton Christensen's _Innovator's Dilemma_ explains why great companies fail. The theory: incumbents over-serve their best customers with features nobody asked for, while startups offer simpler, cheaper alternatives that "good enough" customers adopt.
...
Every business runs on three financial statements. You do not need an accounting degree -- you need to read them as _stories about a business_:

| Statement               | The Story It Tells                      | Key Question                             |
| :---------------------- | :-------------------------------------- | :--------------------------------------- |
| **Income statement**    | How the business makes (or loses) money | Is revenue growing? Are margins healthy? |
| **Balance sheet**       | What the company owns vs what it owes   | Can it pay its debts?                    |
| **Cash flow statement** | Where real money moves                  | Is it generating cash or burning it?     |
...
| Category                | Skills                                                                                                                                                                                   | Key Frameworks                         |
| :---------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------- |
| **Foundation Strategy** | business-model-designer, competitive-intelligence, customer-persona-builder, value-proposition-crafter, market-opportunity-analyzer, business-idea-validator, product-positioning-expert | BMC, JTBD, April Dunford positioning   |
| **Market & Product**    | go-to-market-planner, pricing-strategy-architect, feature-prioritization-framework, strategic-roadmap-builder                                                                            | RICE, OKR alignment                    |
| **Marketing & Growth**  | content-marketing-strategist, growth-hacking-playbook, social-media-strategist, seo-content-planner, email-marketing-architect, brand-identity-designer, community-building-strategist   | AARRR, Traction Bullseye               |
| **Retention & Metrics** | metrics-dashboard-designer, retention-optimization-expert, onboarding-flow-optimizer, customer-feedback-framework                                                                        | Cohort analysis, NPS                   |
| **Fundraising & Ops**   | financial-model-architect, fundraising-strategy-planner, investor-pitch-deck-builder, investor-brief-writer, operational-playbook-creator                                                | Van Westendorp pricing, unit economics |
...
| You Need To...                               | Use This Framework                | Why                                          |
| :------------------------------------------- | :-------------------------------- | :------------------------------------------- |
| Understand competitive dynamics              | Porter's Five Forces              | Maps all competitive pressure sources        |
| Evaluate if your industry is being disrupted | Christensen Disruption            | Identifies over/underserved segments         |
| Design a business model                      | Business Model Canvas (StratArts) | Structures all 9 model components            |
| Size a market opportunity                    | TAM/SAM/SOM (StratArts)           | Separates dream from realistic targets       |
| Understand a company's health                | Financial Statements              | Numbers tell the real story                  |
| Set prices                                   | Pricing Strategy                  | Balances value, competition, and psychology  |
| Prepare for a deal                           | Negotiation (BATNA/ZOPA)          | Structured preparation beats improvisation   |
| Develop as a leader                          | Leadership Framework              | Targeted development, not generic advice     |
| Launch a product                             | Go-to-Market (StratArts)          | Channel strategy + positioning + metrics     |
| Learn from a real company's decision         | Harvard Case Study                | Builds judgment through analysis of outcomes |
