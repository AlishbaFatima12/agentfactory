...
- **Version output format**: `claude --version` outputs `X.X.XX (Claude Code)`, matching the format shown in Lesson 2
...
- **Leads to**: Lessons 4-13 work identically regardless of which setup path you chose (persistent context, MCP, subagents, skills, hooks, configuration)
