...
Setting up Claude Cowork is a one-time configuration of three things: installing the Desktop app, switching to the Cowork tab, and granting folder access. After setup, Claude can act on your files with your approval at each step.
...
- Switch to the Cowork tab (not Chat) to activate autonomous background capabilities: the folder access panel confirms you are in the right mode.
...
- Trying to use Cowork on an Intel Mac: Apple Silicon (M1+) is required on macOS. On Windows, both x64 and ARM64 are supported.

### Connections

- **Builds on**: Claude Cowork concepts and the agent vs. chatbot distinction from Lesson 25
- **Leads to**: Practical Cowork workflows for documents and file operations (Lesson 27)
