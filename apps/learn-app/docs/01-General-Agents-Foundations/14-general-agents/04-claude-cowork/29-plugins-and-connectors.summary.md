...
- Install Plugins from the **+** button > **Plugins** > **Add plugin** menu; all components activate immediately
...
- Add Connectors via the **+** button > **Connectors** menu in the prompt box; manage them in Settings > Connectors
