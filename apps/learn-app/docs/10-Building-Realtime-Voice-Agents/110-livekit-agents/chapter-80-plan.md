# Chapter 110: LiveKit Agents - Lesson Plan

**Generated by**: chapter-planner v2.0.0 (Reasoning-Activated)
**Source**: Part 10 README, Deep Search Report, Chapter 109 context
**Created**: 2026-01-01
...
**Core Concepts** (from Deep Search + Part 10 README): 10 concepts
...
- Capstone for Part 10 is Chapter 115, so Chapter 110 focuses on skill improvement, not full capstone

---

## II. Success Evals (from Part 10 README + Chapter 110 Description)
...
1. **Draft Your LEARNING-SPEC.md**
   ...
   - I understand voice AI fundamentals from Chapter 109
...
- Prepares for: Chapter 111 (Pipecat) - alternative framework comparison
...
**Chapter 110: LiveKit Agents** is a 4-lesson SKILL-FIRST technical chapter:
