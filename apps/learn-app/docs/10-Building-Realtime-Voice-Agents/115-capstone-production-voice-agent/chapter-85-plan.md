# Chapter 115: Production Voice Agent (Capstone) - Lesson Plan

**Generated by**: chapter-planner v2.0.0 (Reasoning-Activated)
**Source**: Part 10 README, Chapters 79-84 context, Deep Search Report
**Created**: 2026-01-02
...
**TECHNICAL (LAYER 4 CAPSTONE)** - This is the integrative capstone for Part 10. Students orchestrate ALL accumulated knowledge from Chapters 79-84 into a production-grade voice-enabled Task Manager.
...
## II. Success Evals (from Part 10 README)
...
## III. Accumulated Skills from Part 10
...
**Foundational knowledge** (Chapter 109):
...
3. **Architecture Decision: Native S2S vs Cascaded** (~10 min)
   - Review Chapter 109 decision matrix
...
5. **Multimodal Screen Sharing** (~15 min)
   - Use Gemini Live API knowledge from Chapter 113
...
6. **Natural Conversation Patterns** (~10 min)
   - Semantic turn detection configuration (from Chapter 110)
   - Barge-in handling (from Chapter 112)
...
3. **Add Screen Sharing**
   ...
   Using my knowledge from Chapter 113, help me:
...
|-------|--------|------------------|
| `livekit-agents` | Chapter 110 | Core voice agent, WebRTC, multi-agent patterns |
| `pipecat` | Chapter 111 | Provider flexibility, custom processors |
| `voice-telephony` | Chapter 114 | Phone/Twilio integration |
| `web-audio-capture` | Chapter 114 | Browser audio capture |

**Direct API Knowledge Applied**:
- OpenAI Realtime API (Chapter 112): Understanding for Native S2S comparison
- Gemini Live API (Chapter 113): Multimodal screen sharing integration
...
- [x] Requires: Chapter 109 (architecture mental models)
- [x] Requires: Chapter 110 (livekit-agents skill)
- [x] Requires: Chapter 111 (pipecat skill)
- [x] Requires: Chapter 112 (OpenAI Realtime understanding)
- [x] Requires: Chapter 113 (Gemini Live for multimodal)
- [x] Requires: Chapter 114 (voice-telephony, web-audio-capture skills)
...
**Chapter 115: Production Voice Agent (Capstone)** is a 3-lesson Layer 4 integration chapter:
...
This capstone fulfills Part 10's contribution to the book's thesis: **"Manufacture Digital FTEs powered by agents, specs, skills."**

Students graduate Part 10 with:
