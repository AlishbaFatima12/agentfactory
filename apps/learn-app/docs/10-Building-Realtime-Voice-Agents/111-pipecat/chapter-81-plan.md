# Chapter 111: Pipecat - Lesson Plan

**Generated by**: chapter-planner v2.0.0 (Reasoning-Activated)
**Source**: Part 10 README, Deep Search Report, Chapter 110 context
**Created**: 2026-01-01
...
- Follows L00 pattern established in Parts 6-8 and Chapter 110
...
**Proficiency Tier**: B1-B2 (Part 10 requires Parts 6, 7, 9, 10 completed; students have production experience)
...
- Chapter 110 covered similar voice AI fundamentals, reducing cognitive load
- 3 lessons sufficient for skill-first framework mastery

---

## II. Success Evals (from Part 10 README + Chapter 111 Description)
...
- Chapter 109 completed (voice AI fundamentals)
- Chapter 110 recommended (LiveKit comparison context)
...
1. **Draft Your LEARNING-SPEC.md**
   ...
   My context:
   - I just learned LiveKit Agents in Chapter 110
...
- Requires: Chapter 110 (LiveKit Agents) - comparison context, voice pipeline understanding
- Prepares for: Chapter 112 (OpenAI Realtime API) - direct API access after framework abstraction
- Prepares for: Chapter 115 (Capstone) - production voice agent
...
**Chapter 111: Pipecat** is a 3-lesson SKILL-FIRST technical chapter:
...
**Comparison to Chapter 110 (LiveKit)**:
- Chapter 110: 4 lessons, 10 concepts, distributed architecture focus
- Chapter 111: 3 lessons, 9 concepts, modular composition focus
