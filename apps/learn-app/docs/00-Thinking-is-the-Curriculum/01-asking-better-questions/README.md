---
sidebar_position: 0
title: "Chapter 1: Asking Better Questions"
slides:
  source: "https://pub-80f166e40b854371ac7b05053b435162.r2.dev/books/ai-native-dev/static/slides/part-0/chapter-02/asking-better-questions.pdf"
  title: "Asking Better Questions: The Cognitive Gauntlet"
  height: 700
---
...
| :------: | ------------------------------------------------------ | ---------------- | ---------------------------------------------------- |
|    1     | [The Prediction Lock](./01-prediction-lock.md)         | Layer 1, Layer 2 | Sealed prediction document + reasoning receipt       |
|    2     | [The Question Tournament](./02-question-tournament.md) | Layer 3, Layer 5 | Comparison table ranking questions from two students |
|    3     | [The Divergence Test](./03-divergence-test.md)         | Layer 5, Layer 2 | Original analysis with uniqueness statement          |
|    4     | [Live Defence](./04-live-defence.md)                   | Layer 3, Layer 4 | Peer defence record + counter-argument response      |
