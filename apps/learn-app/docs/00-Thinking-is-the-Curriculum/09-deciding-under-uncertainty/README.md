---
sidebar_position: 0
title: "Chapter 9: Deciding Under Uncertainty"
slides:
  source: "https://pub-80f166e40b854371ac7b05053b435162.r2.dev/books/ai-native-dev/static/slides/part-0/chapter-10/the-60-percent-rule.pdf"
  title: "The 60 Percent Rule"
  height: 700
---
...
| --- | --- | --- | --- |
| [Exercise 1: The Incomplete Brief](./01-sealed-decision.md) | The Incomplete Brief | Layer 1 | A sealed Decision Document with confidence level, missing information ranked by impact, and a Reversal Trigger |
| [Exercise 2: The AI Consultation](./02-ai-consultation.md) | The AI Consultation | Layers 2, 4 | A Consultation Log documenting AI fabrication detection and trust decisions, with updated Decision Document |
| [Exercise 3: The Information Drop](./03-information-drop.md) | The Information Drop | Layers 4, 6 | A revised Decision Document under 20-minute time pressure, with Calibration Check across three stages |
| [Exercise 4: The Decision Audit](./04-decision-audit.md) | The Decision Audit | Layer 6 | A Decision Audit analyzing calibration accuracy and heuristics, plus AI assessment of your self-assessment |
