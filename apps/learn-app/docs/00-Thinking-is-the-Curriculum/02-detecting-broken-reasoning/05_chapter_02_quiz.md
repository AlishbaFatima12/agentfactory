...
options: [
"Logical gaps are broader, covering any conclusion not following from premises; correlation-causation is a specific subtype",
...
options: [
"Domain expertise dramatically affects error detection ability, so caution is needed outside your expertise",
...
correctOption: 1,
explanation: "Perfect calibration means confidence matches reality across the full range. Claims rated 90% confident are correct 90% of the time. Claims rated 30% confident are correct 30% of the time. Rating everything at 50% or 100% shows poor calibration, because the student is not distinguishing between claims they can judge and claims they cannot.",
source: "Exercise 4: Confidence Calibration"
},
{
...
"Outdated information was correct when published but is no longer current, so it requires different detection than outright false claims"
],
correctOption: 3,
...
"To compare error patterns across tools, since different tools may fail in different ways on the same question"
],
correctOption: 3,
...
correctOption: 1,
explanation: "The 20% weight evaluates the three-draft evolution, specifically whether genuine intellectual improvement is visible across drafts. Finding contradictions is necessary but not sufficient. There is no 'correct winner' between AI responses. The grade lives in the gaps between drafts: did the student's thinking genuinely improve through the iterative process?",
source: "Exercise 2: The Contradiction Test"
},
{
