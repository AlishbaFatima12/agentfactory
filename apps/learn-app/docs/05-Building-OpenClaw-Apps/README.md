...
sidebar_position: 5
description: "Experience, understand, and build applications on the OpenClaw agent platform — from first AI employee to production MCP-first architecture"
keywords:
  [
    openclaw,
    agent platform,
...
|---|---------|---------------|
| 56 | [Meet Your First AI Employee — OpenClaw](./56-meet-your-first-ai-employee/README.md) | Set up OpenClaw, use it on WhatsApp, understand the 6 universal agent patterns, create custom skills, evaluate security, delegate to Claude Code |
| 57 | [Building Your First OpenClaw Application](./57-building-openclaw-apps/README.md) | Design and build a production app using the MCP-first pattern — remote MCP server + Cloudflare R2 + shim skill |
