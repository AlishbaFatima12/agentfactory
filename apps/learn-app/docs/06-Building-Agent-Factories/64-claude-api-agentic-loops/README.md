...
sidebar_position: 64
description: "Master the raw Claude API mechanics that every agent SDK abstracts — stop_reason, tool_use, tool_choice, JSON schemas, validation-retry loops, and the Batch API"
keywords:
  [
    claude api,
    messages api,
