...
You'll learn to build evaluation systems for these questions in Chapter 77. For now, the key insight: **don't try to TDD these qualities by mocking LLM responses**.
