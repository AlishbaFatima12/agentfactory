### Core Concept
20-question assessment covering all Chapter 67 topics: Context objects, sampling, notifications, roots, transport, scaling, error handling, and packaging. Tests both conceptual understanding and implementation knowledge. Passing: 15/20 (75%), Advanced: 18/20 (90%).
...
- **Leads to**: Chapter 68 (Agent Skills)
