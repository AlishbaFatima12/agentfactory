...
1. Build your MCP server (you already know how from Chapter 67)
...
├─────────────────────────────────────────────────────────────────┤
│                        LAYER 3: MCP Server                      │
│   - Your FastMCP/Node server (just like Chapter 67)             │
...
**Layer 3: MCP Server** is the backend you already know how to build from Chapters 66-67. The difference? Your tool responses include special metadata that tells ChatGPT to render a widget instead of just showing text.
...
| Aspect | Agents SDK (Chapter 62) | Apps SDK (This Chapter) |
|--------|-------------------------|-------------------------|
...
You already know how to build MCP tools from Chapter 67. Widget-enabled tools differ in three key ways:
...
- OpenAI Agents SDK (what we learned in Chapter 62)
