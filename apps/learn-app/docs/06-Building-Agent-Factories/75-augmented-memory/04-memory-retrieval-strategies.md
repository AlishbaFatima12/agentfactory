...
cognitive_load:
  new_concepts: 4
  assessment: "Medium cognitive load with 4 retrieval strategies. Code examples ground abstract concepts. Builds on vector search concepts from Chapter 73 (RAG)."
