...
- Which MCP? [e.g., "Salesforce connector MCP from Chapter 66"]
...
```
I need to compose skills from Chapter 68 into an orchestrator that implements my specification above.
