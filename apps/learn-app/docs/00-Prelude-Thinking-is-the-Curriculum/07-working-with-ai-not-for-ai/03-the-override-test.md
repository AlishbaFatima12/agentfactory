...
Chapter 2's error detection applied to AI's business analysis. Your Error Taxonomy from [Chapter 2](../03-detecting-broken-reasoning/01-error-prediction.md) is now your override trigger. The same diagnostic rigor applies -- but the errors are in AI output rather than in a scenario.
:::
