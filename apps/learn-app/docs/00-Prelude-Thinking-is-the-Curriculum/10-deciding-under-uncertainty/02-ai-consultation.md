...
You will use the **Collaboration Log** format from [Chapter 6, Exercise 2](../07-working-with-ai-not-for-ai/02-collaboration-log.md), now applied under time pressure with incomplete data.
:::
