...
Decision-making under uncertainty directly uses your **Confidence Calibration** from [Chapter 2, Exercise 4](../03-detecting-broken-reasoning/04-confidence-calibration.md), the **Assumption Autopsy** from [Chapter 4, Exercise 3](../05-reasoning-from-first-principles/03-assumption-autopsy.md), and the **Collaboration Log** format from [Chapter 6, Exercise 2](../07-working-with-ai-not-for-ai/02-collaboration-log.md). Your Error Taxonomy should now be instinctive when evaluating AI output under time pressure.
:::
...
You will use **Confidence Calibration** from [Chapter 2, Exercise 4](../03-detecting-broken-reasoning/04-confidence-calibration.md) — now applied to decisions, not claims — and the **Assumption Autopsy** from [Chapter 4, Exercise 3](../05-reasoning-from-first-principles/03-assumption-autopsy.md) — your missing information list is an assumption list.
:::
