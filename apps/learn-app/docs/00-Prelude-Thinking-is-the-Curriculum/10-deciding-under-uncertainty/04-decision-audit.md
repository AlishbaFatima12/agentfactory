...
skills:
  - name: "Decision Audit"
    ...
    measurable_at_this_level: "Student can retrospectively audit their own decision process across multiple stages, accurately identifying calibration strengths, weaknesses, and the heuristics that helped or hurt"

  - name: "Meta-Cognitive Self-Assessment"
    proficiency_level: "A1"
    category: "Conceptual"
    bloom_level: "Evaluate"
    digcomp_area: "Critical Thinking"
...
learning_objectives:
  ...
  - objective: "Identify the specific heuristics you relied on and evaluate whether they helped or hurt your decision quality"
    proficiency_level: "A1"
    bloom_level: "Evaluate"
    assessment_method: "AI Check rates whether identified heuristics match the actual decision trail or are post-hoc rationalizations"
...
differentiation:
  ...
  remedial_for_struggling: "Focus on answering three questions: (1) Was I overconfident or underconfident at each stage? (2) What was my best decision and why? (3) What is one specific thing I will do differently next time?"
...
The Decision Audit uses your **Confidence Calibration** skills from [Chapter 2, Exercise 4](../03-detecting-broken-reasoning/04-confidence-calibration.md) to assess the accuracy of your confidence at each decision stage.
:::
