...
You will use the **Error Taxonomy** from [Chapter 2, Exercise 1](../03-detecting-broken-reasoning/01-error-prediction.md) to identify errors in causal reasoning. Systems errors build on the error detection skills you practiced there.
:::
