...
teaching_guide:
  ...
  key_points:
    ...
    - "The key insight: in a country where 60% are unbanked and rely on personal relationships, the entire dynamic around trust and access changes fundamentally"
  misconceptions:
  ...
  teaching_tips:
    ...
    - "The specific variable shift ('60% unbanked, personal relationships') is deliberately context-rich — it does not just change numbers, it changes the entire social fabric around banking"
...
You will use the same skill from [Chapter 2's Contradiction Test](../03-detecting-broken-reasoning/02-contradiction-test.md) — handling changing information — applied to systems rather than arguments.
:::
