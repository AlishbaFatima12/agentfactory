...
This capstone chapter calls on everything: you will use **question formulation** ([Chapter 1](../02-asking-better-questions/01-prediction-lock.md)) to design your learning plan, **error detection** ([Chapter 2](../03-detecting-broken-reasoning/01-error-prediction.md)) to evaluate AI's teaching, **systems thinking** ([Chapter 3](../04-thinking-in-systems/01-cascade-mapping.md)) to understand how concepts connect, **first principles** ([Chapter 4](../05-reasoning-from-first-principles/01-blank-page-derivation.md)) to build understanding from foundations, and **AI collaboration** ([Chapter 6](../07-working-with-ai-not-for-ai/01-three-path-comparison.md)) to learn efficiently without becoming dependent.
:::
...
Your learning plan is a **Prediction Lock** — a prediction about your own learning process, committed before you begin. You will use the same format from [Chapter 1, Exercise 1](../02-asking-better-questions/01-prediction-lock.md).
:::
