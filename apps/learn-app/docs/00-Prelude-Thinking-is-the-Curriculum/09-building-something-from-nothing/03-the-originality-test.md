...
differentiation:
  extension_for_advanced: "Run the originality test with both Claude and ChatGPT independently. Compare the two AI solutions against each other and against yours -- does the triangulation reveal more about where human value lives?"
...
You will apply the **Assumption Autopsy** technique from [Chapter 4](../05-reasoning-from-first-principles/03-assumption-autopsy.md) to examine your assumptions about your own originality. Use the **Cascade Map** from [Chapter 3](../04-thinking-in-systems/01-cascade-mapping.md) to trace which ideas in your solution came from which source.
:::
