...
You will use the **Reasoning Receipt** format from [Chapter 1, Exercise 1](../02-asking-better-questions/01-prediction-lock.md). Your annotation practice from Chapter 1 becomes error annotation here.
:::
