...
The **Error Taxonomy** from Chapter 2 helps you catch flawed assumptions. The **cascade mapping** from [Chapter 3](../03-thinking-in-systems/01-cascade-mapping.md) helps you see downstream effects of each assumption. Your **Prediction Lock** habit should now be automatic.
:::
