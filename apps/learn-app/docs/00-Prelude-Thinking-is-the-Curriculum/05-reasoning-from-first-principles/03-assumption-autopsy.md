...
You will use the **Error Taxonomy** from [Chapter 2, Exercise 1](../03-detecting-broken-reasoning/01-error-prediction.md) and the **Cascade Map** technique from [Chapter 3, Exercise 1](../04-thinking-in-systems/01-cascade-mapping.md). Assumptions are hidden errors; finding them uses the same detection muscle.
:::
