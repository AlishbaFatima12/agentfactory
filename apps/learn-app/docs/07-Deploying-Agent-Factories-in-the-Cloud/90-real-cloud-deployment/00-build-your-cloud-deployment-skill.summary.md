### Core Concept
Start Chapter 90 by creating a cloud-deployment skill that captures patterns for provisioning clusters, networking, secrets, and app rollout—built from official docs and refined through the chapter.
