...
Your kubectl and Helm skills from Chapters 80-81 work identically on DOKS. The only difference is how you connect.
...
In Lesson 3, you'll use these credentials to provision your first DOKS cluster. The `kubectl` commands you learned in Chapter 80 will work identically—the only difference is the cluster runs on DigitalOcean's infrastructure instead of your laptop.
