...
In Docker (Chapter 79), a container had a stable network identity. You'd run a container, learn its IP, and talk to it.
...
**Challenge**: You have a FastAPI agent running in Kubernetes (from Chapter 79 containerization). Expose it so:
