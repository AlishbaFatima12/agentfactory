...
You learned Kafka directly in Chapter 82. You wrote code that knew about brokers, topics, and consumer groups. If you wanted to switch from Kafka to RabbitMQ, you'd rewrite your messaging code. Different SDK, different connection logic, different error handling.
...
|----------------|--------------|
| **Actors** | Stateful virtual actors require a separate mental model (Chapter 89) |
| **Workflows** | Long-running orchestration builds on actors (Chapter 89) |
...
| `pubsub.kafka` | Apache Kafka | Production event streaming (Ch82) |
...
### The Connection to Chapter 82

In Chapter 82, you wrote Kafka-specific code:
