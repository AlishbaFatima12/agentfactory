...
# Chapter 81: Helm Charts for AI Services
...
- Chapter 80 Kubernetes fundamentals (Pods, Deployments, Services, ConfigMaps, Secrets, RBAC, HPA)
...
- **Chapter 82 (Kafka)**: Event-driven architecture with Helm-deployed message brokers
- **Chapter 85 (CI/CD)**: GitOps pipelines that automatically deploy your Helm charts
- **Chapter 86 (Observability)**: Monitoring charts with Prometheus and Grafana dependencies
