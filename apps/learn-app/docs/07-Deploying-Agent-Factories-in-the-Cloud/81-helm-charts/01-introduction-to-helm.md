...
**Setup**: You have your Task API container image from Chapter 79 pushed to a registry. You'll parameterize a Helm chart to support three environments (dev, staging, production) with different replicas, resources, and database configurations.

**Prompts**:

1. **Chart Creation with AI**:
   ```
   I have my Task API image at your-registry/task-api:latest from Chapter 79.
