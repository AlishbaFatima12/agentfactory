...
cognitive_load:
  new_concepts: 4
  assessment: "Within B1 limit of 10. Four focused concepts: state encryption, mTLS verification, audit logging, and threat modeling. Each builds on existing Dapr security knowledge from Chapter 83."
