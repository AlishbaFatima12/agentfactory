...
You have a fine-tuned model from Chapter 94. It knows the Task API domain—task creation, priorities, due dates, categories. It gives accurate answers.
...
Your Chapter 94 model sits in the "Reference Manual" quadrant—high knowledge, low personality. Chapter 95 moves it to "Digital FTE"—high on both dimensions.
