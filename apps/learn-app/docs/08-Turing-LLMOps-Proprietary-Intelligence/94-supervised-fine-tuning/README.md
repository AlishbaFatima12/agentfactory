...
# Chapter 94: Supervised Fine-Tuning (SFT)

You build a `fine-tuning` skill first, then train models with LoRA/QLoRA (Unsloth) on Colab T4. The Task API dataset from Chapter 93 powers your first supervised run.
...
- Chapters 91-93 (strategy, architecture, data)
