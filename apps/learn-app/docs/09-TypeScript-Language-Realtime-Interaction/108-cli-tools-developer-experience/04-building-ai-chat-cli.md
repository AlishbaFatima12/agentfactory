...
source_spec: Part 9, Chapter 108, Lesson 4
created: 2026-01-01
...
These types reflect what you learned about discriminated unions in Chapter 103. The `StreamChunk` type with its `type` discriminator enables TypeScript to narrow the type in switch statements.
