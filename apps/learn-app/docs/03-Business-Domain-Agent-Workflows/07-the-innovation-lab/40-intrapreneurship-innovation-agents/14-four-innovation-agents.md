...
keywords:
  [
    ...
    "fundraising readiness agent",
    "Monday innovation brief",
    "customer signal digest",
    "financial health review",
    "persistent agent",
    "weekly automation",
    "innov.local.md",
    "innovation agents chapter",
  ]
chapter: 40
lesson: 14
duration_minutes: 40
...
skills:
  - name: "Explain the Role and Weekly Deliverables of Each Innovation Agent"
  ...
  - name: "Configure Persistent Agents to Monitor a Venture's Innovation Metrics"
    ...
    measurable_at_this_level: "Student can invoke each of the 4 agents for a specific venture context and evaluate whether the output is specific to their venture (draws from innov.local.md) or generic (ignores venture context)"
...
learning_objectives:
  ...
  - objective: "Describe the weekly automated deliverable and primary on-demand use case for each of the 4 innovation agents"
    proficiency_level: "B1"
    bloom_level: "Understand"
    assessment_method: "Student can match each agent to its correct weekly output format (Monday Innovation Brief, Customer Signal Digest, Financial Health Review, Investor Pipeline Update) and its primary trigger condition"
...
| Dimension         | Skills (Commands)                          | Agents (Persistent)                                                   |
| ----------------- | ------------------------------------------ | --------------------------------------------------------------------- |
| Activation        | You invoke them when you need them         | They activate on schedule or trigger                                  |
| Frequency         | On-demand; once per invocation             | Weekly automated + on-demand                                          |
| Context awareness | Reads innov.local.md if you provide it     | Reads innov.local.md automatically every invocation                   |
| Output            | Single-task response                       | Continuous intelligence over time                                     |
| Primary use case  | Specific synthesis, analysis, or creation  | Pattern monitoring, proactive surfacing, readiness                    |
| Example           | `/discovery` synthesises 10 interviews now | Customer Intelligence agent synthesises all week's feedback on Monday |
...
| -------------------------- | ------------------------------------------------------------------------------- |
| Investor pipeline          | Stakeholder alignment tracker (CHAMPION / NEUTRAL / RESISTANT)                  |
| Pitch deck                 | Business case document                                                          |
| Data room                  | Evidence pack: pilot results, financial justification, risk assessment          |
| 15 hard Q&A answers        | Objections from CFO, Legal, IT, and HR                                          |
