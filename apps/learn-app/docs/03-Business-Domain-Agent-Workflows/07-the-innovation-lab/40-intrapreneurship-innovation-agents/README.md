...
# Chapter 40: Intrapreneurship & Innovation Agents
...
| ----------------------------------------------------- | ------------------------------------------ | -------- | --------------------------------------------------------------------------------------------------------------------------- |
| [L01](./01-the-innovation-os.md)                      | The Innovation OS                          | 25 min   | The DLA Stack framework, why methodology order matters, and how AI accelerates each stage                                   |
| [L02](./02-plugin-architecture-installation.md)       | Plugin Architecture and Installation       | 20 min   | Plugin installed, 10 commands mapped to DLA stages, `innov.local.md` template understood                                    |
...
| [L10](./10-competitive-intelligence-market-sizing.md) | Competitive Intelligence and Market Sizing | 40 min   | Competitive landscape scan, bottom-up TAM/SAM/SOM, moat assessment                                                          |
