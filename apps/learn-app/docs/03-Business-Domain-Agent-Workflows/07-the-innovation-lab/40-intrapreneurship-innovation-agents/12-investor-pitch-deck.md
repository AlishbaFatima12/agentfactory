---
slug: /Business-Domain-Agent-Workflows/intrapreneurship-innovation-agents/investor-pitch-deck
sidebar_position: 12
title: "Investor Pitch Deck"
description: "Construct a 9-slide investor pitch narrative with emotional engineering per slide, prepare honest answers for the 15 hardest investor questions, and write a 100-word executive summary using the /pitch skill"
keywords:
  [
    "investor pitch deck",
    "pitch narrative",
...
skills:
  - name: "Construct a 9-Slide Investor Pitch Narrative with Emotional Engineering"
...
learning_objectives:
  - objective: "Build a 9-slide investor pitch narrative using the Hook-to-Vision arc, with each slide engineered for a specific investor emotion"
    proficiency_level: "B2"
    bloom_level: "Create"
    assessment_method: "Student produces a pitch deck narrative where all 9 slides are present, each has a headline free of banned phrases, and the traction slide uses data from the traction hierarchy (revenue > pilot results > LOIs > waitlist > interviews)"

  - objective: "Evaluate pitch weaknesses by preparing honest answers to the 15 hardest investor questions"
    proficiency_level: "B2"
    bloom_level: "Evaluate"
    assessment_method: "Student identifies at least 3 slides or claims for which they currently lack strong evidence and writes a concrete action plan to address each before pitching"

  - objective: "Synthesise venture data into a 100-word executive summary suitable for an investor email introduction"
    proficiency_level: "B1"
    bloom_level: "Create"
    assessment_method: "Student produces an executive summary that includes all five elements (problem, solution, traction, ask, differentiation) in under 120 words with no placeholder text"
...
| ----- | -------------- | ------------------------------------------- |
| 1     | The Hook       | Curiosity + urgency                         |
| 2     | The Problem    | Recognition; empathy with customer          |
| 3     | The Solution   | Relief; "this makes sense"                  |
| 4     | The Market     | Scale calibration; achievable               |
| 5     | Traction       | De-risking; this team can execute           |
| 6     | Business Model | Financial conviction                        |
| 7     | The Team       | Trust                                       |
...
| Pitch Deck Slide | Business Case Equivalent                                  |
| ---------------- | --------------------------------------------------------- |
...
**Type:** Fundraising / Narrative Architecture
**Time:** 90 minutes
**Goal:** Write the narrative for a 9-slide investor pitch deck for your own venture
...
Continue to [Lesson 13: Innovation Sprints →](./13-innovation-sprints.md)
