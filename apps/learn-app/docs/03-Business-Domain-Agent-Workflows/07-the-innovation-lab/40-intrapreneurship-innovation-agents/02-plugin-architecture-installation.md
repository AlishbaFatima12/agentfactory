...
description: "Install the innovation plugin in Cowork, learn the 10-command map across all DLA stages, and understand the innov.local.md configuration template that makes every output specific to your venture"
keywords:
  [
    "innovation plugin",
    "Cowork plugin",
...
skills:
  - name: "Install and verify the innovation plugin in Cowork"
    proficiency_level: "A2"
    category: "Technical"
    bloom_level: "Apply"
    digcomp_area: "Content-Creation"
    measurable_at_this_level: "Student can install the innovation plugin via Cowork's plugin browser, verify all 10 commands are available, and confirm the plugin responds to a test prompt"

  - name: "Navigate the innov.local.md template structure and understand what each section configures"
    proficiency_level: "A2"
    category: "Technical"
...
learning_objectives:
  - objective: "Install the innovation plugin and verify that all 10 commands are available in Cowork"
    proficiency_level: "A2"
    bloom_level: "Apply"
    assessment_method: "Student runs a verification prompt and receives a correct list of 10 commands with descriptions; plugin is confirmed installed"

  - objective: "Map each of the 10 commands to its DLA stage and explain what it produces"
    proficiency_level: "A2"
    bloom_level: "Understand"
    assessment_method: "Student can complete a table matching each command to its stage (Design Thinking, Lean Startup, Agile, or cross-cutting) without referring to the lesson"

  - objective: "Describe the purpose of innov.local.md and identify the sections most critical to complete before starting exercises"
    proficiency_level: "A2"
    bloom_level: "Understand"
    assessment_method: "Student can explain why a blank innov.local.md produces generic outputs and why filling in the venture and customer_profiles sections changes this"
...
- `/sprint` before assumptions are validated: "Your assumption stack has 8 untested HIGH-risk assumptions. Running sprints before validating these risks building the wrong thing."
...
Continue to [Lesson 3: Customer Discovery and Problem Statement →](./03-customer-discovery-problem-statement.md)
