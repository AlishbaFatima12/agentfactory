...
skills:
  - name: "Explain the DLA Stack and why each methodology operates at a different level of uncertainty"
    proficiency_level: "A2"
    category: "Conceptual"
    bloom_level: "Understand"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can describe what Design Thinking, Lean Startup, and Agile each answer, and identify which methodology applies to a given innovation challenge"

  - name: "Identify which DLA stage applies to a given innovation scenario"
    proficiency_level: "A2"
    category: "Conceptual"
...
learning_objectives:
  ...
  - objective: "Explain why using the DLA methodologies out of order produces predictable failure modes"
    proficiency_level: "A2"
    bloom_level: "Understand"
    assessment_method: "Given a scenario where a team jumped straight to building without discovery, student can name the failure mode and which DLA stage was skipped"

  - objective: "Describe what AI accelerates in the DLA Stack and what remains the entrepreneur's responsibility"
    proficiency_level: "A2"
    bloom_level: "Remember"
    assessment_method: "Student can complete the sentence 'AI accelerates [X] but does not replace [Y]' with accurate examples from the AI acceleration table"
...
teaching_guide:
  ...
  discussion_prompts:
    ...
    - "Where in the DLA Stack do most teams in your industry tend to start? What does that tell you about the culture?"
  teaching_tips:
    - "Open with the failure mode, not the framework. Ask: 'Has anyone ever built something that nobody wanted?' Then explain the DLA Stack as the methodology designed to prevent that."
    - "Use the AI acceleration table as a reference document, not a lecture slide. Point students to it and tell them: this is what you are getting back in this chapter."
---
...
| DLA Stage                  | Traditional Bottleneck                        | With AI                                                    |
| -------------------------- | --------------------------------------------- | ---------------------------------------------------------- |
| Design Thinking: Empathise | Interview synthesis takes weeks               | 10 interviews → insight map in approximately 2 hours       |
...
| Design Thinking: Prototype | Concept creation takes creative expertise     | Concept sketches, user stories, mockup briefs immediately  |
