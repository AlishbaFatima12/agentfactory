...
skills:
  - name: "Scope an MVP that tests the top three critical assumptions with explicit feature in/out decisions"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can produce an MVP design document where every included feature maps to at least one critical assumption, and every excluded feature has a documented reason why it tests no critical assumption at this stage"

  - name: "Write measurable success and failure criteria that trigger a pivot-or-persevere decision"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can write specific, measurable success criteria (e.g., '3 customers pay $500/month before build') and failure criteria (e.g., 'cannot sign 3 pilots at $500 → pricing assumption wrong → pivot on price') rather than vague goals like 'good adoption' or 'users like it'"

learning_objectives:
  - objective: "Apply feature inclusion criteria to scope an MVP that tests only critical assumptions"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student produces an MVP with at least 5 features and an exclusion list of at least 5 features. Every included feature maps to a TIER 1 or TIER 2 assumption from the Lesson 5 map. Every excluded feature has a written rationale for why it was excluded."

  - objective: "Define specific, measurable success and failure criteria for an MVP pilot"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student writes 3-4 success criteria where each criterion is specific (a number), measurable (observable from pilot data), and maps to a critical assumption. Failure criteria explicitly name the assumption they invalidate and the pivot action they would trigger."

  - objective: "Produce a week-by-week MVP build plan that respects the team and time constraints"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student produces a build plan where each week has a specific deliverable, the plan fits within the stated team size and time budget, and the plan ends with a pilot onboarding step rather than an indefinite build phase"
...
teaching_guide:
  ...
  misconceptions:
    ...
    - "The MVP is what you show to investors. Correction: the MVP is what you use to validate assumptions with customers. Investor pitches come later, after you have the data the MVP produces."
  discussion_prompts:
...
2. Is that assumption TIER 1 or TIER 2?
3. Is this the cheapest way to test that assumption?
...
Continue to [Lesson 7: Build-Measure-Learn →](./07-build-measure-learn.md)
