---
slug: /Business-Domain-Agent-Workflows/intrapreneurship-innovation-agents/innovation-sprints
sidebar_position: 13
title: "Innovation Sprints"
description: "Design innovation sprints that have both a learning goal and a delivery goal, write assumption-linked user stories with testable acceptance criteria, and prioritise a sprint backlog using assumption risk times delivery value scoring"
keywords:
  [
    "innovation sprint",
    "sprint planning",
    "learning goal",
    "delivery goal",
    "assumption-linked user stories",
...
skills:
  - name: "Design an Innovation Sprint with Learning and Delivery Goals"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can produce a complete sprint plan containing a dual goal statement (learning + delivery), a backlog of 3–5 user stories with testable acceptance criteria, a definition of done covering code/learning/documentation, and a retrospective format that updates assumption statuses"

  - name: "Prioritise a Sprint Backlog by Assumption Risk Times Delivery Value"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Problem-Solving"
...
learning_objectives:
  - objective: "Distinguish between an innovation sprint and a product sprint and select the correct format for a given venture stage"
    ...
    assessment_method: "Given a venture at VALIDATION stage, student correctly selects the innovation sprint format and provides a written rationale referencing the dual goal requirement and assumption update retrospective"

  - objective: "Write a user story that names a specific role, a precise action, and testable acceptance criteria, and links the story to an assumption ID"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student produces at least 3 user stories where each story passes the strong/weak quality test: specific role (not 'user'), precise action (not 'notified'), measurable acceptance criteria (binary pass/fail), and an explicit assumption ID reference"
...
differentiation:
  ...
  remedial_for_struggling: "Focus on the learning goal only. For your venture's most critical untested assumption (from L05), write one sentence: 'This sprint will tell us whether [assumption] is true, by measuring [metric] over [timeframe].' Then write one user story that would produce that measurement. If you can do this, you have the core of the innovation sprint."
...
| ------------------ | -------------------------------------- | ---------------------------------------------------------- |
| Goal type          | Delivery ("complete features X and Y") | Learning + delivery ("validate A-004 while building Y")    |
| Success definition | Did we ship what we planned?           | Did we learn what we set out to learn?                     |
| Backlog priority   | Business value + complexity            | Assumption risk × delivery value                           |
| Retrospective      | How do we work better together?        | Which assumptions changed status this sprint?              |
...
| Assumption reference | none                        | "Tests assumption A-004 (WhatsApp integration feasibility)" |
...
Continue to [Lesson 14: Four Innovation Agents →](./14-four-innovation-agents.md)
