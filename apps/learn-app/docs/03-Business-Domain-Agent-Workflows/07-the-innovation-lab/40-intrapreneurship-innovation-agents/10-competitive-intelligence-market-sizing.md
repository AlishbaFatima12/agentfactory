---
slug: /Business-Domain-Agent-Workflows/intrapreneurship-innovation-agents/competitive-intelligence-market-sizing
sidebar_position: 10
title: "Competitive Intelligence and Market Sizing"
description: "Conduct a competitive landscape scan, build a bottom-up TAM/SAM/SOM model using the five-step method, assess your competitive moat, and validate your pricing against the value you deliver using the /market skill"
keywords:
  [
...
skills:
  - name: "Conduct a Competitive Landscape Analysis with Strategic Recommendation"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Analyze"
    digcomp_area: "Information-Processing"
    measurable_at_this_level: "Student can profile direct competitors and indirect alternatives with honest strength/weakness assessment, assign threat levels with specific rationale, and produce a strategic recommendation identifying where to win and where to avoid competing"

  - name: "Build a Bottom-Up Market Size Model with TAM/SAM/SOM"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can apply the five-step bottom-up method (count, qualify, price, calculate, validate) to produce a TAM/SAM/SOM model with cited sources, and validate the pricing against the value capture rule (<10% of value delivered)"

learning_objectives:
  - objective: "Profile three to six competitors with honest strength and weakness assessment and a strategic recommendation for where to compete"
    proficiency_level: "B1"
    bloom_level: "Analyze"
    assessment_method: "Student's competitive profile includes at least one genuine strength per competitor (not just weaknesses), a threat level with specific rationale (not just 'LOW' with no explanation), and a strategic recommendation that names the specific customer segment or use case where the venture wins"

  - objective: "Build a bottom-up market size model using the five-step method and validate pricing against the value capture ratio"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student produces a TAM/SAM/SOM model where each number is built from a count of organisations (not derived from analyst reports alone), sources are cited, and the value capture ratio is calculated and assessed against the <10% guideline"

  - objective: "Assess the venture's current moat and identify the moats being built versus those that remain aspirational"
    proficiency_level: "B1"
    bloom_level: "Evaluate"
    assessment_method: "Student distinguishes between moats they currently have (with evidence) and moats they are building (with a timeline) , and does not claim a moat that requires 100+ customers when they have 3"

cognitive_load:
  new_concepts: 5
  concepts_list:
    - "Competitive landscape structure, direct competitors vs. indirect alternatives (including 'do nothing' and 'Excel')"
    - "Bottom-up market sizing, five-step method from count to value capture validation"
    - "TAM / SAM / SOM, definitions and how each maps to a different business decision"
    - "Value capture ratio: the <10% rule and why pricing above it attracts competitors"
    - "Six moat types, data, switching costs, network effects, brand, regulatory, distribution"
  assessment: "5 concepts at B1 level is within the cognitive limit. The competitive and market sizing sections are independent of each other, which allows students to work through them sequentially without each depending on the prior concept."

differentiation:
  extension_for_advanced: "After completing the competitive landscape, conduct a 'white space' analysis: map all competitors on a two-dimensional positioning chart (e.g. price vs. level of ERP integration, or market segment vs. product complexity). Where is the positioning space that no existing product occupies? Is the AP automation product's positioning in that white space , or does it overlap significantly with an existing player? What does the overlap imply for go-to-market strategy?"
  remedial_for_struggling: "Focus on two things: the competitive landscape (who else solves this problem, and what is their actual strength?) and the SAM calculation (how many companies in your geography could realistically buy this?). If you can answer those two questions honestly, you have the core competitive intelligence for a pitch. The moat assessment and sensitivity analysis can come later."

teaching_guide:
  key_points:
    - "Bottom-up market sizing is more credible than top-down analyst TAM, investors will ask for the methodology"
    - "Every competitor profile must include a genuine strength; if you only list their weaknesses, you have not understood them"
    - "The value capture ratio (<10% of value delivered) validates pricing as well as market size: a product capturing 25% of value will lose customers as alternatives emerge"
    - "Moats take time to build, claiming a data moat with 3 customers is not honest; claiming you are building one with a timeline is"
    - "L10 is the foundation of two future lessons: the TAM/SAM/SOM appears in the pitch deck (L12 Slide 4) and the market context frames the GTM strategy (L11)"
  misconceptions:
    - "Our product has no direct competitors. Correction: if there are no competitors, there is likely no market , or you have not looked hard enough. The most dangerous competitor is often not another SaaS product but the incumbent alternative: Excel and manual process. Describe it honestly."
    - "A large TAM means a large market opportunity. Correction: TAM is a ceiling, not a target. A $50B TAM is only relevant if you can describe the specific SAM (the reachable subset) and the SOM (what you will actually go after). Investors are not impressed by large TAM numbers without a credible path to the SAM."
    - "Competitive advantages are permanent. Correction: competitive advantages are temporary unless defended. A product feature advantage lasts until a competitor ships the same feature. A data moat or switching cost moat is much harder to replicate, which is why those are worth building deliberately."
  discussion_prompts:
    - "The AP automation competitive landscape includes ERP vendors as a potential threat (block 8 of the canvas). When an ERP vendor launches a competing AP module at $200/month, is that a direct competitor or a category killer? What is the specific customer for whom the AP automation product still wins?"
    - "The bottom-up market size model for AP automation produces a SAM in the hundreds of millions of dollars. Is that a realistic business opportunity, or is it too large for a three-person team to address? How does the SOM (five-year target) calibrate investor expectations?"
  teaching_tips:
    - "Start with the indirect competitor that students are most likely to underestimate: 'Excel and manual process.' Doing nothing or continuing with Excel is the incumbent solution for most small companies. Understanding why customers switch from Excel to a SaaS product is more useful than understanding why they switch from one SaaS to another."
    - "The bottom-up calculation takes 15 minutes with the five-step method. Walk students through each step for AP automation, then ask them to apply it to their own venture. The sources step (where do you get the company count?) is where most students get stuck, country business registries, LinkedIn counts, and industry associations are the most practical starting points."
---
...
| Approach   | Method                                          | Investor Credibility                                  |
| ---------- | ----------------------------------------------- | ----------------------------------------------------- |
| Top-down   | Analyst TAM × assumed market share percentage   | Low, hard to defend; feels invented                  |
| Bottom-up  | Count × qualify × price × calculate             | High, shows you know your customer and market deeply |
...
:::info The Strongest Competitor Analysis Is Honest
...
| Moat Type      | Description                                                            | Durability    | AP Automation Status                                              |
| -------------- | ---------------------------------------------------------------------- | ------------- | ----------------------------------------------------------------- |
| Data           | Your AI improves with more customers; each customer's data benefits all | HIGH          | Building, more invoice data → better accuracy (87% → 95%+)     |
| Switching costs | Painful for customers to move; their history and integrations are in your system | MEDIUM-HIGH | Building, ERP integration + historical records create lock-in |
| Network effects | More users make the product more valuable for all users               | HIGH          | Not applicable, B2B SaaS with no network component              |
| Brand          | Customers trust you over alternatives by reputation alone              | MEDIUM        | Not built yet, 3 customers is too few for brand credibility      |
| Regulatory     | You are certified or approved in ways competitors are not              | MEDIUM        | Potential, audit-readiness certifications could differentiate    |
| Distribution   | You have exclusive access to customers competitors cannot reach easily | MEDIUM        | Building, professional association partnerships planned          |
...
Continue to [Lesson 11: Go-to-Market Strategy →](./11-go-to-market-strategy.md)
