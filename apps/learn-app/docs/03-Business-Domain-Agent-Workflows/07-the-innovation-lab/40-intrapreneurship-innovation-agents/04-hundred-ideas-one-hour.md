---
slug: /Business-Domain-Agent-Workflows/intrapreneurship-innovation-agents/hundred-ideas-one-hour
sidebar_position: 4
title: "Hundred Ideas, One Hour"
description: "Run a 100-idea sprint across 10 structured categories, score ideas using the DVF framework, shortlist to 10, and pressure-test the selected idea using the /idea skill"
keywords:
  [
    "100-idea sprint",
    "idea generation",
...
skills:
  - name: "Generate 100 structured ideas across the 10-category sprint framework"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can invoke /idea with a HMW problem statement and produce 100 categorised ideas, then apply the 'Why Now?' test to each category before shortlisting"

  - name: "Apply DVF scoring to filter an idea list to an actionable shortlist"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Evaluate"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can score ideas on Desirability, Viability, and Feasibility dimensions and select a single idea with a documented rationale that references customer discovery data from Lesson 3"

  - name: "Pressure-test a selected idea using devil's advocate analysis"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Evaluate"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can identify the 5 strongest arguments against their selected idea and specify what must be proven to overcome each, forming the foundation for the assumption map in Lesson 5"
...
learning_objectives:
  ...
  - objective: "Score a set of ideas using the DVF framework and select the highest-potential idea with a documented rationale"
    proficiency_level: "B1"
    bloom_level: "Evaluate"
    assessment_method: "Student produces a shortlist of 10 ideas each with GREEN/YELLOW/RED scores across all three DVF dimensions, and a two-paragraph case for the selected idea that references evidence from customer discovery"
...
Continue to [Lesson 5: The Assumption Stack →](./05-the-assumption-stack.md)
