---
slug: /Business-Domain-Agent-Workflows/intrapreneurship-innovation-agents/go-to-market-strategy
sidebar_position: 11
title: "Go-to-Market Strategy"
description: "Define a surgical ICP with buying triggers, design a multi-channel GTM strategy ranked by CAC efficiency, build a seven-step sales process, and produce a 90-day GTM calendar with decision gates using the /gtm skill"
keywords:
  [
...
skills:
  - name: "Define an ICP with Buying Trigger and Exclusion Criteria"
...
learning_objectives:
  - objective: "Define an ICP including company profile, person profile, buying trigger, identification signals, and explicit exclusion criteria"
    proficiency_level: "B2"
    bloom_level: "Apply"
    assessment_method: "ICP includes a specific buying trigger (not just demographic description), at least two signals for identifying prospects, and a NOT a fit section that names specific exclusions with rationale"

  - objective: "Design a ranked channel strategy for reaching the first 50 customers with CAC efficiency assessment for each channel"
    proficiency_level: "B2"
    bloom_level: "Create"
    assessment_method: "Channel strategy includes at least three channels ranked by CAC efficiency, with a Week 1 activation step for the primary channel and a rationale for why the secondary channel is not activated until the primary is producing"

  - objective: "Produce a 90-day GTM calendar with decision gates at Day 30 and Day 60"
    proficiency_level: "B2"
    bloom_level: "Create"
    assessment_method: "Calendar includes week-by-week activities with weekly targets, a specific metric at the Day 30 gate (e.g. conversion rate on outreach), and a specific decision criterion at Day 60 (e.g. are we on track for 10 customers by Day 90?)"
...
differentiation:
  extension_for_advanced: "After designing the 90-day calendar, model what happens if the Day 30 gate fails (conversion rate on outreach is below threshold). Design a 'failed gate' response plan: what do you change about the ICP, the message, or the channel? This forces you to think about GTM not as a linear plan but as an experiment with defined failure criteria and responses."
  remedial_for_struggling: "Focus on two things: the ICP with buying trigger, and the primary channel with Week 1 activation. If you can describe exactly who you are calling in Week 1 and what event made them ready to buy right now, you have the core of a GTM strategy. The channel ranking, pricing, and 90-day calendar elaborate on this foundation."
...
| Channel                      | CAC         | Scale  | Speed  | Best For                                  |
| ---------------------------- | ----------- | ------ | ------ | ----------------------------------------- |
| Founder-led outreach         | Low         | Low    | Fast   | First 10 customers; ICP refinement        |
| Content / thought leadership | Medium-low  | Medium | Slow   | Inbound pipeline over 6–12 months         |
| Community and associations   | Medium      | Medium | Medium | Warm introductions in trust-based markets |
| Referral programme           | Low         | Medium | Varies | Once you have 10+ happy customers         |
| Inside sales (SDRs)          | Medium-high | High   | Fast   | Scaling what founder-led has proven       |
| Partnerships and channels    | Variable    | High   | Slow   | Distribution leverage at Month 12+        |
...
| ---------- | -------------------- | -------------------------------------- | -------------------------------------- |
| Primary    | $500/month           | Manufacturing/distribution $5M–$50M    | Validated by 2 pilots; annual = $5,000 |
| SME        | $350/month           | Companies $1M–$5M                      | Emerging from Pilot 3 data             |
...
Continue to [Lesson 12: Investor Pitch Deck →](./12-investor-pitch-deck.md)
