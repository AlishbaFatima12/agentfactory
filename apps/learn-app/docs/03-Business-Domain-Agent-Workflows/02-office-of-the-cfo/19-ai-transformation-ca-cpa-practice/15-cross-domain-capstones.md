...
skills:
  - name: "Execute Cross-Domain Client Onboarding Workflow"
...
cognitive_load:
  new_concepts: 5
  concepts_list:
    - "Cross-domain workflow integration (connecting all 5 CA/CPA domains in a single engagement)"
    - "Engagement acceptance risk assessment (ISA 220 framework)"
...
differentiation:
  ...
  remedial_for_struggling: "Start with Exercise 22 only. Focus on Steps 1-4 (document intake through engagement scope). If you can produce a client profile, a risk assessment, and an analytical review that flow logically from one to the next, you have demonstrated cross-domain integration. Steps 5-8 apply the same integration pattern to different outputs."
...
**US GAAP / IRC**: US engagements follow AU-C 210 (AICPA standards). Revenue recognition follows ASC 606. Tax exemptions vary by state and federal provisions.
**UK FRS / HMRC**: UK engagements follow ISA (UK) 210 with FRC adaptations. Export incentives operate through HMRC trade facilitation rather than SRO-type provisions.
:::
