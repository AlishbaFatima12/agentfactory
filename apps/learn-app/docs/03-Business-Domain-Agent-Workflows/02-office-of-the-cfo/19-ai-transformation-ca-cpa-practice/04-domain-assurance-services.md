...
skills:
  - name: "Explain How AI Changes Audit Epistemics"
    proficiency_level: "A2"
    category: "Conceptual"
    bloom_level: "Understand"
    digcomp_area: "Information Literacy"
    measurable_at_this_level: "Student can explain the shift from sampling-based audit (probabilistic assurance) to population-level testing (deterministic assurance) and describe why this changes the nature of the auditor's opinion"

  - name: "Identify Gen-AI and Agentic AI Capabilities in Assurance"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Digital Literacy"
    measurable_at_this_level: "Student can map Gen-AI capabilities (audit documentation, contract analysis, risk identification) and agentic capabilities (autonomous audit agent, continuous audit agent) to specific audit engagement workflows"

  - name: "Conduct AI-Assisted Audit Risk Assessment"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
...
learning_objectives:
  ...
  - objective: "Map Gen-AI and agentic AI capabilities to specific external audit, internal audit, and other assurance workflows, using real-world deployments as evidence"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student can identify which AI capability addresses a given audit scenario and cite at least one real-world platform (KPMG Clara or MindBridge) demonstrating the capability in production"
...
cognitive_load:
  ...
  concepts_list:
    ...
    - "Audit sampling vs population testing"
    - "Gen-AI audit documentation capability"
...
differentiation:
  ...
  remedial_for_struggling: "Focus on the concept box about materiality and sampling. Write a simple explanation of why an auditor tests a sample instead of every transaction, then explain why AI changes this. If you can explain the shift from 'we checked some and found nothing wrong' to 'we checked everything and found these specific issues,' you have understood the core concept."
...
- **KPMG Clara:** [kpmg.com/us/en/capabilities-services/audit-services/kpmg-clara](https://kpmg.com/us/en/capabilities-services/audit-services/kpmg-clara.html)
- **MindBridge AI:** [mindbridge.ai](https://www.mindbridge.ai/)
