---
slug: /Business-Domain-Agent-Workflows/banking-domain-agents/aml-tm-ml-sar
sidebar_position: 10
title: "Transaction Monitoring, ML Evolution, and SAR Filing"
description: "Compare rules-based and machine-learning transaction monitoring approaches, trace the end-to-end SAR filing workflow from alert to submission, and understand the tipping-off prohibition that constrains every banking AI agent"
keywords:
  [
...
skills:
  - name: "Compare Rules-Based and ML Transaction Monitoring"
    proficiency_level: "B1"
    category: "Technical"
    bloom_level: "Analyze"
    digcomp_area: "Data Literacy"
    measurable_at_this_level: "Student can describe how rules-based systems generate alerts using threshold and pattern rules, explain how ML approaches (peer group analysis, network analysis, anomaly detection) reduce false positives, and evaluate the trade-offs between interpretability and accuracy"

  - name: "Describe the End-to-End SAR Filing Workflow"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Understand"
    digcomp_area: "Safety"
    measurable_at_this_level: "Student can trace the workflow from alert generation through investigation, escalation, and filing decision, identifying the reporting authority in at least three jurisdictions"

  - name: "Identify Tipping-Off Risks in AI Agent Design"
    proficiency_level: "B1"
    category: "Conceptual"
    bloom_level: "Understand"
    digcomp_area: "Safety"
    measurable_at_this_level: "Student can explain why tipping-off is a criminal offence, identify specific agent behaviours that would constitute tipping-off, and describe safeguards that must be built into any banking AI system"
...
learning_objectives:
  ...
  - objective: "Describe the end-to-end SAR filing workflow from alert generation to regulatory submission"
    proficiency_level: "B1"
    bloom_level: "Understand"
    assessment_method: "Student traces the full workflow, names the reporting authority in at least three jurisdictions, and explains the legal obligation to file"

  - objective: "Identify tipping-off risks and explain why AI agents must never disclose SAR-related information"
    proficiency_level: "B1"
    bloom_level: "Understand"
    assessment_method: "Student identifies at least three specific agent behaviours that would constitute tipping-off and explains the criminal penalty under POCA 2002 s333A"

cognitive_load:
  new_concepts: 6
  concepts_list:
    - "Rules-based TM (threshold rules, pattern rules, velocity rules, geographic rules)"
    - "ML-based TM (peer group analysis, network analysis, behavioural anomaly detection)"
    - "Alert investigation workflow (triage, investigation, escalation, disposition)"
    - "SAR filing -- legal obligation, content, timelines, reporting authorities by jurisdiction"
    - "Tipping-off prohibition -- criminal offence, applies to all staff and systems"
    - "Agent boundary in TM -- generates analysis and flags, never files SARs or communicates suspicion"
  assessment: "6 concepts at B1 level -- within the 7-10 limit. Students have the three lines of defence and CDD/EDD framework from Lesson 9. This lesson builds on that foundation with the operational mechanics of transaction monitoring and the legal framework for SAR filing."

differentiation:
  extension_for_advanced: "Research Featurespace's ARIC platform or NICE Actimize's SAM solution. Identify which ML techniques each uses (supervised vs unsupervised, feature engineering approach, model governance). Explain how model explainability requirements affect the choice between interpretable models and deep learning approaches in a regulated environment."
  remedial_for_struggling: "Focus on the SAR workflow diagram and the tipping-off prohibition. If you can trace an alert from generation to filing and explain why an AI agent must never tell a customer that their account is being investigated, you have the essential knowledge for building compliant banking AI agents."
---
...
:::warning Criminal Liability for AI Systems
