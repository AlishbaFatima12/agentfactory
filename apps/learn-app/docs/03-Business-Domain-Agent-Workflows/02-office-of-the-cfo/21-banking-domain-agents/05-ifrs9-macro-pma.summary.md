...
- Best practice is three to five scenarios (upside, base, adverse, severe adverse) with probability weights summing to 1.0, where weights reflect informed judgment documented and approved by the credit committee
- Sensitivity analysis on probability weights reveals material ECL variation: shifting 5-10% between scenarios can change the weighted ECL by 15% or more, which is why weight assignments are rigorously challenged by auditors and regulators
- The complete IFRS 9 ECL has eight steps: staging, PD calibration, LGD estimation, EAD calculation, facility-level ECL, scenario weighting, PMAs, and final reported ECL = weighted ECL + PMA
- During Covid-19, major banks applied PMAs of $1-10 billion because no model had been calibrated for global lockdowns, and government support schemes obscured true credit quality
...
- **Builds on**: Lessons 3-4's ECL formula and component building, completing the full IFRS 9 calculation chain from raw data to final provision
- **Leads to**: Lesson 6's Basel capital ratios, shifting from the accounting pillar (how much to provision) to the solvency pillar (how much capital to hold)
