---
slug: /Business-Domain-Agent-Workflows/banking-domain-agents/aml-three-lines
sidebar_position: 9
title: "AML/KYC -- The Three Lines of Defence"
description: "Apply the three lines of defence model to a bank's anti-money-laundering framework, classify customers for standard or enhanced due diligence, and identify where AI agents automate screening versus where human judgment is non-negotiable"
keywords:
  [
    "AML",
    "KYC",
...
skills:
  - name: "Apply the Three Lines of Defence Model to AML"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Safety"
    measurable_at_this_level: "Student can assign specific AML functions to the correct line of defence and explain the accountability boundary between each line"

  - name: "Classify Customers as CDD or EDD"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Problem Solving"
    measurable_at_this_level: "Student can review a customer profile, identify risk indicators (PEP status, high-risk jurisdiction, complex ownership), and determine whether standard CDD or enhanced EDD is required"

  - name: "Identify the AI Agent Boundary in AML Compliance"
    proficiency_level: "B1"
    category: "Conceptual"
    bloom_level: "Understand"
    digcomp_area: "Safety"
    measurable_at_this_level: "Student can list functions that an AI agent can automate (screening, data gathering, risk scoring) and functions that require human judgment (risk acceptance, EDD decisions, SAR filing)"

learning_objectives:
  - objective: "Apply the three lines of defence model to a bank's AML framework, assigning specific functions to each line"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student correctly maps CDD screening, compliance oversight, and internal audit to their respective lines and explains what happens when the second line identifies a first-line failure"
  ...
  - objective: "Explain the boundary between what AI agents can automate in AML and what requires human judgment"
    proficiency_level: "B1"
    bloom_level: "Understand"
    assessment_method: "Student lists at least five automatable functions and five human-judgment functions with clear rationale for the boundary"

cognitive_load:
  new_concepts: 6
  concepts_list:
    - "Three lines of defence (1st: customer-facing business, 2nd: financial crime compliance, 3rd: internal audit)"
    - "Customer Due Diligence (CDD) -- identity verification, source of funds, purpose of relationship, risk rating"
    - "Enhanced Due Diligence (EDD) -- additional requirements for higher-risk customers"
    - "Politically Exposed Persons (PEP) -- definition, screening requirements, family and close associates"
    - "Beneficial ownership -- identifying ultimate controllers beyond the 25% threshold"
    - "Agent boundary -- AI automates screening and data gathering; humans make risk acceptance decisions"
  assessment: "6 concepts at B1 level -- within the 7-10 limit. Students shift from the solvency pillar (Lessons 6-8) to the financial crime pillar. The three-pillar framework from Lesson 1 provides the structural context. AML concepts are procedural rather than quantitative, making them accessible at B1 despite the regulatory complexity."

differentiation:
  extension_for_advanced: "Research the UK's Joint Money Laundering Steering Group (JMLSG) guidance on PEP de-risking. Explain the tension between AML compliance (requiring enhanced scrutiny of PEPs) and financial inclusion (avoiding blanket refusal to bank PEPs). How should an AI agent handle this tension?"
  remedial_for_struggling: "Focus on the three lines model and the CDD/EDD distinction. If you can explain which line of defence does screening, which oversees the framework, and which audits both, and you can distinguish when CDD is sufficient versus when EDD is required, you have the essential foundation."
---
...
1. List every risk factor you identify
2. Determine: Standard CDD or Enhanced EDD? Justify your answer
3. What additional information would you request under EDD?
4. Which elements of this assessment can the AI agent perform? Which require human decision?
5. The former minister's nephew is the CFO of Azura. Does this change your assessment?

:::tip Key Risk Factors
