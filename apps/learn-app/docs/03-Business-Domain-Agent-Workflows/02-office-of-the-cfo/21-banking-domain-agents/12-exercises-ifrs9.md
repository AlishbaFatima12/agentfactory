...
keywords:
  [
    "IFRS 9 exercises",
    "ECL calculation practice",
    "stage assessment",
    "retail mortgage IFRS 9",
    "corporate ECL model",
    "GCC banking",
    "SICR assessment",
...
skills:
  - name: "Assess IFRS 9 Stage Classification Across a Retail Portfolio"
    proficiency_level: "B2"
    category: "Applied"
    bloom_level: "Analyze"
    digcomp_area: "Data Literacy"
    measurable_at_this_level: "Student can classify 8 mortgage facilities into Stage 1, 2, or 3 using quantitative triggers (DPD, PD movement) and qualitative indicators (employment status, property values, hardship), then calculate ECL for each using the appropriate measurement basis"

  - name: "Build a Multi-Scenario Corporate ECL Model with Regional Adjustments"
    proficiency_level: "B2"
    category: "Technical"
    bloom_level: "Create"
    digcomp_area: "Digital Content Creation"
    measurable_at_this_level: "Student can construct a complete ECL model for 6 GCC corporate borrowers with drawn and undrawn exposures, apply through-the-cycle to point-in-time PD conversion, weight across 3 macroeconomic scenarios, and produce a probability-weighted ECL with regional macro adjustments"

  - name: "Produce IFRS 7 Disclosure-Ready Stage Movement Tables"
    proficiency_level: "B2"
    category: "Applied"
    bloom_level: "Create"
    digcomp_area: "Digital Content Creation"
    measurable_at_this_level: "Student can produce a stage movement matrix showing gross carrying amounts and ECL provisions transitioning between stages, formatted for IFRS 7 financial instrument disclosure requirements"
