...
(3) Skill library — list of all skills, their trigger
...
For each edge case, classify any errors: AI error (fix the skill), configuration error (fix global instructions), or a limitation requiring human review. Document the results.
...
4. **How would you apply the Knowledge Extraction Method to encode a senior practitioner's judgment into a Cowork skill?**
...
- 5 plugins (finance, financial-analysis, equity-research,
  private-equity, IDFA)
- 5 Cowork domain skills (jurisdiction tax rules,
...
2. What skill maintenance should I have performed by now?
