...
| ------------------------------------------------------- | -------------------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------------------- |
| [L01](./01-the-most-consequential-ai-transformation.md) | The Most Consequential AI Transformation                 | 15 min   | The Gen-AI vs Agentic AI distinction for CA/CPA practice, the 5-domain ranking, and the chapter's structural roadmap |
| [L02](./02-domain-accounting-financial-reporting.md)    | Domain 1: Accounting and Financial Reporting             | 45 min   | Domain analysis + Exercise 1: Automating the Month-End Close with Cowork                                             |
| [L03](./03-domain-tax-non-assurance-advisory.md)        | Domain 2: Tax and Non-Assurance Advisory                 | 35 min   | Domain analysis + Exercise 2: Tax Research and Computation with Cowork                                               |
| [L04](./04-domain-assurance-services.md)                | Domain 3: Assurance Services                             | 40 min   | Domain analysis + Exercise 3: AI-Assisted Audit Risk Assessment                                                      |
...
| [L08](./08-jurisdiction-entity-extensions.md)           | Building Jurisdiction and Entity Skills                  | 30 min   | Extensions 1-2: jurisdiction-specific tax rules and chart of accounts encoding                                       |
| [L09](./09-methodology-compliance-extensions.md)        | Building Methodology and Compliance Skills               | 45 min   | Extensions 3-5 + Exercise 7: Building a CA/CPA Domain Extension                                                      |
