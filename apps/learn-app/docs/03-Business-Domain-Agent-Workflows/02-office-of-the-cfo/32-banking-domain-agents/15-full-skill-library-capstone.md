...
keywords:
  [
    ...
    "skill library build",
    "board risk report",
    "banking agent deployment",
    "cross-pillar scenario",
    "ECL movement",
    "capital dashboard",
    "AML dashboard",
...
skills:
  - name: "Build and Validate a Complete Banking Skill Library"
...
learning_objectives:
  ...
  - objective: "Execute the capstone scenario and produce a Board Risk Report covering ECL, capital, liquidity, AML, and integrated stress testing"
    proficiency_level: "B2"
    bloom_level: "Create"
    assessment_method: "Student produces all 5 capstone phases (ECL movement, capital dashboard, liquidity, AML dashboard, integrated stress) and assembles a coherent 10-slide Board Risk Report with executive summary, key metrics, and recommendations"

  - objective: "Evaluate the five principles of banking domain AI and apply them to real regulatory scenarios"
    proficiency_level: "B2"
    bloom_level: "Evaluate"
    assessment_method: "Student explains each principle and cites at least one exercise from the chapter that demonstrates it"
...
| Metric            | Value                                                               |
| ----------------- | ------------------------------------------------------------------- |
| Total loan book   | GBP 4.2B                                                            |
| ECL (current)     | GBP 124M (Stage 1: GBP 18M, Stage 2: GBP 62M, Stage 3: GBP 44M)     |
| CET1 ratio        | 11.2% (current), 10.8% (after latest ECL movement)                  |
| Leverage ratio    | 4.6%                                                                |
| LCR               | 142%                                                                |
| NSFR              | 108%                                                                |
| AML metrics       | 847 alerts in queue, 12 SARs filed this quarter, 2 MRAs outstanding |
| Key concentration | CRE: GBP 680M with 14% in Stage 2; Consumer: early DPD stress       |

### Macroeconomic Overlay Scenarios

| Scenario | Probability | GDP   | Unemployment | Key Assumption                      |
| -------- | ----------- | ----- | ------------ | ----------------------------------- |
| Base     | 50%         | +1.2% | 4.8%         | Gradual recovery                    |
| Adverse  | 35%         | -0.8% | 6.5%         | Mild recession, property correction |
| Severe   | 15%         | -3.0% | 9.1%         | Deep recession, property crash      |

### Phase 1: ECL Movement Dashboard

Calculate the ECL movement from the prior quarter:

| Component     | Prior Quarter | Current Quarter | Movement     |
| ------------- | ------------- | --------------- | ------------ |
| Stage 1 ECL   | GBP 15M       | GBP 18M         | +GBP 3M      |
| Stage 2 ECL   | GBP 55M       | GBP 62M         | +GBP 7M      |
| Stage 3 ECL   | GBP 40M       | GBP 44M         | +GBP 4M      |
| **Total ECL** | **GBP 110M**  | **GBP 124M**    | **+GBP 14M** |
...
| Metric              | Minimum | + Buffer     | Current       | Status        |
| ------------------- | ------- | ------------ | ------------- | ------------- |
...
| Metric | Minimum | Current | Headroom |
| ------ | ------- | ------- | -------- |
| LCR    | 100%    | 142%    | 42pp     |
| NSFR   | 100%    | 108%    | 8pp      |
...
| Metric            | Value    | Trend                  | Concern Level |
| ----------------- | -------- | ---------------------- | ------------- |
| Open alerts       | 847      | Up 12% QoQ             | Medium        |
| SARs filed        | 12       | Up from 8 last quarter | Medium-High   |
| MRAs outstanding  | 2        | Unchanged              | High          |
| Average alert age | 4.2 days | Up from 3.8 days       | Medium        |
...
| -------------------------- | ---------------------------------------------------------- | ---------- |
| ECL increase under adverse | ECL rises from GBP 124M to approximately GBP 180M          | +GBP 56M   |
...
| Stressed CET1              | Starting CET1 minus GBP 79.5M                              | Calculate  |
| Stressed CET1 ratio        | Stressed CET1 / RWA (assume RWA increases 5% under stress) | Calculate  |
...
| Slide | Content                                                               |
| ----- | --------------------------------------------------------------------- |
| 1     | **Executive Summary**: Key metrics, traffic-light status, top 3 risks |
| 2     | **ECL Movement**: Dashboard from Phase 1 with trend chart             |
| 3     | **Stage Migration Analysis**: Where is credit quality deteriorating?  |
| 4     | **Capital Adequacy**: Dashboard from Phase 2, buffer headroom         |
| 5     | **Liquidity Position**: LCR and NSFR from Phase 3, NSFR concern       |
| 6     | **AML and Financial Crime**: Dashboard from Phase 4, MRA status       |
| 7     | **Integrated Stress Test**: Results from Phase 5, survival assessment |
| 8     | **Concentration Risk**: CRE GBP 680M deep-dive, consumer early stress |
| 9     | **Recommendations**: 5 specific actions with owners and timelines     |
| 10    | **Appendix**: Methodology notes, data sources, model limitations      |
