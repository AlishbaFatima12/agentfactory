---
slug: /Business-Domain-Agent-Workflows/banking-domain-agents/the-three-pillars
sidebar_position: 1
title: "The Three Regulatory Pillars of Modern Banking"
description: "Why every banking institution is simultaneously governed by three regulatory pillars — Solvency (Basel), Accounting (IFRS 9), and Financial Crime (AML) — and why single-pillar AI agents produce incomplete output"
keywords:
  [
    "banking regulation",
    "three pillars",
...
skills:
  - name: "Explain the Three Regulatory Pillars of Modern Banking"
    proficiency_level: "A2"
    category: "Conceptual"
    bloom_level: "Understand"
    digcomp_area: "Information Literacy"
    measurable_at_this_level: "Student can name the three regulatory pillars (Solvency, Accounting, Financial Crime), explain what each governs, and describe why a single loan portfolio requires treatment under all three simultaneously"

  - name: "Identify Which Regulatory Pillar Governs a Banking Scenario"
    proficiency_level: "A2"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can take a banking scenario and identify which pillar or combination of pillars applies, and explain what output each pillar produces"

learning_objectives:
  - objective: "Explain the three regulatory pillars of modern banking and why they must be addressed simultaneously"
    proficiency_level: "A2"
    bloom_level: "Understand"
    assessment_method: "Student can describe what Basel III, IFRS 9, and AML each require from a bank holding the same loan portfolio, and explain why addressing only one pillar is insufficient"

  - objective: "Identify which regulatory pillar governs a given banking scenario"
    proficiency_level: "A2"
    bloom_level: "Apply"
    assessment_method: "Given three banking scenarios (a provision calculation, a capital ratio, a suspicious transaction), student correctly assigns each to the appropriate pillar"

  - objective: "Articulate why single-pillar AI agents produce incomplete or misleading output for banking professionals"
    proficiency_level: "A2"
    bloom_level: "Understand"
    assessment_method: "Student can explain the cross-pillar cascade problem and describe the architectural solution this chapter builds"
...
differentiation:
  ...
  remedial_for_struggling: "Focus on the single loan portfolio example. If you can explain what IFRS 9 does to it (provision), what Basel does to it (capital charge), and what AML does to it (monitor for suspicious activity), you have the foundation for every subsequent lesson."
---
...
| Pillar              | Framework    | Question It Answers                                                                     | Governing Body                                |
| ------------------- | ------------ | --------------------------------------------------------------------------------------- | --------------------------------------------- |
| **Accounting**      | IFRS 9       | How much should the bank provision for expected credit losses?                          | IASB (140+ countries)                         |
| **Solvency**        | Basel III/IV | Does the bank hold enough capital to absorb unexpected losses?                          | BCBS at BIS (28 member jurisdictions)         |
| **Financial Crime** | AML/KYC      | Is the bank being used for money laundering, terrorist financing, or sanctions evasion? | FATF (40 Recommendations, 200+ jurisdictions) |
...
| Bank          | Year | Fine     | Violation                            |
| ------------- | ---- | -------- | ------------------------------------ |
| Goldman Sachs | 2020 | $2.9B    | 1MDB bribery and money laundering    |
| HSBC          | 2012 | $1.9B    | Mexican drug cartel money laundering |
| Westpac       | 2020 | AUD 1.3B | 23 million AML reporting failures    |
| Deutsche Bank | 2017 | $630M    | Russian mirror-trading scheme        |
...
| Dimension              | IFRS 9 (Accounting)        | Basel III (Solvency)                    | AML (Financial Crime)          |
| ---------------------- | -------------------------- | --------------------------------------- | ------------------------------ |
| **Primary question**   | What is the expected loss? | What capital must be held?              | Is the borrower legitimate?    |
| **Key metric**         | ECL provision ($)          | Risk-weighted asset ($) and CET1 charge | Risk rating (low/medium/high)  |
| **Trigger for action** | Credit deterioration       | Change in risk weight                   | Suspicious transaction pattern |
| **Output**             | Provision on balance sheet | Capital ratio to regulator              | SAR filing to FIU              |
| **Plugin skill**       | `ifrs9-ecl`                | `basel-rwa-credit`                      | `aml-cdd-edd`                  |
...
| ----------- | ----------- | ---------------------------------------------------- | ---------------------------------------------- |
| **Level 1** | Calculation | Deterministic formulas with defined inputs           | ECL = PD x LGD x EAD                           |
| **Level 2** | Analytical  | Judgment-assisted analysis with professional context | SICR assessment, PMA design                    |
| **Level 3** | Autonomous  | Cross-pillar orchestration across multiple skills    | Fraud cascade tracing across all three pillars |
...
| Pillar          | International Body | Standard           | Adoption                                                             |
| --------------- | ------------------ | ------------------ | -------------------------------------------------------------------- |
| Accounting      | IASB               | IFRS 9             | 140+ countries (notably NOT the USA, which uses CECL under ASC 326)  |
| Solvency        | BCBS at BIS        | Basel III/IV       | 28 member jurisdictions (implemented nationally by local regulators) |
| Financial Crime | FATF               | 40 Recommendations | 200+ jurisdictions (assessed via mutual evaluations)                 |
