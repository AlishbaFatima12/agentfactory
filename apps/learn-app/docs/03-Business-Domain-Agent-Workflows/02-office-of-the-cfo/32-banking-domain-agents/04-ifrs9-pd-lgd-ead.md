...
skills:
  - name: "Build PD Term Structures and Apply Forward-Looking Adjustment"
    proficiency_level: "B1"
    category: "Technical"
    bloom_level: "Apply"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can construct a PD term structure from TTC PDs using a credit cycle adjustment, distinguish PIT from TTC PD, and explain why IFRS 9 requires PIT calibration"

  - name: "Calculate Downturn LGD and EAD with Credit Conversion Factors"
    proficiency_level: "B1"
    category: "Technical"
    bloom_level: "Apply"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can compute downturn LGD using forced sale values and cure rates, calculate EAD for revolving facilities using CCFs, and combine all three components into a facility-level ECL"

learning_objectives:
  - objective: "Build a PD term structure and apply forward-looking credit cycle adjustment to convert TTC PD to PIT PD"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student constructs a 5-year PD term structure from TTC PDs using a CCA multiplier and explains why the adjustment is needed for IFRS 9 compliance"

  - objective: "Calculate downturn LGD incorporating forced sale value, collateral haircuts, and cure rates"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student computes LGD for a secured mortgage facility using downturn property values and explains why IFRS 9 requires stressed, not current, collateral values"

  - objective: "Compute EAD with credit conversion factors for revolving and undrawn commitments"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student calculates EAD for a revolving credit facility with both drawn and undrawn components, applies the correct CCF, and explains why EAD exceeds the current drawn balance"
...
| Type    | Full Name         | What It Measures                                    | Used For                                    |
| ------- | ----------------- | --------------------------------------------------- | ------------------------------------------- |
...
| Economic Condition | CCA Range | Effect                             |
| ------------------ | --------- | ---------------------------------- |
| Expansion (benign) | 0.5 - 0.8 | PIT PD lower than TTC PD           |
| Neutral            | ~1.0      | PIT PD approximately equals TTC PD |
| Recession (stress) | 1.3 - 2.5 | PIT PD higher than TTC PD          |
...
| Year | Cumulative PD | Marginal PD | Calculation                      |
| ---- | ------------- | ----------- | -------------------------------- |
| 1    | 2.10%         | 2.10%       | = Cumulative PD Year 1           |
| 2    | 4.35%         | 2.30%       | = (4.35% - 2.10%) / (1 - 2.10%)  |
| 3    | 6.85%         | 2.62%       | = (6.85% - 4.35%) / (1 - 4.35%)  |
| 4    | 9.50%         | 2.85%       | = (9.50% - 6.85%) / (1 - 6.85%)  |
| 5    | 12.20%        | 2.98%       | = (12.20% - 9.50%) / (1 - 9.50%) |
...
| Sovereign and bank                                | 45-75%            | Recovery through restructuring               |
...
| Facility Type                              | Typical CCF Range | Rationale                                                                      |
| ------------------------------------------ | ----------------- | ------------------------------------------------------------------------------ |
| Unconditionally cancellable (credit cards) | 0-10%             | Bank can cancel the facility before drawdown                                   |
| Committed revolving credit                 | 50-75%            | Borrower has contractual right to draw; distressed borrowers typically utilise |
| Construction/project drawdown              | 80-100%           | Planned drawdown schedule, high utilisation expected                           |
...
| ---------------------- | --------------- | -------------------------------------------------- |
| TTC PD                 | 1.8%            | Internal rating model                              |
| CCA                    | 1.3             | Mild recession                                     |
| **PIT PD (12m)**       | **2.34%**       | 1.8% x 1.3                                         |
| Current property value | N/A             | Unsecured                                          |
| **LGD**                | **45%**         | Corporate unsecured (senior), downturn calibration |
| Drawn balance          | $5,000,000      | Current utilisation                                |
| Undrawn commitment     | $15,000,000     | Facility limit - drawn                             |
| CCF                    | 60%             | Committed revolving                                |
...
| Facility | Balance ($M) | Undrawn ($M) | CCF | DPD | Rating Change  | LTV | LGD | TTC PD | CCA |
| -------- | ------------ | ------------ | --- | --- | -------------- | --- | --- | ------ | --- |
| A001     | 10.0         | 0            | N/A | 0   | No change      | 65% | 12% | 0.8%   | 1.2 |
| A002     | 5.0          | 10.0         | 60% | 0   | Down 3 notches | N/A | 45% | 1.5%   | 1.2 |
| A003     | 8.0          | 0            | N/A | 35  | Down 1 notch   | 75% | 18% | 1.1%   | 1.2 |
| A004     | 15.0         | 5.0          | 50% | 0   | No change      | N/A | 40% | 0.5%   | 1.2 |
| A005     | 3.0          | 0            | N/A | 95  | Down 5 notches | 90% | 35% | 4.0%   | 1.2 |
| A006     | 20.0         | 0            | N/A | 0   | No change      | 60% | 10% | 0.3%   | 1.2 |
| A007     | 7.0          | 3.0          | 50% | 0   | Down 2 notches | N/A | 50% | 2.0%   | 1.2 |
| A008     | 12.0         | 0            | N/A | 15  | No change      | 70% | 15% | 0.6%   | 1.2 |
