...
skills:
  - name: "Apply IFRS 9 to Diminishing Musharaka"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can apply the IFRS 9 business model test and SPPI test to a diminishing musharaka home finance arrangement, classify the bank's co-ownership share as a financial asset at amortised cost (substance over form), and generate the effective interest rate journal entries distinguishing accounting characterisation from Shariah legal form"

  - name: "Explain HMRC Tax Equivalence for Islamic Finance"
    proficiency_level: "B1"
    category: "Conceptual"
    bloom_level: "Understand"
    digcomp_area: "Information Literacy"
    measurable_at_this_level: "Student can explain how HMRC treats Islamic finance products as tax-equivalent to conventional counterparts under Finance Act 2005, including that DM rental is treated as interest for tax purposes, that SDLT relief prevents double taxation on Islamic mortgages, and that the accounting label and tax characterisation can differ"

  - name: "Compare Islamic and Conventional Construction Finance Under IFRS"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Analyze"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can compare a DM/wakala construction finance structure with a conventional construction facility under IFRS 9, identifying when the bank begins recognising financing income and how the construction-period investment is treated"
...
cognitive_load:
  ...
  concepts_list:
    ...
    - "Accounting characterisation vs tax characterisation distinction"
