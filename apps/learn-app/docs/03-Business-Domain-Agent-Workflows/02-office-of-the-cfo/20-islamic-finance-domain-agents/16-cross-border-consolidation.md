...
keywords:
  [
    "Islamic banking consolidation",
    "AAOIFI IFRS consolidation",
    "IAH funds consolidation",
    "intra-group murabaha",
    "Al Baraka Banking Group",
    "cross-border Islamic finance",
    "transfer pricing mudarib",
    "GCC banking group",
    "multi-jurisdiction consolidation",
    "Islamic finance group reporting",
...
skills:
  - name: "Consolidate Across AAOIFI and IFRS Frameworks"
    proficiency_level: "B2"
    category: "Applied"
    bloom_level: "Analyze"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can identify the top consolidation adjustments required when an AAOIFI parent consolidates IFRS subsidiaries, determine the appropriate group framework (IFRS primary with AAOIFI supplementary), and generate the consolidation adjustment journal entries for each policy difference"

  - name: "Handle IAH Funds in Consolidation"
    proficiency_level: "B2"
    category: "Applied"
    bloom_level: "Analyze"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can explain why IAH funds create the most complex consolidation issue in Islamic banking (separate category under AAOIFI vs financial liability under IFRS), determine which treatment the group should adopt for consolidated statements, and produce the reclassification journal entry"

  - name: "Evaluate Shariah Compliance of Intra-Group Transactions"
    proficiency_level: "B2"
    category: "Conceptual"
    bloom_level: "Evaluate"
    digcomp_area: "Digital Literacy"
    measurable_at_this_level: "Student can assess whether intra-group murabaha is a genuine trading transaction or an inter-company funding arrangement, determine whether it should be eliminated on consolidation, and identify the Shariah compliance question that the SSB must resolve"
...
cognitive_load:
  new_concepts: 5
  concepts_list:
    - "Multi-framework consolidation (AAOIFI parent with IFRS subsidiaries)"
    - "IAH funds reclassification in group accounts (separate category vs financial liability)"
    - "Intra-group murabaha elimination and Shariah compliance question"
    - "Transfer pricing for intra-group mudarib fees (Pakistan FBR)"
    - "Dual-framework group reporting (IFRS primary with AAOIFI supplementary disclosures)"
  assessment: "5 concepts at B2 level. Students arrive having completed the AAOIFI vs IFRS capstone (L14) and all prior product and jurisdiction lessons. The cognitive challenge is applying consolidation mechanics to the specific Islamic finance differences they have already studied. No new products or jurisdictions are introduced — only the consolidation layer."

differentiation:
  extension_for_advanced: "Research the Islamic Development Bank Group's published consolidated financial statements. The IsDB Group consolidates entities across AAOIFI and IFRS jurisdictions. Identify how the IsDB Group handles IAH fund presentation in its consolidated balance sheet and compare with the approach you took in this exercise."
  remedial_for_struggling: "Focus on Steps 1 and 2 only. If you can identify three consolidation adjustments between an AAOIFI parent and an IFRS subsidiary, and explain why IAH funds are the most complex adjustment, you have understood the core challenge. The transfer pricing and full financial statement steps apply the same logic to additional dimensions."

teaching_guide:
  lesson_type: "practice-lab"
  session_group: 5
  session_title: "Cross-Domain Integration"
  key_points:
    - "This exercise models the real challenge facing Al Baraka, IsDB Group, and every Islamic banking group spanning AAOIFI and IFRS jurisdictions"
    - "IAH funds are the single most complex consolidation issue because they do not exist as a category under IFRS — the reclassification is not presentational, it is conceptual"
    - "Intra-group murabaha raises a Shariah question that the agent cannot resolve — whether one Islamic bank can make a murabaha to another group entity is an SSB judgment"
    - "The pragmatic industry answer for group reporting is IFRS primary with AAOIFI supplementary disclosures for Bahrain/Qatar regulatory compliance"
  misconceptions:
    - "Students may assume consolidation adjustments are purely mechanical — the IAH funds reclassification involves a conceptual decision about the nature of the instrument, not just a label change"
    - "Students may treat intra-group murabaha as identical to conventional inter-company loans — the Shariah compliance question is genuinely open and must be escalated to the SSB"
---
