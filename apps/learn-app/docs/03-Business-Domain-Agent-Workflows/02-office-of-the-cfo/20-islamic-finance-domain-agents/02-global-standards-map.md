...
keywords:
  [
    "Islamic finance standards map",
    "AAOIFI accounting standards",
    "IFRS Islamic finance",
    "MFRS Islamic banking",
    "murabaha comparison",
    "Bahrain AAOIFI",
    "Malaysia MFRS",
    "UK Islamic banking",
...
skills:
  - name: "Read the Global Standards Map"
    proficiency_level: "A2"
    category: "Conceptual"
    bloom_level: "Remember"
    digcomp_area: "Information Literacy"
    measurable_at_this_level: "Student can look up any of the 20 reference jurisdictions in the Global Standards Map and identify its primary standard, AAOIFI role, regulator, and unique features"

  - name: "Compare Accounting Treatment Across Regimes"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Analyze"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can take a murabaha transaction and explain how the income label, receivable classification, and balance sheet presentation differ between an AAOIFI-primary jurisdiction and an IFRS jurisdiction, identifying which differences are compliance-critical"

learning_objectives:
  - objective: "Use the Global Standards Map to identify the primary standard, AAOIFI role, and regulator for any of the 20 reference jurisdictions"
    proficiency_level: "A2"
    bloom_level: "Remember"
    assessment_method: "Given a jurisdiction name, student can state its primary standard, whether AAOIFI is mandatory or supplemental, and name its Islamic finance regulator"
  ...
  - objective: "Classify jurisdictions into the three accounting regimes and explain what determines regime membership"
    ...
    assessment_method: "Student can assign 8+ jurisdictions to the correct regime and explain the distinguishing factor (whether AAOIFI or IFRS or local standards serve as the primary framework)"

cognitive_load:
  new_concepts: 6
  concepts_list:
    - "The Global Standards Map as a reference tool (20 jurisdictions)"
