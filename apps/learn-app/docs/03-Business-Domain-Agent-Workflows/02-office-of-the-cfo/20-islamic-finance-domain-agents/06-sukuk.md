...
skills:
  - name: "Apply the SPPI Test to Sukuk Instruments"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Digital Literacy"
    measurable_at_this_level: "Student can apply the IFRS 9 SPPI test to different sukuk structures (ijarah, musharakah, mudarabah), determine whether each passes or fails, explain the accounting classification consequence (amortised cost, FVOCI, or FVTPL), and identify the impact of a purchase undertaking on the SPPI analysis"

  - name: "Compare Sukuk Accounting Across Four Jurisdictions"
    proficiency_level: "B2"
    category: "Applied"
    bloom_level: "Analyze"
    digcomp_area: "Information Literacy"
    measurable_at_this_level: "Student can produce a comparison table of sukuk investor accounting across AAOIFI FAS 25, MFRS 9, and IFRS 9, identifying differences in measurement basis, income labels, and impairment approach for the same sukuk held by investors in different jurisdictions"

  - name: "Analyse Sukuk Issuer Derecognition Under IFRS"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Analyze"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can apply the IFRS 9 derecognition criteria to a sukuk issuance, determine whether the originator's underlying assets should be derecognised, assess the impact of a purchase undertaking on the derecognition analysis, and classify the sukuk as financial liability or equity under IAS 32"
...
learning_objectives:
  ...
  - objective: "Compare sukuk investor accounting across three jurisdictions (Bahrain AAOIFI FAS 25, Malaysia MFRS 9, UK IFRS 9), identifying differences in measurement basis, income labels, and impairment approach"
    proficiency_level: "B2"
    bloom_level: "Analyze"
    assessment_method: "Student produces the comparison table in Exercise 3 Step 5 and assesses AAOIFI Draft Standard 62 risk"

cognitive_load:
  new_concepts: 7
  concepts_list:
    - "Sukuk as certificates of ownership in underlying assets"
    - "Ijarah sukuk structure (sale-and-leaseback)"
    - "The SPPI test for sukuk classification"
    - "Purchase undertaking and its derecognition impact"
...
**Issuer journal entry at issuance:**
...
| AAOIFI FAS 25 Category | Similar IFRS 9 Category | Measurement            |
| ---------------------- | ----------------------- | ---------------------- |
...
| -------------------------------------------------------- | ------------------------------------------------------ |
| Sukuk = unsecured claim on originator's creditworthiness | Sukuk = secured claim on specific assets               |
| Investors have recourse to originator if assets fail     | Investors have recourse ONLY to the transferred assets |
| Most current sukuk structures                            | Would require restructuring most existing sukuk        |
...
3. **Malaysia investor accounting (MFRS 9).** Tell your AI assistant: _"Jurisdiction: Malaysia. Framework: MFRS 9. An investor holds MYR 80M. Apply the SPPI test: do the cash flows represent solely principal and return? Note the purchase undertaking impact on SPPI. Conclude: amortised cost, FVOCI, or FVTPL? Justify."_

4. **UK investor accounting (IFRS 9).** Tell your AI assistant: _"Jurisdiction: UK. Framework: IFRS 9. An investor holds $25M. Apply the same SPPI test. Does the fact that the sukuk is listed on the LSE change any aspect of the accounting? Generate IFRS 9 journal entries for initial recognition and first semi-annual distribution."_
