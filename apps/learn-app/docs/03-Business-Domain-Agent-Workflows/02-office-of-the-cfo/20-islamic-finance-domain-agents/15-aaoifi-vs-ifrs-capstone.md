...
skills:
  - name: "Build Complete AAOIFI Financial Statements"
    proficiency_level: "B2"
    category: "Applied"
    bloom_level: "Create"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can construct a complete set of AAOIFI financial statements for a Bahraini Islamic bank — statement of financial position, statement of income, statement of changes in equity of investment account holders, and statement of cash flows — using AAOIFI-specific line items and presentation requirements without defaulting to IFRS labels"

  - name: "Reconcile AAOIFI to IFRS Financial Statements"
    proficiency_level: "B2"
    category: "Applied"
    bloom_level: "Analyze"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can identify the five most material accounting differences between AAOIFI and IFRS treatment for an Islamic bank, quantify the USD impact of each difference on assets, liabilities, equity, and net income, and produce IFRS financial statements from AAOIFI statements via reconciling adjustments"

  - name: "Draft Auditor Risk Assessment for Framework Tension"
    proficiency_level: "B2"
    category: "Applied"
    bloom_level: "Evaluate"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can identify the five most significant audit risks that arise from AAOIFI/IFRS framework tension, assess each risk as high/medium/low, specify the primary audit procedure, and draft the audit working paper conclusion for each risk"

learning_objectives:
  - objective: "Create a complete set of AAOIFI financial statements for a hypothetical Bahraini Islamic bank using AAOIFI-specific presentation, line items, and terminology"
    proficiency_level: "B2"
    bloom_level: "Create"
    assessment_method: "Student produces four AAOIFI financial statements with correct line items (murabaha receivables, ijarah assets, equity of IAH), no IFRS-default labels (no 'loans and advances,' no 'net interest income'), and the separate statement of changes in equity of investment account holders"

  - objective: "Analyze the five most material AAOIFI/IFRS differences for an Islamic bank and produce a reconciliation table quantifying the USD impact on assets, liabilities, equity, and net income"
    proficiency_level: "B2"
    bloom_level: "Analyze"
    assessment_method: "Student identifies at least five material differences (IAH classification, ijarah asset treatment, income labelling, impairment approach, zakat treatment), quantifies each, and produces IFRS statements from AAOIFI via reconciling adjustments"

  - objective: "Evaluate the audit risks arising from AAOIFI/IFRS framework tension and draft an auditor's risk assessment working paper with specific procedures for each risk"
    proficiency_level: "B2"
    bloom_level: "Evaluate"
    assessment_method: "Student drafts a risk assessment identifying at least five framework-tension audit risks, with risk rating, primary procedure, and working paper conclusion for each"

cognitive_load:
  new_concepts: 7
  concepts_list:
    - "AAOIFI statement of financial position presentation (no 'loans and advances')"
    - "Statement of changes in equity of investment account holders (separate from bank equity)"
    - "AAOIFI/IFRS ijarah asset treatment divergence (on-balance-sheet vs derecognition)"
    - "IAH classification difference (separate category vs financial liability)"
    - "ROE divergence caused by framework choice (larger vs smaller equity base)"
    - "Reconciling adjustment methodology (AAOIFI → IFRS via journal entries)"
    - "Framework-tension audit risks (dual-reporting, label compliance, ratio distortion)"
  assessment: "7 concepts at B2 level. This is the capstone accounting exercise — it integrates all prior product knowledge (murabaha, ijarah, musharaka, mudaraba) and all jurisdiction knowledge (Bahrain AAOIFI specifically) into a single comprehensive deliverable. Students are expected to work through the full exercise across multiple sessions if needed."

differentiation:
  extension_for_advanced: "Extend the exercise to a three-entity group: Bahrain parent (AAOIFI), UAE subsidiary (IFRS), and Malaysia subsidiary (MFRS). Produce consolidated group financial statements under IFRS as the primary framework with supplementary AAOIFI disclosures for the Bahrain parent's regulatory compliance. This mirrors the real challenge facing Al Baraka Banking Group, Ithmaar Bank, and other multi-jurisdiction Islamic banking groups."
  remedial_for_struggling: "Focus on Steps 1 and 2 only — building the AAOIFI statements and identifying the five material differences. The reconciliation (Step 3) and ratio comparison (Step 4) require Step 2 as input. If you can produce the AAOIFI statements with correct line items and identify why ROE differs under the two frameworks, you have the capstone concept."
...
teaching_guide:
  ...
  misconceptions:
    - "Students may assume AAOIFI and IFRS produce materially different income numbers — in most cases the income measurement is arithmetically identical; the differences are in presentation, classification, and balance sheet structure"
    - "Students may think the ROE difference is a performance difference — it is entirely an accounting artefact caused by the size of the equity denominator"
  discussion_prompts:
    - "If an investor is comparing a Bahrain AAOIFI bank with a UAE IFRS bank, and the Bahrain bank shows a lower ROE, is the Bahrain bank actually less profitable? How would you adjust the comparison?"
    - "Should AAOIFI adopt IFRS 9 ECL impairment to replace FAS 30, or should it maintain its own impairment framework? What are the consequences for comparability?"
  teaching_tips:
    - "Encourage students to build the AAOIFI statements first without referencing IFRS — this forces them to think in AAOIFI terms rather than converting IFRS statements into AAOIFI labels"
    - "The ratio comparison in Step 4 is the most powerful demonstration of why framework choice matters — use the ROE difference as the central teaching moment"
  assessment_checks:
    - question: "Why does the AAOIFI treatment of investment account holders as a separate balance sheet category produce a different ROE than IFRS treatment as financial liabilities?"
      expected_response: "Under AAOIFI, IAH funds are presented separately — neither as liabilities nor as bank equity. This increases the apparent equity base when calculating ROE (because the denominator includes IAH), producing a lower ROE. Under IFRS, IAH funds are financial liabilities, making the equity base smaller and the ROE higher. The actual profitability is identical — the ROE difference is a measurement artefact."
    - question: "What is the most material balance sheet difference between AAOIFI and IFRS for an Islamic bank with a large ijarah portfolio?"
      expected_response: "Under AAOIFI FAS 32, ijarah assets remain on the lessor's balance sheet at cost less accumulated depreciation. Under IFRS 16, ijarah arrangements assessed as finance leases result in derecognition of the asset and recognition of a net investment in the lease. For a bank with $2B of ijarah assets, this can mean a multi-billion dollar difference in total assets between the two frameworks."
---
