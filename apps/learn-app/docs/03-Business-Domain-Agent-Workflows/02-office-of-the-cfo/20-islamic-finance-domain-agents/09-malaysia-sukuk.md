...
skills:
  - name: "Apply MFRS 9 to Malaysian Sukuk"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Digital Literacy"
    measurable_at_this_level: "Student can apply the IFRS 9 / MFRS 9 business model test and SPPI test to classify sukuk musharakah as financial liability (issuer) or financial asset at amortised cost / FVTPL (investor), and generate the corresponding journal entries with correct Malaysian income labels"

  - name: "Draft SC Malaysia Regulatory Disclosures"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can draft the accounting and financial disclosure sections of a sukuk Information Memorandum for SC Malaysia and Bursa Malaysia submission, including MFRS 9 classification rationale, SRI Sukuk Framework use-of-proceeds reporting, and Shariah compliance certification summary"

  - name: "Evaluate Green Sukuk Disclosure Requirements"
    proficiency_level: "B1"
    category: "Conceptual"
    bloom_level: "Analyze"
    digcomp_area: "Information Literacy"
    measurable_at_this_level: "Student can distinguish between accounting treatment (unchanged by green designation) and disclosure obligations (use-of-proceeds, impact reporting, SC verification) for sukuk issued under the SC Malaysia SRI Sukuk Framework"
...
cognitive_load:
  new_concepts: 6
  concepts_list:
    - "Sukuk musharakah IAS 32 classification (liability vs equity)"
    - "MFRS 9 SPPI test applied to sukuk cash flows"
    - "SC Malaysia SRI Sukuk Framework"
    - "Green sukuk use-of-proceeds reporting"
    - "EPF investor accounting for Malaysian sukuk"
    - "Information Memorandum regulatory disclosure structure"
  assessment: "6 concepts at B1 level. Students enter from Lesson 7 with product-level sukuk accounting knowledge (issuer and investor perspectives from the sukuk product lessons). This lesson applies that knowledge to Malaysia's specific regulatory and market context, adding the SRI Sukuk Framework as the green finance overlay."
...
teaching_guide:
  lesson_type: "core"
  session_group: 3
  session_title: "Jurisdiction Deep-Dives — Malaysia"
  key_points:
    - "Malaysia is the world's single largest sukuk market, accounting for approximately 35-40% of global sukuk issuance annually — this is not a regional market but the global reference case"
    - "Malaysia applies MFRS (IFRS-equivalent) — not AAOIFI — to sukuk accounting, meaning sukuk musharakah classification follows IAS 32 and MFRS 9 analysis"
    - "The SRI Sukuk Framework is Malaysia's globally watched contribution to sustainable Islamic finance — sustainable sukuk issuance grew 17% year-on-year in early 2024"
    - "The EPF (Employees Provident Fund) is one of the world's largest institutional investors in sukuk — its classification decisions under MFRS 9 set market standards"
  misconceptions:
    - "Students may assume green sukuk has different accounting treatment — in fact, the green designation changes only disclosures (use of proceeds, impact reporting), not recognition or measurement"
    - "Students may confuse sukuk musharakah with equity — most sukuk musharakah with fixed distributions and redemption at face value are classified as financial liabilities under IAS 32"
    - "Students may think Malaysia uses AAOIFI — Malaysia uses MFRS (IFRS-equivalent) with MASB Islamic application guidance; AAOIFI is used only as voluntary Shariah reference"
  discussion_prompts:
    - "If a sukuk musharakah has fixed quarterly distributions and a fixed redemption at face value, is it economically distinguishable from a conventional bond? If not, should the accounting treatment be identical?"
    - "Malaysia's SRI Sukuk Framework combines Islamic finance's asset-backed, ethical principles with global ESG requirements. Is this convergence natural, or does it create tension between Shariah compliance and ESG definitions?"
  teaching_tips:
    - "The IAS 32 classification question is the most important analytical moment — whether the sukuk is liability or equity depends entirely on whether there is a contractual obligation to deliver cash"
    - "Use Tenaga Nasional as a concrete, relatable example — it is Malaysia's national electricity company and students can understand why it would issue green sukuk for solar assets"
    - "The EPF investor step (Step 3) grounds institutional investor accounting in a real-world context that Malaysian students immediately recognise"
  assessment_checks:
    - question: "Why is a sukuk musharakah with fixed distributions and redemption at face value classified as a financial liability under IAS 32, even though the word 'musharakah' means partnership?"
      expected_response: "IAS 32 classifies financial instruments based on economic substance, not Shariah legal form. If the issuer has a contractual obligation to (a) pay fixed periodic distributions and (b) redeem at face value at maturity, those obligations meet the IAS 32 definition of a financial liability — a contractual obligation to deliver cash. The Shariah characterisation as musharakah (partnership) reflects the religious legal structure, but IFRS financial statements follow substance over form. A genuine equity-like musharakah sukuk would have no fixed distributions and no guaranteed redemption — returns would depend entirely on venture profit."
    - question: "What does the SRI Sukuk Framework add to a sukuk issuance that standard MFRS 9 accounting does not cover?"
      expected_response: "The SRI Sukuk Framework adds disclosure and reporting obligations: (1) Use of proceeds — allocation to eligible green/social projects must be specified and tracked; (2) Impact reporting — measurable environmental or social outcomes must be reported periodically; (3) SC Malaysia verification — the Securities Commission verifies the issuer's compliance with SRI criteria. These are additional disclosure requirements. The accounting measurement and recognition under MFRS 9 are unchanged — the sukuk is still measured at amortised cost or fair value regardless of the green designation."
---
...
| Institution                             | Role                                                                 | Relevance to Accounting                                             |
| --------------------------------------- | -------------------------------------------------------------------- | ------------------------------------------------------------------- |
| **Securities Commission (SC) Malaysia** | Regulates Islamic capital market products, approves sukuk structures | SRI Sukuk Framework, Information Memorandum requirements            |
...
| **MASB**                                | Sets accounting standards (MFRS = IFRS-equivalent)                   | MFRS 9 governs sukuk classification; no separate Islamic standards  |
...
:::info Sukuk Musharakah — The Dominant Malaysian Corporate Structure
...
:::tip EPF — Malaysia's Institutional Sukuk Benchmark
...
| ------------------------------- | ---------------------------------------------------------------------------------------------- |
| **Eligible project categories** | Renewable energy, green buildings, sustainable transport, water infrastructure, social housing |
| **Use of proceeds**             | Issuer must allocate proceeds exclusively to eligible SRI projects                             |
| **Impact reporting**            | Periodic reporting on measurable environmental or social outcomes achieved                     |
| **SC Malaysia verification**    | The Securities Commission verifies compliance with SRI criteria                                |
...
1. **Issuer classification (MFRS 9 / IAS 32).** Ask your AI assistant:
   ...
   _"Jurisdiction: Malaysia. Framework: MFRS. I am Tenaga Nasional Berhad (issuer). Classify the sukuk musharakah under IAS 32: (1) Is it a financial liability or equity? (2) Does the fixed distribution rate create a financial liability? (3) Does the obligation to redeem at face value at maturity create a financial liability? (4) Conclude on balance sheet classification. (5) Generate the journal entry for the initial issuance of MYR 3 billion."_

2. **Quarterly distribution accounting.** Ask:

   _"Generate the quarterly distribution entries for Year 1 (four quarters). Distribution amount: MYR 3B x 4.75% / 4 = MYR 35.625M per quarter. Under MFRS 9 amortised cost: (1) Is this distribution classified as a finance cost (P&L) or an equity distribution? (2) How does it appear in the income statement? (3) How does it affect the sukuk carrying value?"_

3. **EPF investor accounting (MFRS 9 SPPI test).** Ask:

   _"Malaysia's Employees Provident Fund (EPF) holds MYR 500M of the sukuk in its Shariah savings portfolio. Framework: MFRS 9. (1) Business model test: EPF holds to collect contractual cash flows — which model? (2) SPPI test: do the cash flows represent solely principal and a Shariah-compliant return? (3) Classification: amortised cost or FVOCI? (4) Calculate the effective profit rate equating initial price to all future cash flows. (5) Generate journal entries for initial recognition and first quarterly income."_

4. **Green sukuk overlay (SRI Sukuk Framework).** Ask:

   _"Tenaga wishes to designate this sukuk as a Green Sukuk under the SC Malaysia SRI Sukuk Framework. (1) What additional disclosures are required in the offering circular? (2) What ongoing reporting obligations apply — use of proceeds, impact reporting? (3) How does the Green designation affect the accounting — any difference in recognition or measurement? (4) Draft the Use of Proceeds section for a green sukuk financing solar generation assets."_

5. **SC Malaysia Information Memorandum section.** Ask:

   _"Draft the accounting and financial disclosure section of the Information Memorandum for this sukuk. Required sections per SC Malaysia guidelines: (1) Summary of accounting policies for sukuk financing; (2) Historical and projected debt coverage ratios; (3) MFRS 9 classification rationale; (4) Risks relating to accounting treatment; (5) Shariah compliance certification summary. Format for submission to Bursa Malaysia and SC Malaysia."_
...
- **Securities Commission Malaysia — SRI Sukuk Framework:** [sc.com.my/regulation/guidelines/recognizing-markets/guidelines-on-sri-sukuk](https://www.sc.com.my/regulation/guidelines/recognizing-markets)
