...
| #   | Chapter                                                            | Key Focus                                                         |
| --- | ------------------------------------------------------------------ | ----------------------------------------------------------------- |
| 25  | [The Enterprise Agentic Landscape](enterprise-agentic-landscape)   | Strategic landscape, deployment patterns, build vs. buy framework |
| 26  | [The Enterprise Agent Blueprint](enterprise-agent-blueprint)       | Cowork plugin anatomy, PQP Framework, governance, and ownership   |
| 27  | [The Knowledge Extraction Method](the-knowledge-extraction-method) | Transforming tacit expert knowledge into SKILL.md files           |
