...
skills:
  - name: "Design a Four-Phase Offboarding Process Using /offboard"
  ...
  - name: "Design an Exit Interview for Institutional Learning"
    ...
    measurable_at_this_level: "Student can explain why exit interviews must be conducted by an HRBP (not the line manager), design a question structure covering departure reason, experience assessment, and organisational learning, and evaluate the quality of an exit interview output"

  - name: "Configure the Offboarding-Knowledge-Agent for HRIS-Triggered Automation"
    proficiency_level: "B1"
    category: "Technical"
    bloom_level: "Apply"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can describe the five-step workflow the offboarding-knowledge-agent follows on resignation confirmation and explain how it integrates with the knowledge capture plan from Lesson 10"

learning_objectives:
  - objective: "Apply the four offboarding principles to evaluate an existing offboarding process and identify what is missing"
    proficiency_level: "B1"
    bloom_level: "Evaluate"
    assessment_method: "Student scores a fictional or real offboarding process against the four principles and identifies at least two gaps with specific improvement suggestions"

  - objective: "Use /offboard to generate a complete offboarding plan with phase-by-phase actions, owners, and dates"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student produces an offboarding plan for a named departing employee that includes all four phases, correctly assigns owners, and includes the handover table format for at least three work areas"

  - objective: "Explain why the exit interview must not be conducted by the line manager and design a question structure for institutional learning"
    proficiency_level: "B2"
    bloom_level: "Create"
    assessment_method: "Student articulates the conflict-of-interest reason, then produces a ten-question exit interview guide covering departure reasoning, experience assessment, and organisational learning"
...
differentiation:
  ...
  remedial_for_struggling: "Focus on two things: the four offboarding principles and why the exit interview must not be conducted by the line manager. If you can articulate these two concepts and produce a basic handover plan table (three work areas, with owner and date for each), you have the core framework. The four-phase structure will become clear once you work through the exercise."
