...
skills:
  - name: "Assess Institutional Knowledge Risk Using a Structured Risk Classification Framework"
    proficiency_level: "B2"
    category: "Applied"
    bloom_level: "Analyze"
    digcomp_area: "Information"
    measurable_at_this_level: "Student can apply the HIGH/MEDIUM/LOW risk scoring model to identify the three employees in their organisation whose departure would represent the greatest knowledge loss, with a written justification for each classification"

  - name: "Design a Structured Knowledge Capture Plan for a Departing Employee Using /knowledge"
    proficiency_level: "B1"
    category: "Technical"
    bloom_level: "Create"
    digcomp_area: "Content-Creation"
    measurable_at_this_level: "Student can invoke /knowledge with relevant employee context and produce a capture plan that specifies knowledge areas, session structure, interview questions, and knowledge article outputs"

  - name: "Structure Captured Knowledge Into Searchable Knowledge Articles"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Content-Creation"
    measurable_at_this_level: "Student can take notes from a knowledge capture session and structure them into knowledge articles with the required fields: title, knowledge, when it applies, exceptions, related contacts, and confidence level"

learning_objectives:
  - objective: "Explain the difference between explicit and tacit organisational knowledge, and why tacit knowledge is at high risk of permanent loss"
    proficiency_level: "B1"
    bloom_level: "Understand"
    assessment_method: "Student gives a concrete example of tacit knowledge from their own experience and explains why it would not survive the holder's departure without structured capture"

  - objective: "Apply the knowledge risk scoring model to identify high-risk knowledge holders in an organisation"
    proficiency_level: "B2"
    bloom_level: "Apply"
    assessment_method: "Student scores at least three employees using the five-factor model and correctly classifies each as HIGH, MEDIUM, or LOW risk with written justification"
...
Continue to [Lesson 11: Offboarding and Knowledge Transfer →](./11-offboarding-knowledge-transfer.md)
