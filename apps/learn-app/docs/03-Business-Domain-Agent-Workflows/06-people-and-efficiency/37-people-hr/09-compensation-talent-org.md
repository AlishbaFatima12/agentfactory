---
slug: /Business-Domain-Agent-Workflows/people-hr/compensation-talent-org
sidebar_position: 9
title: "Compensation, Talent & Org Planning"
description: "Use /comp-analysis, /match, and /org-planning together to benchmark pay, assess internal candidates for succession, and redesign team structures when someone moves up"
keywords:
  [
    "people and hr",
    "hr operations",
...
skills:
  - name: "Benchmark Compensation Using Percentile Bands"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Information"
    measurable_at_this_level: "Student can invoke /comp-analysis for a role and interpret the 25th/50th/75th/90th percentile output to determine whether a salary range is competitive and whether internal equity is maintained"

  - name: "Assess Internal Candidates Across Six Dimensions Using /match"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Analyze"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can use /match to systematically assess two or more internal candidates against a role, evaluate the six-dimension output, and apply the READY NOW / READY IN 6 MONTHS / READY IN 12 MONTHS / DEVELOPING / NOT A FIT classification"

  - name: "Design Succession Planning Conversations Without Making Promotion Promises"
  ...
  - name: "Diagnose Org Structure Issues Using Span-of-Control Analysis"
    ...
    bloom_level: "Analyze"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can use /org-planning to identify span-of-control violations and IC-to-manager ratio issues, and propose a restructure when an internal promotion changes the reporting map"

learning_objectives:
  - objective: "Use /comp-analysis to produce percentile benchmarks for a role and assess internal equity for a promotion"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student runs /comp-analysis for a specific role, receives percentile bands, and correctly identifies which band the proposed salary falls in and whether it presents an internal equity risk"

  - objective: "Run /match to assess two internal candidates against a role using all six dimensions and produce a readiness classification"
    proficiency_level: "B1"
    bloom_level: "Analyze"
    assessment_method: "Student invokes /match with two candidates, receives the six-dimension output, and can justify the readiness classification for each candidate with reference to specific evidence in the output"

  - objective: "Apply /org-planning to model the structural impact of an internal promotion and identify span-of-control risks"
    proficiency_level: "B1"
    bloom_level: "Apply"
...
- The compensation range based on `/comp-analysis`
- The structural adjustments needed based on `/org-planning`
- Whether you recommend having a succession conversation now, and what you would say
...
Continue to [Lesson 10: Institutional Knowledge Capture →](./10-institutional-knowledge-capture.md)
