...
skills:
  - name: "Configure an Onboarding Orchestrator Agent with HRIS-Triggered Workflow Timeline"
    proficiency_level: "B1"
    category: "Technical"
    bloom_level: "Apply"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can describe the full T-14 to Day 90 workflow, identify the three alert trigger conditions, and trace what the onboarding orchestrator produces at each milestone"

  - name: "Configure a Policy Maintenance Agent with Monthly and Event-Triggered Monitoring"
    proficiency_level: "B1"
    category: "Technical"
    bloom_level: "Apply"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can identify the five monthly checks the policy maintenance agent performs, explain how statutory rate changes trigger the event-based workflow, and run a simulated monthly audit"

  - name: "Distinguish Event-Triggered from Scheduled Agent Architectures"
    proficiency_level: "B2"
    category: "Conceptual"
    bloom_level: "Analyze"
    digcomp_area: "Information"
    measurable_at_this_level: "Student can classify any proposed HR agent as event-triggered or scheduled, explain which architecture fits each use case, and identify when an agent needs both (hybrid trigger)"

learning_objectives:
  - objective: "Trace the full onboarding orchestrator workflow from T-14 through Day 90, including alert conditions and escalation paths"
    proficiency_level: "B1"
    bloom_level: "Understand"
    assessment_method: "Student produces a timeline diagram or table showing all eight milestones, the actions at each, and the three alert trigger conditions with their escalation paths"

  - objective: "Configure the policy maintenance agent for a specific jurisdiction and run a simulated monthly policy audit"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student configures the agent for their jurisdiction, runs all five monthly checks on a sample policy set, and produces a maintenance report identifying at least two issues requiring action"
...
| Architecture        | Trigger                            | Examples                                                                                        |
| ------------------- | ---------------------------------- | ----------------------------------------------------------------------------------------------- |
| **Event-triggered** | Activated by a specific HRIS event | `onboarding-orchestrator` (new hire record), `offboarding-knowledge-agent` (resignation record) |
...
**Architecture:** Event-triggered (HRIS new hire record)
**Sensitivity:** CONFIDENTIAL
**What it catches:** Everything humans forget when they are managing five other new starters
...
| Milestone     | Agent action                                                                     | Who receives it                           |
| ------------- | -------------------------------------------------------------------------------- | ----------------------------------------- |
| **T-14 days** | Generate pre-boarding checklist; assign tasks to HR, IT, and Manager             | HR team, IT team, Manager                 |
| **T-7 days**  | Send Day 1 schedule to new starter; chase any incomplete pre-boarding items      | New starter, HR, Manager                  |
| **T-3 days**  | Check all critical pre-boarding items; escalate any incomplete items immediately | HR team (urgent alert)                    |
| **Day 1**     | Confirm IT setup complete; send personalised welcome message from HR             | New starter, Manager                      |
| **Day 10**    | Check mandatory compliance training completion; chase incomplete                 | Manager, new starter                      |
| **Day 30**    | Schedule 30-day check-in; send check-in agenda to manager and new starter        | Manager, new starter                      |
| **Day 60**    | Schedule 60-day check-in; gather feedback from new starter (satisfaction survey) | Manager, new starter, HR                  |
| **Day 90**    | Schedule 90-day review; generate 30-60-90 completion summary                     | Manager, new starter, HR Business Partner |
...
**Architecture:** Hybrid (monthly schedule + event-triggered on statutory rate changes)
**Sensitivity:** ROUTINE
**What it catches:** Policy drift, out-of-date rates, broken links, FAQ gaps
...
**Type:** Configuration and Applied Testing
**Time:** 40 minutes
...
Continue to [Lesson 13: People Analytics and Agent Operations →](./13-people-analytics-agent-operations.md)
