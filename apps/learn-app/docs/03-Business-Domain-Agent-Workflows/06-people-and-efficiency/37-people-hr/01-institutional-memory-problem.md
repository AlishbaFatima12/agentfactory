---
slug: /Business-Domain-Agent-Workflows/people-hr/institutional-memory-problem
sidebar_position: 1
title: "The Institutional Memory Problem"
description: "Understand why HR teams spend the majority of their time on information routing — and what an AI-native HR operation does instead"
keywords:
  [
    "people and hr",
    "hr operations",
...
skills:
  - name: "Classify HR Work by Type — Information Routing vs Process Execution vs Knowledge Capture"
    proficiency_level: "A2"
    category: "Conceptual"
    bloom_level: "Understand"
    digcomp_area: "Information"
    measurable_at_this_level: "Student can take a list of HR activities and correctly classify each as information routing, process execution, or knowledge capture — and identify which classification makes each a candidate for AI automation"

  - name: "Distinguish Explicit from Tacit Organisational Knowledge"
    proficiency_level: "A2"
    category: "Conceptual"
    bloom_level: "Analyze"
    digcomp_area: "Information"
    measurable_at_this_level: "Student can review a list of HR knowledge items and correctly label each as explicit (findable in documents) or tacit (exists only in people's heads) — and identify which tacit items represent the highest organisational risk"

  - name: "Apply the Three-Function Framework to Diagnose HR Operational Overhead"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can map their own organisation's recurring HR questions and tasks to the three-function framework, identify which function accounts for the most overhead, and articulate which explicit-vs-tacit gaps present the greatest risk"

learning_objectives:
  - objective: "Explain the explicit vs tacit knowledge distinction and why both create HR operational overhead"
    proficiency_level: "A2"
    bloom_level: "Understand"
    assessment_method: "Student can describe both knowledge types with a concrete example of each from an HR context, and explain why each creates a different category of problem"

  - objective: "Classify the three HR functions that AI transforms and explain what changes in each"
    proficiency_level: "A2"
    bloom_level: "Understand"
    assessment_method: "Student identifies all three functions (information routing, process execution, knowledge capture) and correctly describes what AI changes — and does not change — in each"

  - objective: "Conduct a diagnostic of an organisation's top recurring HR questions and classify each by knowledge type and function"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student produces a list of 10 recurring HR questions or tasks classified by function and knowledge type, with the highest-risk tacit knowledge items flagged"

cognitive_load:
  new_concepts: 4
  concepts_list:
    - "Explicit knowledge — organisational information that exists in documents and is theoretically findable"
    - "Tacit knowledge — unwritten understandings that govern how things actually work, held in people's heads"
    - "Information routing — answering questions that have written answers; the 60% problem"
    - "Three-function framework — information routing, process execution, knowledge capture"
  assessment: "4 foundational concepts at A2 level — appropriate for a chapter-opening lesson. The lesson introduces the conceptual vocabulary (explicit vs tacit, three functions) that every subsequent lesson depends on. No plugin commands means the cognitive load stays on understanding, not execution."

differentiation:
  extension_for_advanced: "Interview three colleagues in your HR team (or three HR professionals you know) and ask each one to estimate the percentage of their week spent on each of the three functions. Compare their estimates. Where do they agree? Where do they differ? What does the disagreement tell you about how overhead is distributed across HR roles?"
  remedial_for_struggling: "Focus on the 60/40 split in the opening quote. Can you name five things from your own experience that fit the '60%' category — questions with written answers that people still ask in person? That is information routing. Everything else in the lesson builds from that one pattern."

teaching_guide:
  key_points:
    - "The problem is not that policies do not exist — it is that they cannot be found or understood without asking a person"
    - "Tacit knowledge is the harder problem — it is invisible until the person who holds it leaves"
    - "AI does not replace HR judgment on difficult situations — it eliminates the administrative overhead that crowds out that judgment"
    - "The three-function framework is the lens for every subsequent lesson — students should be able to place any HR activity into one of the three"
  misconceptions:
    - "HR automation means replacing HR professionals. Correction: the lesson is explicit that AI targets the 60% that consumes time without adding value — freeing capacity for the 40% that only humans can do."
    - "Tacit knowledge is informal and therefore unimportant. Correction: tacit knowledge is often the most operationally critical — it is the knowledge that makes the organisation actually function, not just formally comply."
    - "Writing something down converts tacit to explicit knowledge. Correction: explicit knowledge must also be findable, current, and comprehensible. Documents that nobody can locate or understand remain practically tacit."
  discussion_prompts:
    - "Think about the last time a colleague left your organisation. What knowledge did they take with them that was never written down? How did you find out it was missing?"
    - "If 60% of HR time is information routing, what would your HR team do with that time if it were freed? What work is currently chronically under-invested?"
  teaching_tips:
    - "The CPO quote at the opening is the lesson in miniature — use it as a discussion anchor. Ask students whether this matches their experience before explaining the framework."
    - "The knowledge classification exercise works best as a collaborative activity — students discover that what they thought was explicit knowledge (written in a policy) is in practice tacit (nobody can find it, so they ask a person)."
---
...
**Time:** 25 minutes
**Plugin command:** None (concepts only)
**Goal:** Map your organisation's recurring HR questions to the explicit/tacit framework and identify the highest-risk knowledge gaps
...
Continue to [Lesson 2: Your HR Operations Stack →](./02-hr-operations-stack.md)
