---
slug: /Business-Domain-Agent-Workflows/people-hr/onboarding-first-90-days
sidebar_position: 5
title: "Onboarding — The First 90 Days"
description: "Design structured onboarding programmes that give new hires clear success criteria at every stage — using the /onboarding skill to generate pre-boarding checklists, 30-60-90 plans, and manager briefings calibrated to role and seniority"
keywords:
  [
    "people and hr",
    "hr operations",
...
skills:
  - name: "Design 30-60-90 Onboarding Plans with Observable Success Criteria"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Create"
    digcomp_area: "Content-Creation"
    measurable_at_this_level: "Student can use /onboarding to generate a complete onboarding programme — pre-boarding checklist, week-by-week schedule, 30-60-90 framework with specific success criteria — and audit the output against the three failure modes before using it"

  - name: "Calibrate Onboarding Programmes by Seniority Level"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Analyze"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can compare /onboarding outputs for junior, mid, and senior hires in the same role family and articulate how the 30-60-90 expectations differ by seniority — independence threshold, stakeholder scope, and contribution type"

  - name: "Evaluate Onboarding Success Criteria for Specificity and Observability"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Evaluate"
    digcomp_area: "Information"
    measurable_at_this_level: "Student can distinguish weak from strong success criteria and rewrite vague goals (understands the culture) into observable outcomes (can describe three strategic priorities and explain how their role contributes)"

learning_objectives:
  - objective: "Identify the three onboarding failure modes and explain how each undermines new hire productivity"
    proficiency_level: "A2"
    bloom_level: "Understand"
    assessment_method: "Student names the three failure modes and gives one concrete example of each from their own experience or the lesson scenario"

  - objective: "Use /onboarding to generate a complete onboarding programme with role-specific 30-60-90 plan and pre-boarding checklist"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student invokes /onboarding with the required inputs and receives a plan that includes pre-boarding checklist, week 1 schedule, and 30-60-90 milestones — then verifies each milestone against the strong success criteria standard"

  - objective: "Design seniority-differentiated onboarding variants for the same role family"
    proficiency_level: "B1"
    bloom_level: "Create"
    assessment_method: "Student produces two /onboarding outputs for the same role at different seniority levels and explains at least two meaningful differences in the 30-60-90 expectations"

cognitive_load:
  new_concepts: 4
  concepts_list:
    - "Three onboarding failure modes — Information Dump, Administrative Bottleneck, Invisible Ramp"
    - "Pre-boarding checklist — actions that must complete before Day 1, split by owner (HR/IT/Manager)"
    - "30-60-90 framework — staged milestones that define what success looks like at each checkpoint"
    - "Success criteria quality — the distinction between vague goals and observable, assessable outcomes"
  assessment: "4 concepts at B1 level — manageable given that three of the four are variations on a single diagnostic theme (what goes wrong and how to prevent it). The 30-60-90 framework is the core deliverable; the success criteria quality concept is the key insight that makes it practically useful."

differentiation:
  extension_for_advanced: "Pull your organisation's last three onboarding surveys or 90-day review outcomes. For each new hire who left within 12 months, trace back to the onboarding record and identify which failure mode was present. Build a failure mode frequency table and use it to prioritise which onboarding element to redesign first — this is what a CHRO would do before a full onboarding programme overhaul."
  remedial_for_struggling: "Focus on one thing: what does success look like at 30 days for a specific real role you know well? Write three success criteria in the strong format (observable, verifiable, role-specific) before running /onboarding. The skill works better when you are clear on the outcome before you ask for the plan."

teaching_guide:
  key_points:
    - "The three failure modes are not about effort or intention — most HR teams work hard on onboarding. They are structural: wrong format (dump), wrong timing (bottleneck), wrong definition of success (invisible ramp)"
    - "Success criteria quality is the single biggest lever in an onboarding programme — weak criteria make it impossible to tell whether a new hire is on track until it is too late"
    - "/onboarding is a template generator, not a replacement for manager judgment — the manager's briefing conversation on Day 1 is still the most important moment in the onboarding process"
    - "Seniority differentiation matters: the same role at senior level requires a different 30-day focus (stakeholder relationships first) than at junior level (tool fluency and supervised tasks first)"
  misconceptions:
    - "More onboarding content means better onboarding. Correction: volume is the Information Dump failure mode in disguise. A new hire who has 12 context sessions in Week 1 retains almost none of them. Better onboarding is less content, better sequenced, with explicit check-ins to verify retention."
    - "If the laptop is ready and access is provisioned, the Administrative Bottleneck is solved. Correction: administrative readiness is necessary but not sufficient. The Invisible Ramp is the failure mode that kills long-term outcomes — without defined success criteria, a new hire can be productively busy for 90 days and still be failing at the things that matter."
    - "/onboarding replaces the manager's role in onboarding. Correction: the skill generates the structure; the manager provides the context, relationships, and judgment. The first-week check-in is irreplaceable."
  discussion_prompts:
    - "Think about the best and worst onboarding experiences you have had or witnessed. Which failure mode explains the worst one? What specifically was missing?"
    - "What is the difference between a goal (be productive by day 90) and a success criterion (have delivered the first solo analysis and presented it to a stakeholder group)? Why does the difference matter for the new hire?"
  teaching_tips:
    - "Start with Ayesha's Day 1 disaster — it is immediately recognisable to anyone who has started a new job. This anchors the abstract failure modes in something concrete."
    - "Have students critique three sample 30-day success criteria before they run /onboarding. Building the discriminator before using the tool sharpens the output review significantly."
    - "The seniority differentiation exercise (Extend section) is where most of the learning depth lies — do not skip it."
---
...
The Invisible Ramp is the hardest failure mode to see, because organisations often _have_ a 30-60-90 plan and still fail to provide direction. The problem is the quality of the success criteria.
...
Continue to [Lesson 6: Job Descriptions & Interview Preparation →](./06-job-descriptions-interview-prep.md)
