...
skills:
  - name: "Deploy and Configure an HR Knowledge Base Agent for Employee Self-Service"
    proficiency_level: "B1"
    category: "Technical"
    bloom_level: "Apply"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can deploy the knowledge-base-agent with a configured FAQ knowledge base, test it with a range of query types, and verify that policy queries are answered accurately and individual-situation queries are escalated correctly"

  - name: "Classify HR Queries by Type and Design Appropriate Agent Responses"
    proficiency_level: "B2"
    category: "Applied"
    bloom_level: "Analyze"
    digcomp_area: "Information"
    measurable_at_this_level: "Student can distinguish between Type 1 (policy) and Type 2 (individual situation) queries, explain why the distinction matters, and evaluate whether agent responses follow the correct pattern for each type"

  - name: "Design a Warm Handoff Protocol for Sensitive HR Queries"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Create"
...
learning_objectives:
  - objective: "Explain the two query types the knowledge-base-agent handles and why the distinction determines the agent's response"
    ...
    assessment_method: "Student gives a correct example of a Type 1 and Type 2 query and explains what makes each type what it is"

  - objective: "Deploy the knowledge-base-agent with a FAQ knowledge base and verify query handling across policy and individual-situation queries"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student deploys the agent, tests it with at least 5 policy queries and 3 individual-situation queries, and confirms that each query type receives the correct category of response"

  - objective: "Evaluate the weekly knowledge-base-agent report to identify knowledge gaps and escalation trends"
    proficiency_level: "B2"
    bloom_level: "Evaluate"
    assessment_method: "Student reviews a sample weekly report and identifies at least two actionable items: a knowledge gap to address and a query category that signals policy confusion"
...
| ---------------------- | ----------------------------------------------------------- |
| **Accuracy**           | Figures and processes match your actual policy              |
| **Tone**               | Warm, practical, not legalistic                             |
| **Citation**           | Policy source included for Type 1; named contact for Type 2 |
| **Escalation clarity** | Employee knows exactly who to contact and how               |
