...
skills:
  - name: "Build a Structured Audit Preparation Plan Using the /audit Command"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can run /audit with a compliance map as input, interpret the week-by-week preparation timeline and evidence inventory, and identify which gaps must close before audit day"

  - name: "Run a Mock Audit to Identify Weaknesses Before the Real Review"
    proficiency_level: "B2"
    category: "Applied"
    bloom_level: "Analyze"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can simulate auditor questions for the highest-risk obligation areas, identify gaps in their ideal answers, and close those gaps before the actual audit"

  - name: "Draft Audit Responses That Demonstrate Governance Maturity"
    proficiency_level: "B2"
    category: "Applied"
    bloom_level: "Create"
    digcomp_area: "Communication"
    measurable_at_this_level: "Student can write an audit response that acknowledges a finding without arguing, identifies root cause, and provides a specific, time-bound, owned corrective action plan"

learning_objectives:
  - objective: "Generate a six-week audit preparation plan using /audit that includes an evidence inventory, gap prioritisation, and week-by-week actions"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student runs /audit with the L07 compliance map as input, produces a preparation plan for a regulatory visit with evidence inventory and gap closure actions, and identifies the top two priority gaps to close before audit day"

  - objective: "Conduct a mock audit of the highest-risk compliance area to surface weaknesses in evidence and answers before the real review"
    proficiency_level: "B2"
    bloom_level: "Analyze"
    assessment_method: "Student runs a mock audit on the AML/PEP screening obligation area, identifies at least two questions they cannot answer satisfactorily, and develops specific remediation actions for each weakness"

  - objective: "Draft an audit response for a hypothetical finding that is factual, root-cause-oriented, and includes a specific corrective action plan"
    proficiency_level: "B2"
    bloom_level: "Create"
    assessment_method: "Student's audit response acknowledges the finding without argument, correctly identifies a root cause, and provides a corrective action with named owner, specific action, and target date"
...
teaching_guide:
  ...
  misconceptions:
    ...
    - "The mock audit is optional if you are confident. Correction: confidence about your own controls is not the same as the ability to demonstrate them to a sceptical reviewer. The mock audit specifically tests demonstration, not possession of controls."
  discussion_prompts:
...
**Worked example.** The FCA has issued a finding: _"The firm's SM&CR annual certification records were not current at the time of the supervisory visit. Certification was due [date] and had not been completed. Finding classification: MAJOR."_ You type:
...
_"The firm's complaint handling procedure requires documented root cause analysis for all complaints. Review of 12 complaint records found 3 records with no root cause analysis documented. Finding: MINOR."_
...
Continue to [Lesson 9: Operational Risk Register That Works →](./09-operational-risk-register-that-works.md)
