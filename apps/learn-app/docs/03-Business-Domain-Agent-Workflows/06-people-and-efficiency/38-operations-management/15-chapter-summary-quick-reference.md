---
slug: /Business-Domain-Agent-Workflows/operations-management/chapter-summary-quick-reference
sidebar_position: 15
title: "Chapter Summary and Quick Reference"
description: "Review the central insight of operations intelligence, what this chapter built, and access quick-reference tables for all plugin commands, auto-skills, agents, and key frameworks"
keywords:
  [
    "operations management summary",
    "operations plugin quick reference",
...
skills:
  - name: "Synthesise Operations Intelligence Frameworks Into a Reference System"
    proficiency_level: "B2"
    category: "Applied"
    bloom_level: "Evaluate"
    digcomp_area: "Information-Literacy"
    measurable_at_this_level: "Student can select the correct plugin command, framework, or agent for any operational scenario described in the chapter and justify their choice using the quick-reference tables"

  - name: "Articulate the Operations-as-Intelligence Insight"
    proficiency_level: "B1"
    category: "Conceptual"
    bloom_level: "Evaluate"
    digcomp_area: "Communication"
    measurable_at_this_level: "Student can explain in two sentences why operations is an intelligence function rather than an administrative one, using at least one concrete example from the chapter"

learning_objectives:
  - objective: "Summarise what each of the 14 chapter exercises built and how the outputs feed each other"
    proficiency_level: "B1"
    bloom_level: "Understand"
    assessment_method: "Student can trace the dependency chain from ops.local.md through vendor audit, contract obligations, compliance map, to the intelligence brief without referencing earlier lessons"

  - objective: "Use the quick-reference tables to select the correct command, auto-skill, or agent for a given operational task"
    proficiency_level: "B2"
    bloom_level: "Apply"
    assessment_method: "Student correctly routes 8 of 10 operational scenarios to the right plugin command, auto-skill, or agent in the Try With AI exercise"

  - objective: "Apply the risk scoring matrix, change classification, and compliance status codes from memory or reference"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student can classify a described risk, change, and compliance situation using the correct framework, and explain what action each classification triggers"

cognitive_load:
  new_concepts: 0
  concepts_list: []
  assessment: "No new concepts in this lesson. The cognitive work is synthesis and consolidation. Students are organising what they have already learned into a coherent reference system, not acquiring new knowledge."

differentiation:
  extension_for_advanced: "Design your own operations intelligence maturity model: define four maturity levels (Initial, Managed, Defined, Optimised) and specify which chapter capabilities belong at each level. Identify where your organisation currently sits and what a 12-month roadmap to the next level looks like."
  remedial_for_struggling: "Focus on the three questions this chapter always asked: What is invisible? Which plugin makes it visible? What does good output look like? If you can answer those three questions for vendor management, compliance, and incident response, you have the core framework."
...
:::caution Never Use Auto-Skills as Slash Commands
