...
skills:
  - name: "Classify Changes and Run Impact Assessments Using /change-request"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can classify a change at the correct level, run /change-request to produce a stakeholder impact map and integration risk register, and identify which teams and systems are affected that the change owner had not considered"

  - name: "Build Change Communication Plans That Prevent Resistance from Surprise"
  ...
  - name: "Design Rollback Plans with Pre-Defined Trigger Criteria"
    ...
    bloom_level: "Create"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can produce a phase-specific rollback plan with explicit trigger criteria (defined as observable conditions, not 'if things go wrong'), named decision authority, and reversibility assessment for each phase"

learning_objectives:
  - objective: "Classify a change using the four-level classification system and justify the classification based on scope, risk, and approval requirements"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student correctly classifies three different change scenarios and explains why each classification determines specific approval authority and assessment depth"

  - objective: "Produce a change impact assessment using /change-request that covers all affected teams, integration risks, and timeline risks"
    proficiency_level: "B2"
    bloom_level: "Analyze"
    assessment_method: "Student produces an impact assessment for an ERP migration that identifies at least one team or system impact the change owner had not initially considered"

  - objective: "Design a phase-specific rollback plan with explicit trigger criteria defined before the change begins"
    proficiency_level: "B2"
    bloom_level: "Create"
    assessment_method: "Student produces a rollback plan where every trigger criterion is an observable condition, not vague language, and where decision authority is named at each phase"
