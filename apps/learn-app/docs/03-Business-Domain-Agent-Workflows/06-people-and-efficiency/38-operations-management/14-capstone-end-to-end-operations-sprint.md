...
skills:
  - name: "Execute an End-to-End Operations Intelligence Deployment"
  ...
  - name: "Select and Adapt Operations Workflows for Scenario-Specific Contexts"
    ...
    bloom_level: "Analyze"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can choose the appropriate scenario, identify how the scenario changes the priority and focus of each sprint phase, and adapt the standard workflow to scenario-specific operational requirements"
...
learning_objectives:
  ...
  - objective: "Synthesise all nine sprint outputs into a COO-level operations intelligence brief that tells a coherent story specific to the chosen scenario"
    proficiency_level: "C1"
    bloom_level: "Create"
    assessment_method: "The final brief maps each section back to the sprint phase that produced it and surfaces at least one cross-scenario connection that required synthesising output from two or more phases"
...
This capstone requires **both** the **Operations** plugin (official) and the **Operations Intelligence** plugin (custom). All commands from both plugins are used across the nine phases. If you have not installed both, follow the instructions in the [Chapter 38 prerequisites](./README.md#prerequisites) before continuing.
:::
...
Continue to [Lesson 15: Chapter Summary and Quick Reference →](./15-chapter-summary-quick-reference.md)
