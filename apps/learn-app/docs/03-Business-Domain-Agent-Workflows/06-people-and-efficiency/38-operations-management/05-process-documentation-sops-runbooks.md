...
skills:
  - name: "Create SOPs Using /process-doc with Complete RACI and Document Control"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Content-Creation"
    measurable_at_this_level: "Student can use /process-doc to produce a complete SOP with named roles, numbered steps with one action each, controls at risk points, error handling, and a Document Control section"

  - name: "Create Operational Runbooks Using /runbook for Recurring Procedures"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Content-Creation"
    measurable_at_this_level: "Student can use /runbook to produce an execution-focused runbook with exact steps, expected results, failure actions, and escalation paths"

  - name: "Distinguish Between SOPs and Runbooks and Apply Each Appropriately"
    proficiency_level: "B2"
    category: "Conceptual"
    bloom_level: "Analyze"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can correctly categorise a documentation need as SOP or runbook, explain the governing principles for each, and justify the choice based on audience and operational purpose"
...
learning_objectives:
  ...
  - objective: "Use /runbook to create an operational runbook with exact procedures, expected results, and escalation paths"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student produces a runbook that someone unfamiliar with the process could follow without asking clarifying questions"

  - objective: "Correctly identify which documentation tool (SOP vs runbook) is appropriate for a given operational scenario"
    proficiency_level: "B2"
    bloom_level: "Analyze"
    assessment_method: "Student correctly categorises five documentation scenarios as SOP or runbook and provides a justification for each based on audience, purpose, and format principles"
...
| -------------------------- | ------------------------------------------------------------------------- |
| **Named roles**            | Every step names a specific job title, not "the team"                     |
...
| **Escalation**       | Named escalation contacts for each failure scenario                                                                                                         |
