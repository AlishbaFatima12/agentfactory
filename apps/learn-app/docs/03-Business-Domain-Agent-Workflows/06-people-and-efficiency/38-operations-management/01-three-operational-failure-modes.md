...
skills:
  - name: "Diagnose the Operations Intelligence Gap in an Organisation"
    proficiency_level: "B1"
    category: "Conceptual"
    bloom_level: "Analyze"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can identify which of the three operational failure modes is most acute in their own or a fictional organisation, and articulate the downstream consequences of the gap"

  - name: "Map Operational Failures to Their Root Cause"
    proficiency_level: "A2"
    category: "Conceptual"
    bloom_level: "Understand"
    digcomp_area: "Information-Literacy"
    measurable_at_this_level: "Student can connect a specific operational failure (e.g. auto-renewed unused vendor contract) to the correct failure mode (Vendor Sprawl) and explain why the failure was invisible"

learning_objectives:
  - objective: "Explain the Operations Intelligence Gap and why each of the three failure modes traces back to it"
    proficiency_level: "B1"
    bloom_level: "Understand"
    assessment_method: "Student can describe the gap in two sentences and give one concrete example of how it manifests in a 200-person professional services firm"

  - objective: "Identify Vendor Sprawl, Process Rot, and Compliance Drift from operational symptoms"
    proficiency_level: "A2"
    bloom_level: "Analyze"
    assessment_method: "Student reads four operational scenarios and correctly classifies each as an instance of one of the three failure modes, with reasoning"

  - objective: "Preview how the two-plugin architecture addresses each failure mode across the chapter"
    proficiency_level: "A2"
    bloom_level: "Understand"
    assessment_method: "Student can name at least one plugin command or agent that addresses each of the three failure modes"
...
differentiation:
  extension_for_advanced: "After reading this lesson, map all three failure modes onto a real organisation you know. For each, estimate the magnitude of the problem (low/medium/high) and the cost if left unaddressed for 12 months. Present your analysis as a one-page brief to a fictional COO."
  remedial_for_struggling: "Focus on the one insight that underlies everything: operations fails when things are invisible. Vendor Sprawl is invisible vendor spend, Process Rot is invisible process decay, Compliance Drift is invisible obligation gaps. If you can connect each failure mode to the word 'invisible,' you have the core concept."
...
| Symptom                               | Why It Happens                                        | What It Costs                                   |
| ------------------------------------- | ----------------------------------------------------- | ----------------------------------------------- |
| Auto-renewal without renegotiation    | Renewal dates are not tracked in a single place       | Missed negotiation opportunity; locked in terms |
| Three teams using three similar tools | No cross-departmental view of vendor categories       | Redundant spend; integration complexity         |
| High-spend tool with unknown usage    | The person who requested it has left the organisation | Full subscription cost for zero value           |
| Vendor underperformance undocumented  | No systematic SLA tracking; complaints handled ad hoc | No leverage in renewal discussions              |
...
| --------------------- | ------------------------------------ | --------------------------------------------------- |
| Obligation introduced | Fully mapped; control implemented    | Accurate                                            |
| 6 months later        | Control is current                   | Technology change affected one component            |
| 12 months later       | Control is current                   | Staff responsible have changed; handover incomplete |
| 18 months later       | Control is current; evidence on file | Evidence collection process modified; gaps present  |
| Audit                 | Confident of compliance              | Three gaps discovered                               |
...
| Lesson | Failure Mode Addressed | Key Capability Built                               |
| ------ | ---------------------- | -------------------------------------------------- |
| L02    | All three              | Plugin installation + `ops.local.md` configuration |
| L03    | Vendor Sprawl          | Vendor portfolio audit + renewal calendar          |
| L04    | Vendor Sprawl          | Contract obligation extraction                     |
| L05    | Process Rot            | SOP library + process gap analysis                 |
| L06    | Process Rot            | Change impact assessment + rollback planning       |
| L07    | Compliance Drift       | Compliance obligation map                          |
| L08    | Compliance Drift       | Audit evidence preparation + mock review           |
| L09    | All three              | Operational risk register                          |
| L10    | Process Rot            | Incident post-mortem + Five Whys RCA               |
| L11    | All three              | Operational metrics framework + dashboard          |
| L12    | All three              | Four persistent monitoring agents                  |
| L13    | All three              | Operations intelligence brief                      |
| L14    | All three              | End-to-end operations sprint (capstone)            |
