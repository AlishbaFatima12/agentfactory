...
skills:
  - name: "Map Compliance Obligations Using the compliance-tracking Auto-Skill"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can prompt Cowork with a natural-language compliance mapping request, interpret the five-status obligation register, and identify which obligations require immediate remediation action"

  - name: "Evaluate AI-Generated Compliance Output for Accuracy and Completeness"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Evaluate"
    digcomp_area: "Information-Literacy"
    measurable_at_this_level: "Student can assess whether the compliance map correctly identifies all regulatory frameworks, whether status classifications are honest, and whether every CURRENT obligation cites specific evidence"

  - name: "Build an Evidence Inventory and Prioritised Remediation Plan"
    proficiency_level: "B2"
    category: "Applied"
    bloom_level: "Create"
    digcomp_area: "Content-Creation"
    measurable_at_this_level: "Student can produce a prioritised remediation plan for compliance gaps, correctly ranking by regulatory consequence, breach risk, and effort"

learning_objectives:
  - objective: "Map compliance obligations across regulatory, contractual, and standards frameworks using natural-language prompts that activate the compliance-tracking auto-skill"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student maps obligations for a UK professional services firm, produces a structured obligation register with five-status RAG classification, and identifies the AML PEP screening gap as URGENT"

  - objective: "Evaluate whether each obligation in the output meets the evidence standard for CURRENT status"
    proficiency_level: "B1"
    bloom_level: "Evaluate"
    assessment_method: "Student reviews AI output against the evidence standard and identifies at least one obligation where the AI over-claims CURRENT status without citing specific evidence"

  - objective: "Produce a prioritised remediation plan for GAP and PARTIAL obligations, ranked by regulatory consequence"
    proficiency_level: "B2"
    bloom_level: "Create"
    assessment_method: "Student generates a remediation plan with at least three actions, each with a named owner, target date, and regulatory consequence justification for the priority ranking"
