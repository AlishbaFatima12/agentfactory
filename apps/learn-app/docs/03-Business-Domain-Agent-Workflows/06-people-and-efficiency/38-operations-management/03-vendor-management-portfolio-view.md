...
skills:
  - name: "Conduct a Vendor Portfolio Audit Using the /vendor-review Command"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can run /vendor-review with a vendor list, interpret the portfolio audit output, and identify rationalisation opportunities and upcoming renewals requiring action"

  - name: "Evaluate AI-Generated Vendor Analysis for Completeness and Accuracy"
    proficiency_level: "B1"
    category: "Applied"
  ...
  - name: "Build a Vendor Renewal Calendar from Portfolio Audit Data"
    ...
    measurable_at_this_level: "Student can extract renewal dates from the audit output, organise them into a quarterly calendar, and flag contracts requiring negotiation runway"

learning_objectives:
  - objective: "Run a vendor portfolio audit using /vendor-review and interpret the spend-by-category, renewal, and rationalisation sections of the output"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student runs /vendor-review with a 47-vendor list, identifies the top three rationalisation opportunities, and explains why each represents addressable savings"

  - objective: "Evaluate whether an AI-generated vendor analysis correctly identifies overlapping capabilities and renewal risks"
    proficiency_level: "B1"
    bloom_level: "Evaluate"
    assessment_method: "Student reviews the /vendor-review output against the input data and identifies at least one gap or misclassification in the analysis"

  - objective: "Construct a quarterly renewal calendar and determine which contracts require pre-renewal negotiation"
    proficiency_level: "A2"
    bloom_level: "Apply"
    assessment_method: "Student produces a 12-month renewal calendar from audit output, correctly flagging contracts above the negotiation threshold (>£50,000/yr) at least 90 days before renewal"
