...
skills:
  - name: "Extract Contract Obligations and SLAs Using the /contract Command"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can run /contract on a vendor contract, produce a structured obligation table with SLAs and key dates, and identify at least three risk flags present in the contract"

  - name: "Identify and Categorise Contract Risk Flags"
    proficiency_level: "B2"
    category: "Applied"
    bloom_level: "Analyze"
    digcomp_area: "Information-Literacy"
    measurable_at_this_level: "Student can identify all six risk flag types in a contract, assess their severity relative to the vendor's operational importance, and articulate the business consequence of each flag"

  - name: "Draft a Negotiation Position for High-Risk Contract Clauses"
    proficiency_level: "B2"
    category: "Applied"
    bloom_level: "Evaluate"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can produce a complete negotiation position for a flagged clause including issue description, desired position, rationale, acceptable alternative, and walk-away threshold"

learning_objectives:
  - objective: "Run /contract on a vendor contract and produce a structured extraction covering our obligations, vendor obligations, key dates, and SLA table"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student produces a complete obligation extraction from a provided contract scenario, with all five output sections correctly populated"

  - objective: "Identify all six contract risk flag categories present in a contract and assess the severity of each"
    proficiency_level: "B2"
    bloom_level: "Analyze"
    assessment_method: "Student produces a risk flag report for a contract with at least 3 flags, correctly categorising each and explaining why it poses risk in the specific vendor context"
