...
skills:
  - name: "Configure and Deploy Persistent Operations Agents"
  ...
  - name: "Evaluate Agent Alert Output for Actionability"
    ...
    measurable_at_this_level: "Student can review an agent alert and determine whether it contains a specific recommended action, an appropriate escalation path, and the information needed for the recipient to act without seeking additional context"

  - name: "Design an Agent Monitoring Schedule for an Operations Function"
    proficiency_level: "B2"
    category: "Applied"
    bloom_level: "Create"
...
Continue to [Lesson 13: Operations Intelligence Brief →](./13-operations-intelligence-brief.md)
