...
skills:
  - name: "Populate the Personal Layer of work.local.md with Working-Style and Context Data"
...
learning_objectives:
  - objective: "Describe the purpose of each of the four memory layers and explain which type of information belongs in each layer"
    ...
    assessment_method: "Given a list of ten pieces of organisational information (e.g., 'Omar's communication style', 'Boulders terminology', 'AgentFactory status'), student can correctly assign each to the right layer (Personal, Team, Projects, or Organisational) with a brief justification"

  - objective: "Build Layer 1 (Personal) of work.local.md using their own real working context"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student's Layer 1 entry contains all required fields (working_style, decision_making, current_focus, working_hours, primary_tools, communication_preference, language_preference), is specific rather than generic, and accurately describes how they actually work rather than how they aspire to work"
...
differentiation:
  ...
  remedial_for_struggling: "Start with Layer 1 only. Fill in just five fields: your name and role, two or three sentences about how you work, your current top priority, your working hours, and your preferred communication channel. Then run /agentic-office:workplace-context and ask 'What do you know about how I work?' If the output reflects what you wrote, Layer 1 is working. Move to Layer 4 only after Layer 1 feels right."
...
Continue to [Lesson 4: Building Your People Memory →](./04-building-your-people-memory.md)
