---
slug: /Business-Domain-Agent-Workflows/productivity-agentic-office/projects-and-priorities
sidebar_position: 5
title: "Projects and Priorities"
description: "Build Layer 3 of your workplace memory: structured project entries with codenames, P1/P2/P3 priorities, milestones, and risk flags: then use /agentic-office:workplace-search to query across all four memory layers simultaneously."
keywords:
  [
    "project memory",
    "layer 3",
...
skills:
  - name: "Build Structured Project Entries with Priority and Risk Metadata"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Information-Literacy"
    measurable_at_this_level: "Student can write a complete project entry for work.local.md, including codename, status, P1/P2/P3 priority, current milestone, at_risk field, and key decisions that enables accurate cross-layer search and project-aware task prioritisation"

  - name: "Execute Cross-Context Search Across All Four Memory Layers"
    proficiency_level: "B2"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Information-Literacy"
    measurable_at_this_level: "Student can run /agentic-office:workplace-search queries against their work.local.md and interpret the layered results, identifying which layer each result came from and what is missing that would make the search more comprehensive"

  - name: "Apply P1/P2/P3 Priority Classification to Projects"
    proficiency_level: "B1"
    category: "Conceptual"
    bloom_level: "Understand"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can classify their own active projects into P1/P2/P3 levels and articulate the rule that having more than three P1 projects means having no P1 projects, explaining why forced priority is a discipline, not a limitation"

learning_objectives:
  - objective: "Explain what project amnesia is, why it occurs, and how Layer 3 of work.local.md prevents it, with at least two concrete examples of project context that would otherwise be reconstructed from scratch each time"
    proficiency_level: "B1"
    bloom_level: "Understand"
    assessment_method: "Student can name specific project context fields (at_risk, decisions, current_milestone) and describe what happens without them, project briefings reconstructed from memory, risks rediscovered rather than tracked, decisions relitigated"

  - objective: "Write complete project entries for at least three active projects using the ten-field format, with honest at_risk fields and at least one decision logged per project"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student's project entries contain specific risk observations rather than generic ones ('Facility agreement negotiations stalled, 10+ days, escalation needed' vs 'some risk'), and include at least one decision that would otherwise be forgotten"

  - objective: "Run a cross-context search using /agentic-office:workplace-search and evaluate the result set, identifying what is present, what is missing, and what additions to work.local.md would make future searches more complete"
    proficiency_level: "B2"
    bloom_level: "Evaluate"
    assessment_method: "Student runs at least three search queries, reads the cross-layer results, and can articulate specifically what is missing , not just 'it is incomplete' but 'the decision log has no entry for this, I need to add the March board decision'"

cognitive_load:
  new_concepts: 5
  concepts_list:
    - "Project amnesia: what it costs and why project memory prevents it"
    - "Project entry format, ten fields including codename, status, at_risk, and decisions"
    - "P1/P2/P3 project priority: the forced-choice discipline"
    - "Codenames, privacy, efficiency, and shared identity"
    - "Cross-context search, /agentic-office:workplace-search across all four layers"
  assessment: "5 concepts at B1-B2 level. Project amnesia is the most emotionally resonant: every professional has experienced it. The entry format builds directly on Lesson 4's person entry pattern, so the structure is familiar. The P1/P2/P3 concept is reinforced from Lesson 6's task intelligence (same principle at project level). Codenames are a short concept with immediate practical value. The cross-context search is the lesson's payoff, showing that all four layers are now connected and queryable."

differentiation:
  extension_for_advanced: "After building your project entries, test the search layer with compound queries: 'What is at risk across all my projects and which people from Layer 2 are involved?' The skill should surface connected information across layers. Where the connections are missing: a project entry referencing a person who is not in Layer 2, or a risk with no named owner, those are gaps to fill. Advanced use of the search layer is about building a work.local.md where every relevant element is connected."
  remedial_for_struggling: "Start with your single most important project; your equivalent of AgentFactory. Write the entry using just five fields: name, status, priority, current_milestone, at_risk. Get this one right before adding more. Then run a search for it: 'What do we know about [Project Name]?' If the result feels complete and accurate, add a second project. The goal is one genuinely useful entry, not five incomplete ones."

teaching_guide:
  key_points:
    - "Project amnesia is the most expensive failure mode in professional work. Every briefing starting from scratch is not just a time cost; it is a decision quality cost. The at_risk and decisions fields capture what most people carry in their heads and lose between sessions."
    - "The forced-choice discipline on P1/P2/P3 is the most important teaching moment in this lesson. Having three P1 projects is defensible. Having seven is not prioritisation; it is a list with premium formatting."
    - "Codenames serve real organisational purposes. Project Nighthawk is safer to say in a room of mixed attendees than 'Karachi expansion.' This is not secrecy; it is appropriate information management."
    - "Cross-context search is the payoff for all four lessons of Layer-building (L03-L05). The search is only as good as the memory it searches. Every time a search returns 'not in workplace memory', that is a prompt to add the missing information."
  misconceptions:
    - "The at_risk field is for catastrophic risks only. Correction: the at_risk field is for any project constraint or stall that, if not addressed, will affect the milestone. 'Facility agreement negotiations stalled 10+ days' is the right level of specificity, not 'project might slip.'"
    - "Decisions do not belong in project memory; they belong in meeting notes. Correction: key decisions belong in both. Meeting notes capture the full discussion. Project memory captures the decision in context: what was decided, when, and in relation to what milestone. Having to search meeting notes to find a decision is project amnesia in action."
    - "The search only works if I have everything in work.local.md. Correction: the search tells you what you have and explicitly flags what is missing. 'Not in workplace memory' is useful information ; it tells you what to add."
  discussion_prompts:
    - "You have five projects classified as P1. You cannot actually reclassify any of them; they all genuinely feel critical. What does this tell you about your current situation? What would need to change, at the project level or the organisational level, for you to have three or fewer true P1s?"
    - "Project Nighthawk uses a codename for internal communications. What are the limits of this? When does a codename stop being useful and start creating confusion? Who decides when to retire a codename?"
  teaching_tips:
    - "The Islamabad expansion search example is the lesson's best illustration of cross-layer intelligence. Walk through each section of the result, PROJECT MEMORY, MEETING NOTES, DECISION LOG, TASK HISTORY, ORG MEMORY , and ask: where did this come from? Each section maps to a different layer of work.local.md."
    - "The 'more than 3 P1 projects = no P1 projects' rule is deliberately provocative. Most professionals will resist it. Let them push back. The teaching point is not the number; it is the discipline of forced-choice. If everything is critical, the word loses meaning."
---
...
1. The information does not exist (the event has not happened yet)
2. The information exists but was not recorded (gap to fill)
3. The information is stored elsewhere (Notion, email, Slack) and needs to be added
...
Continue to [Lesson 6: Task Intelligence →](./06-task-intelligence.md)
