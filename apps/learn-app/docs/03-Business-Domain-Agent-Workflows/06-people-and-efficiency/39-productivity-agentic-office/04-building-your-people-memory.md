...
skills:
  - name: "Build Structured Person Entries with Communication Profiles"
  ...
  - name: "Generate and Evaluate Person Briefs for Stakeholder Interactions"
    ...
    measurable_at_this_level: "Student can request a people brief for a set of stakeholders, evaluate the output for accuracy and specificity, identify gaps in the underlying entries, and improve the entries to produce more calibrated guidance"

  - name: "Apply Sensitivity Handling Rules to Workplace Memory"
    proficiency_level: "B1"
    category: "Conceptual"
...
Continue to [Lesson 5: Projects and Priorities →](./05-projects-and-priorities.md)
