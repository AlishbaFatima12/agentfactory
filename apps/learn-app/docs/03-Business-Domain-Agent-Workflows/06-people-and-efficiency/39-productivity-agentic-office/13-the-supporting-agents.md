...
skills:
  - name: "Configure Trigger-Based Agents for Memory, Meeting, and Task Lifecycle"
    proficiency_level: "B2"
    category: "Technical"
    bloom_level: "Apply"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can configure all three supporting agents in work.local.md with correct trigger definitions, schedule times, confirmation windows, and escalation paths, and verify each configuration produces the expected output when triggered"

  - name: "Design the Weekly Maintenance Cadence for an Agentic Office"
    proficiency_level: "B2"
    category: "Applied"
    bloom_level: "Create"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can define a weekly agent sequence that aligns Memory Keeper maintenance (Mon 06:30), Chief of Staff brief (Mon 06:45), Work Tracker delegation audit (Fri 16:00), Meeting Intelligence audit (Fri 17:00), and Chief of Staff week-close (Fri 17:30) with a rationale for the ordering"

  - name: "Interpret Delegation Lifecycle Signals and Apply the Overdue Protocol"
    proficiency_level: "B2"
    category: "Applied"
...
learning_objectives:
  ...
  - objective: "Configure the memory_keeper, meeting_intelligence, and work_tracker sections of the agent_integrations block in work.local.md"
    proficiency_level: "B1"
    bloom_level: "Apply"
...
Continue to [Lesson 14: The Complete Agentic Office →](./14-the-complete-agentic-office.md)
