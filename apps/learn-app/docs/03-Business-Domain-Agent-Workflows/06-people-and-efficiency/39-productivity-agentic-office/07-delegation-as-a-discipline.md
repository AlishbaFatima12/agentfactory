---
slug: /Business-Domain-Agent-Workflows/productivity-agentic-office/delegation-as-a-discipline
sidebar_position: 7
title: "Delegation as a Discipline"
description: "Learn the delegation quality standard: a 7-item checklist for briefs that give delegatees everything they need to succeed , and use /agentic-office:delegation to generate calibrated handoff communications loaded from your work.local.md person entries."
keywords:
  [
    "delegation",
    "delegation quality",
...
skills:
  - name: "Apply the Delegation Quality Standard to Produce Actionable Delegation Briefs"
    proficiency_level: "B2"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Communication"
    measurable_at_this_level: "Student can produce a complete delegation record using /agentic-office:delegation, including specific deliverable, named owner, firm deadline, purpose/audience context, format specification, and calibrated handoff message that gives the delegatee everything needed to succeed without returning for clarification"

  - name: "Calibrate Delegation Communications to Delegatee Communication Style"
    proficiency_level: "B2"
    category: "Applied"
    bloom_level: "Analyze"
    digcomp_area: "Communication"
    measurable_at_this_level: "Student can identify how a delegation handoff message changes based on the delegatee's communication profile from work.local.md, explaining specific calibration elements (lead time acknowledgement, channel choice, scope specificity) that differ between two different delegatees receiving the same task"

  - name: "Apply the Delegation Follow-up Protocol"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can define confirmation windows, check-in cadences, and overdue handling steps for a delegation record, and can explain the difference between a polite follow-up (1 day late) and an explicit conversation about downstream impact (3 days late)"

learning_objectives:
  - objective: "Explain why a vague delegation generates more work than doing the task yourself, using the delegation quality checklist to identify which elements are missing from a weak delegation example"
    proficiency_level: "B1"
    bloom_level: "Understand"
    assessment_method: "Given a weak delegation ('Can you handle the analytics thing?'), student can identify all missing checklist items and articulate why each absence creates a follow-up question the delegator should have anticipated"

  - objective: "Produce a complete delegation record for a real task using /agentic-office:delegation, with a handoff message calibrated to the delegatee's communication style from work.local.md"
    proficiency_level: "B2"
    bloom_level: "Apply"
    assessment_method: "Student's delegation record contains all seven checklist elements and the handoff message contains at least two observable calibrations to the delegatee's profile (channel preference, lead time acknowledgement, scope specificity, or context level)"

  - objective: "Evaluate a delegation against the seven-item quality checklist and identify the single weakest element, explaining what specific information would strengthen it"
    proficiency_level: "B2"
    bloom_level: "Evaluate"
    assessment_method: "Student can take a delegation they have produced or received and identify the weakest checklist item with a specific improvement, not 'add more context' but 'add the audience details, who will see this output and what will they decide with it'"

cognitive_load:
  new_concepts: 5
  concepts_list:
    - "Delegation quality standard: why a brief is either complete or it generates rework"
    - "The seven-item delegation quality checklist"
    - "Handoff communication calibration, loading person entries to personalise the message"
    - "Delegation record format: the structured output from /agentic-office:delegation"
    - "Delegation follow-up protocol, confirmation window, check-in cadence, overdue handling"
  assessment: "5 concepts at B1-B2 level. The delegation quality standard is immediately resonant: every professional has sent or received a delegation that came back with 'can you clarify?' The seven-item checklist provides a concrete tool. Handoff calibration is the differentiating concept, showing how the same task produces different messages for different people. The delegation record format is structural and learnable quickly. The follow-up protocol closes the loop."

differentiation:
  extension_for_advanced: "After producing a delegation record, test the brief against the delegatee test: read the delegation as if you were the delegatee, knowing only what the brief contains. Would you succeed without coming back for clarification? If not, identify exactly what question you would ask, and answer it in the brief before sending. Advanced delegation is about anticipating the question before the delegatee asks it."
  remedial_for_struggling: "Start with a delegation you have already sent, something you delegated informally in the last week. Write it up as a delegation record, even after the fact. Go through the seven checklist items: which ones were in your original message? Which were missing? The retrospective analysis builds calibration muscle faster than starting from scratch with a hypothetical task."

teaching_guide:
  key_points:
    - "A delegation without a brief generates more work than doing the task yourself. This is not an exaggeration: the follow-up questions, clarifications, rework, and relationship cost of a vague delegation exceed the original task time in most cases."
    - "The seven-item checklist is a minimum standard, not a maximum. Meeting the checklist does not make a delegation excellent ; it makes it complete. Excellence is anticipating the delegatee's questions before they ask them."
    - "Handoff calibration is the key differentiator between a delegation tool and a delegation discipline. Loading the delegatee's communication profile from work.local.md changes the message , not the task, but the wrapper around it."
    - "The follow-up protocol is as important as the brief. A delegation without a confirmation window is a delegation that may silently fail. The 24-hour rule is not bureaucracy; it is early warning."
  misconceptions:
    - "Good delegation means telling someone what to do and trusting them to do it. Correction: good delegation means giving someone what they need to succeed. Trust is not a substitute for a clear brief; it is what you use after the brief is clear."
    - "Personalising delegation messages is managing people, not delegation quality. Correction: personalisation is a quality measure, not a management style. A message that lands well reduces friction, questions, and rework. A message that lands poorly generates all three, regardless of how much the delegatee is trusted."
    - "Delegation follow-up means micromanaging. Correction: the follow-up protocol is about early warning, not control. A 24-hour confirmation window catches misunderstandings before they compound. A 3-day check-in is a data point, not surveillance."
  discussion_prompts:
    - "You delegated a task with a clear brief and the delegatee still came back with questions. The questions were ones you should have anticipated. What does this tell you about the brief? What additional checklist item would have prevented each question?"
    - "You have a colleague who delegates effectively but never follows up, trusting the delegatee completely until the deadline. Another colleague follows up daily. Which approach is better? Where is the right calibration point for the confirmation window and check-in cadence?"
  teaching_tips:
    - "The Omar analytics brief example is the anchor. Walk through it slowly, show the full delegation record including the calibrated Slack message, and then ask: what in the message specifically reflects Omar's person entry? Students should be able to point to at least three calibrations (lead time acknowledgement, specific scope, offer to adjust)."
    - "The contrast between an Omar delegation message and an Ayesha delegation message (same task, different people) is the most effective teaching tool in this lesson. If time allows, run both through the skill and compare outputs side by side."
---
...
| --- | ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| 1   | **Specific deliverable**                       | Not an activity ("work on the analysis") but an output ("2-page investor-facing analytics summary, slides-ready format") |
| 2   | **Named person**                               | One person, not "the team." One person is accountable; others may contribute, but one delivers                           |
| 3   | **Specific deadline**                          | Not "when you can" or "ASAP": a date and time. "ASAP" produces the lowest-priority work on the delegatee's list         |
| 4   | **Context**                                    | Why this is needed; what decision it supports; who will see it                                                           |
| 5   | **Format specified**                           | Slides/doc/data/email/verbal, specific. "Data file" and "slides-ready charts" are different deliverables                |
| 6   | **Written in the delegatee's preferred style** | Loaded from work.local.md; their channel preference, how they receive requests, what they find difficult                |
| 7   | **Follow-up mechanism defined**                | Confirmation window, check-in point, what happens if it goes overdue                                                     |
...
| 3 days late | Explicit conversation: "This is affecting [downstream item]. What do you need?" |
| 1 week late | Flag in digest; consider rerouting or taking the task back                      |
...
:::info A delegation is not complete when sent
...
**Time:** 35 minutes
**Plugin command:** `/agentic-office:delegation`
...
Continue to [Lesson 8: The Daily Digest →](./08-the-daily-digest.md)
