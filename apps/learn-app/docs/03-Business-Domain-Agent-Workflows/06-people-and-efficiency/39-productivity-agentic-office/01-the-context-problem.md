...
skills:
  - name: "Diagnose Context Failure Modes in AI-Assisted Work"
    proficiency_level: "B1"
    category: "Conceptual"
    bloom_level: "Analyze"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can examine an AI interaction and correctly identify which of the four context failure modes is present, explaining the specific information gap that caused the output to be generic rather than contextual"

  - name: "Distinguish Generic AI Output from Contextual Colleague Output"
    proficiency_level: "A2"
    category: "Conceptual"
    bloom_level: "Understand"
    digcomp_area: "Information-Literacy"
    measurable_at_this_level: "Student can describe the difference between what a knowledgeable colleague knows by default and what an AI assistant knows by default, and articulate why this gap has a material cost in professional productivity"

learning_objectives:
  - objective: "Name all four context failure modes and give a concrete example of each from a professional setting"
    proficiency_level: "A2"
    bloom_level: "Remember"
    assessment_method: "Given a description of an AI interaction, student can correctly identify which failure mode is present and name the specific information gap (terminology, people, project, or priority) that caused the output to fall short"
...
> _"I'd be happy to write a project update. Could you clarify what 'AgentFactory' refers to, and what format the quarterly Boulders review uses?"_
...
Continue to [Lesson 2: Two Plugins, One System →](./02-two-plugins-one-system.md)
