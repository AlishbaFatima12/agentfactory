## Summary: Plugin Architecture & Your Product Context

- **Key concept**: The two-plugin architecture separates universal PM workflows (official Layer 1: write-spec, roadmap-update, synthesize-research, stakeholder-update, competitive-brief, metrics-review) from workflow gaps and craft enforcement (custom Layer 2: brief, interview, prd, stories, prioritise, retro).
