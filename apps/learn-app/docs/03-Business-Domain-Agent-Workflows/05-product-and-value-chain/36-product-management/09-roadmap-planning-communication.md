...
skills:
  - name: "Build a Now/Next/Later roadmap from a story backlog using /roadmap-update and communicate it to three audiences"
  ...
  - name: "Simulate a dependency slip and communicate the resulting roadmap change using the five-step change communication framework"
    ...
    digcomp_area: "Communication"
    measurable_at_this_level: "Student applies the five-step framework to a dependency slip scenario and evaluates whether the resulting communication acknowledges impact to all affected stakeholders"
...
learning_objectives:
  ...
  - objective: "Build a Now/Next/Later roadmap from the L08 story backlog using /roadmap-update, with dependencies mapped and capacity allocation applied"
    proficiency_level: "B2"
    bloom_level: "Apply"
    assessment_method: "Student invokes /roadmap-update with InsightFlow context and produces a roadmap that identifies at least two cross-team dependencies and applies the 70/20/10 capacity rule"
...
Continue to [Lesson 10: Backlog Prioritization Frameworks →](./10-backlog-prioritization-frameworks.md)
