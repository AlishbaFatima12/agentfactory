...
| ----------------------------------------------- | ------------------------------------------- | -------- | ------------------------------------------------------------------------------------------------- |
| [L01](./01-three-structural-failures.md)        | The Three Structural Failures               | 25 min   | Why supply chains fail: the reconciliation swamp, vendor blind spot, and static optimisation trap |
| [L02](./02-plugin-architecture-installation.md) | Plugin Architecture and Installation        | 20 min   | Plugin installed, `supply-chain.local.md` configured, all 8 commands accessible                   |
| [L03](./03-vendor-classification-kraljic.md)    | Vendor Classification -- The Kraljic Matrix | 40 min   | Top 20 vendors classified as Strategic, Tactical, Commodity, or Bottleneck                        |
| [L04](./04-six-dimension-vendor-assessment.md)  | Six-Dimension Vendor Assessment             | 45 min   | Full six-dimension assessments for your top 5 strategic vendors                                   |
| [L05](./05-three-way-match-rule-design.md)      | Three-Way Match Rule Design                 | 40 min   | Complete tolerance rules by category, tested against your invoice sample                          |
| [L06](./06-invoice-reconciliation-at-scale.md)  | Invoice Reconciliation at Scale             | 45 min   | 10 invoices reconciled, exceptions classified, vendor communications drafted                      |
| [L07](./07-supplier-risk-five-dimensions.md)    | Supplier Risk -- Five Dimensions            | 45 min   | Risk dashboard for top 10 suppliers with business case for highest-risk mitigation                |
| [L08](./08-logistics-carrier-performance.md)    | Logistics and Carrier Performance           | 40 min   | Carrier scorecard, lane optimisation analysis, savings opportunities quantified                   |
| [L09](./09-supply-network-design-scenarios.md)  | Supply Network Design Scenarios             | 35 min   | Multi-scenario network analysis with cost, service, and carbon comparison                         |
| [L10](./10-spend-analytics-consolidation.md)    | Spend Analytics and Consolidation           | 45 min   | Category map, consolidation business case, market benchmark for primary opportunity               |
| [L11](./11-vendor-communications-disputes.md)   | Vendor Communications and Disputes          | 35 min   | Five communication templates deployed: disputes, CARs, notices, assurance, exit                   |
| [L12](./12-persistent-agents-schedule.md)       | Persistent Agents and Schedule              | 40 min   | All 5 agents configured and scheduled, weekly executive brief template running                    |
| [L13](./13-vendor-exit-protocol.md)             | Vendor Exit Protocol                        | 35 min   | Complete exit plan for a bottleneck vendor scenario, emergency RFQ, comms plan                    |
| [L14](./14-capstone-end-to-end-procurement.md)  | Capstone -- End-to-End Procurement          | 90 min   | Full procurement cycle executed: classify, assess, reconcile, monitor, optimise, brief            |
| [L15](./15-chapter-summary-quick-reference.md)  | Chapter Summary and Quick Reference         | 15 min   | All commands, all agents, key tables, and the chapter's central insight                           |
...
Start with [Lesson 1: The Three Structural Failures](./01-three-structural-failures.md).
