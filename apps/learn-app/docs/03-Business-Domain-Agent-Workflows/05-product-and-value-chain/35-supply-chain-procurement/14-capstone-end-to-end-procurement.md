...
skills:
  - name: "Integrate All Eight Supply Chain Skills into a Complete Procurement Operating System"
    proficiency_level: "C1"
    category: "Applied"
    bloom_level: "Create"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can sequence and execute all eight skill invocations across a complete procurement cycle, using outputs from earlier phases as inputs to later phases, and produce a deployable procurement system for one spend category"

  - name: "Design and Deploy a Multi-Agent Supply Chain Intelligence Architecture"
    proficiency_level: "B2"
    category: "Technical"
    bloom_level: "Create"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can configure all five persistent agents for a specific vendor portfolio, define appropriate escalation thresholds, and produce a first executive brief that integrates all agent outputs"

  - name: "Evaluate a Complete Procurement Portfolio Against Multi-Dimensional Risk and Performance Criteria"
    proficiency_level: "C1"
    category: "Applied"
    bloom_level: "Evaluate"
    digcomp_area: "Information-Literacy"
    measurable_at_this_level: "Student can synthesise outputs from vendor assessment, risk analysis, logistics performance, and spend analytics to produce a category-level procurement recommendation with supporting data"

learning_objectives:
  - objective: "Execute a complete seven-phase procurement workflow for a new spend category using all eight plugin skills in sequence"
    proficiency_level: "C1"
    bloom_level: "Create"
...
All category vendors classified with Kraljic tiers, review frequencies, and priority actions (Phase 1).

**2. Vendor Assessment Scores**
Full six-dimension assessments for all Tier 1 and Tier 4 vendors (Phase 2).

**3. Reconciliation Rules Configuration**
Tier-calibrated tolerance rules for the category, tested against a sample invoice (Phase 3).

**4. Supplier Risk Dashboard**
Risk scores across five dimensions with alert thresholds for each Tier 1/4 vendor (Phase 4).

**5. Logistics and Spend Baseline**
