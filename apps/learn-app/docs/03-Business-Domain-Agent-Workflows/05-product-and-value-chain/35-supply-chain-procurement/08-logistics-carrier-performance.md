...
skills:
  - name: "Analyse Carrier Performance Using the /logistics-brief Skill"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can invoke /logistics-brief with carrier and lane data, interpret the scorecard output, and identify the highest-priority routing change"

  - name: "Diagnose Root Causes of Expedited Freight Spend"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Analyze"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can distinguish between expedited freight caused by logistics problems versus upstream supply chain problems, and propose the correct intervention for each root cause"

learning_objectives:
  - objective: "Describe the four dimensions of logistics optimisation and the type of decision each dimension informs"
    proficiency_level: "B1"
    bloom_level: "Understand"
    assessment_method: "Student can name each dimension (route efficiency, carrier performance, network design, sustainability) and describe a practical decision each one drives"

  - objective: "Invoke /logistics-brief to generate a carrier performance review and interpret the results"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student runs /logistics-brief, reads the scorecard, identifies underperforming carriers, and proposes lane routing changes with estimated savings"

  - objective: "Identify whether expedited freight spend is a logistics problem or an upstream supply chain problem"
    proficiency_level: "B1"
    bloom_level: "Analyze"
    assessment_method: "Student classifies each expedited shipment event by root cause category and determines the correct intervention"

  - objective: "Explain why carrier cost per kg is a more reliable performance metric than cost per shipment"
    proficiency_level: "A2"
    bloom_level: "Understand"
    assessment_method: "Student articulates that shipment size variation makes cost per shipment misleading and that cost per kg normalises for weight differences"
...
differentiation:
  extension_for_advanced: "Research Scope 3 category 4 (upstream transportation) and category 9 (downstream transportation) emissions accounting under the GHG Protocol. How does your logistics network contribute to each? What carrier data do you need to report accurately, and what are the consequences of estimating versus measuring?"
  remedial_for_struggling: "Focus on the carrier scorecard. If you can read the four metrics (OTD, damage rate, cost per kg, track-and-trace) and classify a carrier as outperforming, compliant, underperforming, or review-required, you have the core analytical skill. Lane analysis and expedited freight diagnosis build on this foundation."
...
Continue to [Lesson 9: Supply Network Design Scenarios →](./09-supply-network-design-scenarios.md)
