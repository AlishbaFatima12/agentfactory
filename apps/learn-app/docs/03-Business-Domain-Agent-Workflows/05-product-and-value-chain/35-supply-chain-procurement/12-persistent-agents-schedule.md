---
slug: /Business-Domain-Agent-Workflows/supply-chain-procurement/persistent-agents-schedule
sidebar_position: 12
title: "Persistent Agents & Schedule"
description: "Deploy all five supply chain intelligence agents, configure their monitoring parameters, and use /schedule to automate the recurring intelligence gathering that keeps your CPO informed without manual effort"
keywords:
  [
    "persistent agents",
...
skills:
  - name: "Deploy and Configure Persistent Supply Chain Intelligence Agents"
    proficiency_level: "B2"
    category: "Technical"
    bloom_level: "Create"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can configure all five agents with appropriate monitoring parameters, set scheduling cadences, and deploy them as an integrated intelligence system"

  - name: "Design Escalation Criteria for Supply Chain Intelligence Alerts"
    proficiency_level: "B2"
    category: "Applied"
    bloom_level: "Evaluate"
    digcomp_area: "Problem-Solving"
    measurable_at_this_level: "Student can define the specific threshold conditions that should trigger an immediate CPO alert versus a scheduled weekly digest, balancing sensitivity against alert fatigue"

  - name: "Generate Executive Supply Chain Briefs Using /supply-chain-brief"
    proficiency_level: "B1"
    category: "Applied"
    bloom_level: "Apply"
    digcomp_area: "Communication"
    measurable_at_this_level: "Student can invoke /supply-chain-brief with the correct parameters to produce a one-page executive summary formatted for CPO and COO consumption"

learning_objectives:
  - objective: "Describe the purpose, trigger, workflow, output format, and escalation rules for each of the five persistent supply chain agents"
    proficiency_level: "B2"
    bloom_level: "Understand"
    assessment_method: "Student can match each agent to its primary function and the manual workflow it replaces, and identify the escalation threshold that distinguishes a scheduled digest from an immediate hot alert"
  ...
  - objective: "Use /schedule to set recurring agent runs and /supply-chain-brief to generate the first weekly executive brief"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Student invokes /schedule for at least one agent and produces a first executive brief output using /supply-chain-brief, verifying the output format matches the CPO brief specification"
...
teaching_guide:
  ...
  teaching_tips:
    ...
    - "The escalation design step (Step 4 of Exercise 7) often surfaces the most important strategic discussion: what does the CPO actually need to be interrupted for on a Sunday evening? That question forces clarity about business priorities that most procurement teams have never explicitly discussed."
---
...
:::tip Scheduling the Invoice Reconciliation Agent
...
Continue to [Lesson 13: Vendor Exit Protocol →](./13-vendor-exit-protocol.md)
