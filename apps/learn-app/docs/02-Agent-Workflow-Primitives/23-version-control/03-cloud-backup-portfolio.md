...
skills:
  - name: "Understand Remote Repositories"
    ...
    measurable_at_this_level: "Student can explain GitHub as a cloud copy of their local project"

  - name: "Connect and Push to GitHub"
    proficiency_level: "A1"
    category: "Technical"
    bloom_level: "Apply"
    digcomp_area: "Digital Competence"
    measurable_at_this_level: "Student can push commits to GitHub and verify they appear online"

  - name: "Clone for Recovery"
    proficiency_level: "A1"
    category: "Technical"
    bloom_level: "Apply"
    digcomp_area: "Digital Competence"
    measurable_at_this_level: "Student can clone a project from GitHub to prove backup works"

  - name: "Protect Secrets with .gitignore"
    proficiency_level: "A1"
    category: "Technical"
    bloom_level: "Apply"
    digcomp_area: "Safety"
    measurable_at_this_level: "Student can create .gitignore to prevent sensitive files from being pushed"

learning_objectives:
  - objective: "Connect a local project to GitHub and push commits"
    proficiency_level: "A1"
    bloom_level: "Apply"
    assessment_method: "Student pushes code and verifies it appears on GitHub"

  - objective: "Clone a project from GitHub to verify backup works"
    proficiency_level: "A1"
    bloom_level: "Apply"
    assessment_method: "Student clones to a separate folder and confirms all files are present"

  - objective: "Create .gitignore to protect sensitive files"
    proficiency_level: "A1"
    bloom_level: "Apply"
    assessment_method: "Student adds secret files to .gitignore before pushing"

  - objective: "Explain GitHub as both backup and portfolio"
    proficiency_level: "A1"
    bloom_level: "Understand"
    assessment_method: "Student describes the dual value of cloud backup and career showcase"

cognitive_load:
  new_concepts: 4
  concepts_list:
    - "Remote repositories (cloud copy of your project)"
    - "Push (uploading snapshots to the cloud)"
...
teaching_guide:
  ...
  assessment_quick_check:
    ...
    - "How do you verify that your backup actually works?"
