...
Use these prompts before, during, and after your evaluation.

**Prompt 1 — Design your test plan:**

```
I have an AI employee for [your profession] with:
- Identity: [1-sentence description from L01]
- Skill: [your L02 skill name and focus]
- Connection: [your L03 channel/MCP server]

Design 5 test tasks that evaluate:
1. Basic identity and professional tone
2. Domain skill application
3. External connection usage
4. Ambiguity handling (should ask for clarification)
5. Complex multi-capability reasoning

Make the tasks realistic for a [your profession] workday.
```

**What you're learning:** How to design structured evaluations. Real-world AI deployment requires systematic testing, not "it seems to work." This skill transfers to any AI tool you evaluate in the future.

**Prompt 2 — Analyze your results:**

```
Here are my AI employee's responses to 5 professional tasks:

[Paste your conversation log]

Evaluate each response against these dimensions:
- Domain accuracy (professional details correct?)
- Tone (appropriate for the profession?)
- Tool usage (did it use the skill and connection effectively?)
- Clarification behavior (did it ask when things were ambiguous?)

Be honest about weaknesses. I want to improve this employee.
```

**What you're learning:** How to use AI as a co-evaluator. You bring the professional judgment (you know what "right" looks like in your field), while the AI helps you systematize the assessment and catch patterns you might miss.

**Prompt 3 — Plan improvements:**

```
Based on this evaluation of my AI employee:

Scores: [paste your rubric scores]
Biggest weakness: [describe]
Best performance: [describe]

What specific changes to my CLAUDE.md identity, SKILL.md, or
connection configuration would address the weakness?
Give me concrete edits, not general advice.
```

**What you're learning:** How to translate evaluation findings into actionable improvements. The gap between "this didn't work well" and "here is what to change" is where most people get stuck. AI helps bridge that gap with specific suggestions you can test.
