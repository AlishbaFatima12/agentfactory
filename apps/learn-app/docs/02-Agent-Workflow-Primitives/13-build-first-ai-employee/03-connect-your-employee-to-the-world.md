...
Use these prompts to design, build, and evaluate your integration.

**Prompt 1 — Design the integration:**

```
I'm building an AI employee for [your profession] using NanoClaw.
It already has WhatsApp and a custom skill for [your L02 skill].

I want to add [channel or MCP server name] because [your reason].

Help me think through:
1. What specific professional tasks does this connection enable?
2. What data will cross the container boundary?
3. Are there any security considerations for my profession?
```

**What you're learning:** How to evaluate an integration decision before implementing it. Professional AI employees need deliberate connection choices, not "add everything available."

**Prompt 2 — Troubleshoot the setup:**

```
I'm trying to add [channel/MCP server] to my NanoClaw instance.
Here's what I've done so far: [describe steps taken]
Here's what's happening: [describe the problem]

Help me debug this. What should I check first?
```

**What you're learning:** How to collaborate with AI on debugging integration issues. The AI can suggest diagnostic steps you might not think of, while you provide the specific error context it cannot see.

**Prompt 3 — Evaluate the data boundary:**

```
My NanoClaw AI employee now has these connections:
- WhatsApp (messaging)
- [Your new connection]
- [Your L02 skill]

For a [your profession] context, map the data flow:
- What sensitive professional data could cross each boundary?
- What would a client or employer want to know about this data exposure?
- What safeguards should I document?
```

**What you're learning:** How to think about data boundaries as a professional responsibility. When you deploy AI employees for real work, clients and employers will ask exactly these questions.
