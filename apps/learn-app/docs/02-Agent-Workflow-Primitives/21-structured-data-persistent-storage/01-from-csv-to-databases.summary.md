...
Chapter 21 begins when evolving query demands make loop-based CSV logic too brittle. Schema and relational constraints become the next required primitive.
