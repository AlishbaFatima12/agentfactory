      ...
      >
        <div className="max-w-[1800px] flex h-16 items-center justify-between mx-auto px-4">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <Link
              to="/"
              className="flex items-center gap-2 font-bold text-base sm:text-lg md:text-xl tracking-tight text-foreground hover:no-underline hover:text-primary transition-colors whitespace-nowrap"
            >
          ...
          <div className="flex items-center gap-2">
            ...
            <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
              ...
              <SheetContent
                side="right"
                className="w-[300px] sm:w-[350px] flex flex-col p-0 overflow-hidden"
              >
