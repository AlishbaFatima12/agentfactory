...
standard_primary: AAOIFI FAS 2 (AAOIFI regimes) / IFRS 9 (IFRS regimes)
jurisdiction: Global — see jurisdiction overlay for label requirements
...
Opening Receivable × (Effective Profit Rate / Periods per Year) = Period Profit
