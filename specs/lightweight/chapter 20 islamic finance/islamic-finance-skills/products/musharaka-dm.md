---
name: diminishing-musharaka-accounting
version: 1.0
description: >
...
standard_primary: AAOIFI FAS 4 (AAOIFI regimes) / IFRS 9 (IFRS regimes — substance analysis)
...
Dr: Accrued Rental Receivable [Rental rate × Bank's current ownership % × Asset value / 12]
...
Monthly income recognition = Opening carrying value × EIR / 12
