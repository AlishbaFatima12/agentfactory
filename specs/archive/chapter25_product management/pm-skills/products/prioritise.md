...
description: >
  ...
  quarterly priorities, should we build this, feature value.
...
"We need a quick 2×2 without complex scoring"
...
RICE Score = (Reach × Impact × Confidence) ÷ Effort
  ...
  Effort:     How much engineering time does this require?
              Express in person-sprints (1 sprint = ~2 weeks × 1 engineer)
