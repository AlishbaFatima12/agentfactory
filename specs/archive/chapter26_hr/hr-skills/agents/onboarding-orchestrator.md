...
version: 1.0
description: >
  Activate for: onboarding automation, new hire workflow, new starter
  tracking, pre-boarding checklist tracking, onboarding progress,
  Day 1 readiness, mandatory training completion, onboarding check-in
  scheduling, 30-60-90 milestone tracking, onboarding satisfaction,
  is everything ready for the new starter.
mcp-integrations: HRIS (trigger + record updates), Calendar (scheduling),
                  Email / Slack (communications), IT ticketing (device + access),
...
T-14 DAYS (two weeks before start date):
  Actions:
  □ Generate personalised pre-boarding checklist (load onboard.md)
...
DAY 10:
  ...
  Mandatory training (from hr.local.md):
    - GDPR / Data protection
    - Information security
    - Code of conduct sign-off
    - [Sector-specific if configured]
