...
version: 1.0
description: >
  Activate for: departure knowledge capture, resignation knowledge,
  offboarding knowledge, knowledge before they leave, what does this
  person know, institutional knowledge risk, knowledge at risk of loss,
  succession knowledge transfer, leaver knowledge, exit knowledge capture,
  preserve institutional memory, knowledge handover automation.
mcp-integrations: HRIS (resignation trigger), Calendar (session scheduling),
                  Document store (knowledge article publishing),
                  Email / Slack (coordination)
sensitivity: CONFIDENTIAL — contains business-sensitive institutional knowledge
---
...
🟢 LOW RISK PLAN:
  Session 1 (60 min): Handover briefing — current work, key contacts, where things live
...
## STEP 3: SCHEDULE AND COORDINATE
  ...
  □ Run sessions using knowledge.md interview guides
...
ARTICLE STRUCTURE (load knowledge.md article format):
