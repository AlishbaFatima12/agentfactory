...
version: 1.0
description: >
  Activate for: meeting prep automation, pre-meeting brief delivery,
  post-meeting synthesis, meeting follow-up, meeting action tracker,
  calendar-triggered prep, meeting notes synthesis, weekly meeting audit,
  recurring meeting prep, board meeting prep.
mcp-integrations: Google Calendar (meeting detection and scheduling),
                  Gmail (meeting-related emails and pre-reads),
                  Notion (action log and project status),
                  work.local.md (people; projects; decisions; culture)
---
...
Action:
  ...
  5. Deliver meeting prep brief using products/meeting.md BEFORE structure
...
Action:
  ...
  2. Apply products/meeting.md AFTER structure
...
- NEVER omit the next-meeting proposal from a synthesis — every
  meeting without a next meeting creates scheduling friction
- NEVER flag a recurring meeting as inefficient without first checking
  work.local.md for context — some meetings that look like status
  updates are actually relationship maintenance that serves a real purpose
