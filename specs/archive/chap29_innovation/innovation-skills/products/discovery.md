...
### Synthesis Output Structure
  ...
  PAIN RANKING (frequency × severity):
...
A strong HMW:
  ...
  ✗ Too broad: "How might we improve finance processes?"
  ✗ Too narrow: "How might we add a WhatsApp button to the approval screen?"
...
A strong insight statement is:
  ...
  who is unreachable, not for a system that is slow. Speed of notification
  matters; speed of processing does not."
