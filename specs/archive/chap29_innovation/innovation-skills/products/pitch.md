...
TYPE 3: EXECUTIVE SUMMARY
  ...
  Output: Problem, solution, traction, ask, why worth their time — specific, no clichés
...
9 SLIDES — NARRATIVE ARC:
  ...
  SLIDE 7: THE TEAM — Why this team
    ...
    Says: [Authentic; personal; why you are the right people — not just who you are]
    Emotional job: Trust
  ...
  SLIDE 8: THE ASK — What you need and exactly how you'll use it
    ...
    Says: [This is exactly what the capital buys; this is exactly when we raise again]
...
The earlier your stage, the more you must compensate with team strength
and insight quality if traction is limited.
