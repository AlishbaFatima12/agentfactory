...
CARRIER SCORECARD FORMAT:
  ...
  FINDINGS:
  🔴 [Carrier underperforming]: [specific metric] — recommended action
  🟡 [Carrier at risk]:         [trend concern] — monitor; review at [date]
  ✅ [Carrier outperforming]:   [strength] — protect relationship
