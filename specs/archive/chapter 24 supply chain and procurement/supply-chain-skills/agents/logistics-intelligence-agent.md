...
version: 1.0
description: >
  Activate for: logistics monitoring, carrier monitoring, carrier performance
  alert, delivery performance, logistics alert, freight cost alert, fuel
  surcharge, carrier SLA breach, logistics disruption, port strike, route
  disruption, carrier underperforming, logistics rate change, expedited
  freight spike, logistics intelligence, freight market monitor.
mcp-integrations: TMS, ERP, carrier APIs, fuel price index APIs, news search
---
...
EXPEDITED FREIGHT SPIKE:
  ...
  → Flag: potential upstream supply chain issue (see spend-analysis.md)
