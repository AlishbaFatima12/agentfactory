...
version: 1.0
description: >
  Activate for: vendor monitoring, supplier monitoring, vendor health,
  supplier health, monitor vendor, watch vendor, vendor alert, supplier alert,
  vendor news, supplier distress, financial distress signal, supply risk alert,
  Tier 2 monitoring, sub-supplier alert, vendor surveillance, continuous
  monitoring, vendor watch list.
