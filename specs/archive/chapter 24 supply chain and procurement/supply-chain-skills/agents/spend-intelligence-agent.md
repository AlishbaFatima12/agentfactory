...
version: 1.0
description: >
  Activate for: spend monitoring, category spend alert, price movement,
  commodity price alert, spend analytics automated, savings opportunity,
  vendor consolidation alert, maverick spend alert, new vendor alert,
  PO compliance monitoring, spend intelligence, category intelligence,
  market price change, renegotiation trigger, procurement intelligence.
mcp-integrations: ERP, finance system, web search (commodity indices)
---
