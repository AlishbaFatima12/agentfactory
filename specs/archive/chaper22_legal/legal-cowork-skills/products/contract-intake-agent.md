...
| Document Type                     | Route                                        |
|-----------------------------------|----------------------------------------------|
| NDA / Mutual CA / CDA             | → nda-triage.md protocol                     |
| Vendor Agreement / MSA / SOW      | → contract-review.md protocol                |
| SaaS / Software Licence           | → contract-review.md protocol                |
| Employment Agreement              | → HR Legal queue (no agent analysis)         |
| Independent Contractor Agreement  | → HR Legal queue                             |
| Partnership / JV Agreement        | → contract-review.md + GC notification       |
...
RUN the appropriate triage protocol (nda-triage.md or contract-review.md).
