...
standard_primary: AAOIFI FAS 3 (AAOIFI regimes) / IAS 32 / IFRS 9 (IFRS regimes)
...
Income attributable to bank's own equity = Total Income × (Bank Equity / Total Funds)
Income attributable to IAH = Total Income × (IAH Funds / Total Funds)

**Step 3 — Apply mudarib share:**
Mudarib fee (bank's share) = IAH Income × Mudarib Percentage (e.g., 30%)
Remaining distributable to IAH = IAH Income × IAH Percentage (e.g., 70%)
...
|---|---|---|---|
| Savings (30-day) | X | 0.90 | X × 0.90 |
| 90-day term | X | 1.00 | X × 1.00 |
| 180-day term | X | 1.15 | X × 1.15 |
| 365-day term | X | 1.25 | X × 1.25 |
| Total | | | Sum |
