---
name: roadmap-coherence-agent
version: 1.0
description: >
  Activate for: roadmap coherence, roadmap drift, backlog alignment,
  roadmap health, roadmap audit, spec coverage, unspecced features,
  sprint misalignment, ad hoc work, roadmap vs backlog, backlog hygiene,
  roadmap integrity, is our sprint aligned, what is not on the roadmap,
  orphan tickets, off-roadmap work.
mcp-integrations: Project tracking (Jira/Linear/Notion), Roadmap tool
---
...
COVERAGE STATUS TABLE:
  ...
  |---|---|---|---|
  | [Item] | REFINED ✅ | [N] | Low |
  | [Item] | DRAFT ⚠️ | [N] | Medium — spec not review-ready |
...
## WEEKLY COHERENCE REPORT
  ...
  Check 3 — Sprint Alignment:
    Current sprint:
      Roadmap work:         [X]% ✅
      Maintenance / bugs:   [X]% ✅/⚠️
      Off-roadmap / untagged:[X]% ✅/⚠️/❌
