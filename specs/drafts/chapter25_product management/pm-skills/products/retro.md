...
### Retro Output Format
  ...
  Evidence:
  ✅ / ⚠️ / ❌ [Metric]: [actual result] vs. [target]
  ✅ / ⚠️ / ❌ [Metric]: [actual result] vs. [target]
  ...
  ✅ / ⚠️ / ❌ Delivered on time: [On time / [N] weeks late — reason]
  ✅ / ⚠️ / ❌ Spec quality:     [No major ambiguity / [Issue reported]]
  ✅ / ⚠️ / ❌ Scope maintained: [No changes / Changes: describe]
  ✅ / ⚠️ / ❌ Quality (bugs):   [Bug rate in first 30 days]
  ✅ / ⚠️ / ❌ ACs met:          [All ACs verified / Outstanding: list]
