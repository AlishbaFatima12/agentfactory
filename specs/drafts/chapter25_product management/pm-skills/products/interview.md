...
description: >
  ...
  research, jobs to be done, JTBD, contextual inquiry.
...
SEGMENT 3: CORE DISCOVERY (20–25 minutes)
  ...
  Structure: one recent specific experience → depth questions
...
### After the Interviews: Synthesis Trigger

When interview notes are complete, use /research to synthesise.
The interview guide and note-taking template above are designed
to produce material that /research can process efficiently.
