...
version: 1.0
description: >
  Activate for: institutional knowledge, knowledge capture, knowledge
  transfer, knowledge base article, knowledge management, preserve
  knowledge, what do they know, departing employee knowledge, exit
  knowledge, succession knowledge, tacit knowledge, undocumented knowledge,
  before they leave, knowledge interview, knowledge extraction, document
  what we know, knowledge at risk, knowledge map.
plugin-commands: /knowledge
sensitivity: CONFIDENTIAL — may contain sensitive business information
---

## KNOWLEDGE CAPTURE WORKFLOW

### The Knowledge Risk Assessment
...
### Knowledge Capture Plan Structure
...
For each knowledge holder, capture plan includes:
  ...
  - Shadowing / observation (for procedural or behavioral knowledge)
  - Pair working (for technical or skills transfer)

  SESSIONS RECOMMENDED:
  [N] sessions × [duration] = [total hours]
...
### Knowledge Interview Guide Structure
...
### Knowledge Article Structure (output from sessions)
  ...
  [When does the standard approach NOT apply? What are the special cases?]

  RELATED CONTACTS
  [Who else holds related knowledge? Who should I talk to about this?]
