...
LAYER 1 — ARE WE ON TRACK?
  ...
  Classify each metric: ✅ On track / ⚠️ At risk / ❌ Off track

LAYER 2 — WHY? (root cause, not symptom)
  For each ❌ or ⚠️ metric: diagnose the root cause.
...
### Performance Report Output Format
  ...
  [Metric]:  [Actual] ([target]) — [✅ / ⚠️ / ❌] [% vs. target]
  [Metric]:  [Actual] ([target]) — [...]

  TOP [N] OPTIMISATION OPPORTUNITIES

  [N]. [STATUS EMOJI] [ISSUE NAME IN CAPS]
...
| LinkedIn Thought Leader CTR | <0.6% | 0.8–1.2% | 1.5% | >2% |
