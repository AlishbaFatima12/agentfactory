...
DIMENSION 2: Risk Identification
  ...
  - Deal has been in same stage >2× average stage duration
  ...
  - No activity >30 days
  - No next step agreed
  - Close date pushed >2× without explanation
...
### Pipeline Report Format
  ...
  PIPELINE GAPS
  [If coverage ratio is below 3×]: Pipeline gap: £[X]
