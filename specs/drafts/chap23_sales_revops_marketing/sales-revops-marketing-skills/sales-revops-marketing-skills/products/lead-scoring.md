...
|---|---|---|---|---|
| 80–100 | 🔴 | HOT — Immediate | Personal outreach; priority queue | 24 hours |
| 60–79 | 🟡 | WARM — MQL | Personalised sequence; sales follow-up | 5 days |
| 40–59 | 🟢 | CULTIVATE | Marketing nurture; quarterly check-in | No SLA |
| 0–39 | ⚪ | NOT YET | Monitor; do not invest sales time | Monitor |

## SCORE OUTPUT FORMAT

  LEAD SCORE: [Company] / [Contact Name]
  ════════════════════════════════════════════════════════════
  TOTAL SCORE: [X] / 100 — [Tier emoji] [Tier label]

  FIT SCORE:      [X] / 40
    [Criterion]:  [✅ / ⚠️ / ❌]  +[points]  ([explanation])
    [Criterion]:  ...
