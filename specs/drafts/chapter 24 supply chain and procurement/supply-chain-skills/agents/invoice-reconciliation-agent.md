...
version: 1.0
description: >
  Activate for: process invoices, invoice queue, AP inbox, batch reconcile,
  automated reconciliation, invoice automation, process AP, clear invoice
  backlog, run reconciliation, invoice agent, AP agent, three-way match
  automation, invoice workflow automation, straight-through processing.
mcp-integrations: AP system / email inbox, ERP, vendor master database
---
...
STAGE 1 — DOCUMENT INTELLIGENCE
  On invoice arrival:
  1. Extract structured data (load invoice-reconciliation.md Stage 1)
...
STAGE 4 — AUDIT AND LOGGING
  ...
  4. If exception: draft vendor communication (load vendor-communication.md)
